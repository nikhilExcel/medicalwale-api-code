            ...
            if ($count2 > 0) {
                ...
                $experience          = $row2['experience'];
                    ...
                    $lng = $get_pract['lng'];
                        ...
                        $sql212             = "SELECT  * from doctor_list WHERE user_id='$doctor_id'";
                        $query_practices12  = $this->db->query($sql212);
                        $total_practices12  = $query_practices12->num_rows();
                        if($total_practices12 > 0)
                        {
                          $get_pract2=$query_practices12->row_array(); 
                          $consultation_video1 = $get_pract2['consultaion_video'];
                          $consultation_chat1 = $get_pract2['consultaion_chat'];
                          $consultation_call1 = $get_pract2['consultation_voice_call'];
                          if($consultation_type=="video")
                            {
                                $consultation_charges =$consultation_video1;
                            }
                            elseif($consultation_type=="chat")
                            {
                                $consultation_charges =$consultation_chat1;
                            }
                            elseif($consultation_type=="call")
                            {
                                $consultation_charges =$consultation_call1;
                            }
                            else
                            {
                               $consultation_charges =$consultation_charges_clinic;  
                            }
                        }
