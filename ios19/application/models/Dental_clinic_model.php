    ...
    public function dental_freeconsultancy_booking($user_id, $lat, $lng, $listing_id, $address_line1, $address_line2, $city, $state, $pincode, $user_name, $mobile, $email, $gender, $status, $payment_mode, $booking_date, $booking_location, $booking_address, $booking_mobile, $patient_id, $booking_id, $trail_booking_date, $trail_booking_time,$package_id,$type,$sub_type,$amount,$transaction_id){
        ...
        //     curl_close($ch);
         ...
         //  echo 'insert';
            ...
            if($appointment_id > 0 && $type != 'free'){
                if($payment_mode != '3' || $payment_mode != '14') {
                ...
                $vendor_id = 39;
                $dat = array();
                $this->LedgerModel->create_ledger($user_id,  $booking_id,  $ledger_owner_type,  $listing_id,  $listing_id_type,  $credit,  $debit,  $payment_method,  $user_comments,  $mw_comments, $vendor_comments, $order_type, $transaction_of, $transaction_id, $trans_status, $transaction_date, $vendor_id, $dat);
            }
            }
