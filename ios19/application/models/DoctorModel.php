    ...
    public function doctor_category($doctors_type_id,$doctors_type_name)
    {
        ...
        foreach ($query->result_array() as $row) {
            ...
            date_default_timezone_set('Asia/Kolkata');
             ...
             $sql   =  sprintf("SELECT doctor_id FROM doctor_online  WHERE FIND_IN_SET('$id', category) and  doctor_online.starttime <= '$current_date'
   ...
   public function doctor_details($user_id, $listing_id)
	...
	if (count($time1) > 0)
                ...
                $resultpost[] = array(
                    ...
                    'chat_charge'=>$chat,
                    'video_charge'=>$video,
                    'profile_video'=>"https://medicalwale.s3.amazonaws.com/images/Doctor_videos/02_1280_1080.mp4",
                    'area_expertise' => $area_expertise,
                    'doctor_specialization' => $speciality_array,
                    'doctor_services' => $service_array,
                    'doctor_degree' => $degree_array,
