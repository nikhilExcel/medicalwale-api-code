...
class DoctoronlineModel extends CI_Model
{
    ...
    public function doctor_online_cat($user_id,$mlat,$mlng)
    {
       ...
       // echo "SELECT doctor_list.*  FROM doctor_list INNER JOIN doctor_online ON doctor_list.user_id=doctor_online.doctor_id WHERE FIND_IN_SET('41', doctor_list.category) and  doctor_list.is_active = 1 and doctor_online.starttime <= '$current_date' AND doctor_online.endtime >= '$current_date' ORDER BY RAND () $ty  ";            
