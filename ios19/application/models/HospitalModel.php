...
class HospitalModel extends CI_Model {
    ...
    public function hospital_booking_sendmail($user_email, $msg)
    {
...
//     }
 ...
 public function hospital_list($latitude, $longitude, $user_id, $category_name,$page,$keyword) {
      if($page==""){
         $page=1;   
        }
        $radius = $page*500;
     ...
     if($keyword!=""){
        $sql = sprintf("SELECT `id`, `user_id`, `name_of_hospital`,`phone`,`about_us`, `certificates_accred`, `category`, `speciality`, `surgery`,`services`, `address`, `pincode`, `city`, `state`, `email`, `lat`, `lng`, `image`, `rating`, `review`,  `date`, `is_active`,`establishment_year`,`user_discount`,( 6371 * acos( cos( radians($latitude) ) * cos( radians( lat ) ) * cos( radians( lng ) - radians($longitude) ) + sin( radians($latitude) ) * sin( radians( lat ) ) ) ) AS distance FROM hospitals WHERE  is_approval='1' AND is_active='1' and name_of_hospital LIKE '%%$keyword%%' HAVING distance < '%s' ORDER BY distance LIMIT $startk, $limitk", ($latitude), ($longitude), ($latitude), ($radius));
    }
   else
   {
        $sql = sprintf("SELECT `id`, `user_id`, `name_of_hospital`,`phone`,`about_us`, `certificates_accred`, `category`, `speciality`, `surgery`,`services`, `address`, `pincode`, `city`, `state`, `email`, `lat`, `lng`, `image`, `rating`, `review`,  `date`, `is_active`,`establishment_year`,`user_discount`,( 6371 * acos( cos( radians($latitude) ) * cos( radians( lat ) ) * cos( radians( lng ) - radians($longitude) ) + sin( radians($latitude) ) * sin( radians( lat ) ) ) ) AS distance FROM hospitals WHERE  is_approval='1' AND is_active='1' HAVING distance < '%s' ORDER BY distance  LIMIT $start, $limit", ($latitude), ($longitude), ($latitude), ($radius));
    }
      ...
      if($count1 == "0" )
       ...
       $i=0;
         ...
         if($page!=0)
{    
        $query = $this->db->query("SELECT `id`, `user_id`, `name_of_hospital`,`phone`,`about_us`, `certificates_accred`, `category`, `speciality`, `surgery`,`services`, `address`, `pincode`, `city`, `state`, `email`, `lat`, `lng`, `image`, `rating`, `review`,  `date`, `is_active`,`establishment_year`,`user_discount`,( 6371 * acos( cos( radians($latitude) ) * cos( radians( lat ) ) * cos( radians( lng ) - radians($longitude) ) + sin( radians($latitude) ) * sin( radians( lat ) ) ) ) AS distance FROM hospitals HAVING distance <= '$radius' LIMIT $start, $limit");
}
else
{
    $query = $this->db->query("SELECT `id`, `user_id`, `name_of_hospital`,`phone`,`about_us`, `certificates_accred`, `category`, `speciality`, `surgery`,`services`, `address`, `pincode`, `city`, `state`, `email`, `lat`, `lng`, `image`, `rating`, `review`,  `date`, `is_active`,`establishment_year`,`user_discount`,( 6371 * acos( cos( radians($latitude) ) * cos( radians( lat ) ) * cos( radians( lng ) - radians($longitude) ) + sin( radians($latitude) ) * sin( radians( lat ) ) ) ) AS distance FROM hospitals  HAVING distance <= '$radius'"); 
}
...
public function list_category($latitude, $longitude, $user_id)
{
    $data=array();
    $data1=array();
     $data2=array();
    ...
    $nursing_array = array();
    $hospital="select id,category,image from hospital_category where sub_category='14'";
    $query = $this->db->query($hospital);
    foreach ($query->result_array() as $row) 
            {
                $id=$row['id'];
                $name=$row['category'];
     ...
     $hospital1="select id,category from hospital_category where sub_category='15'";
    $query1 = $this->db->query($hospital1);
    foreach ($query1->result_array() as $row1) 
     ...
     $hospital2="select id,category from hospital_category where sub_category='4'";
    $query2 = $this->db->query($hospital2);
    foreach ($query2->result_array() as $row2) 
        ...
        $hospital_array[]=array(
                             "cat_id" => "4",
                             "cat_name" => "Nursing Home",
                             "data"=>$data2
                         );
        /*$hospital_array[]=array(
                             "cat_id" => "2",
                             "cat_name" => "Wellness Clinic",
                             "data"=>$data1
                         );  
        $hospital_array[]=array(
                             "cat_id" => "3",
                             "cat_name" => "Old Age Home",
                             "data"=>array()
                         );*/ 
         $resultpost=$hospital_array;
...
public function list_surgey_category($latitude, $longitude, $user_id,$type)
{
    $data=array();
    $data1=array();
    $hospital_array = array();
    $nursing_array = array();
    $hospital="select id,category from hospital_package_category where sub_category='9'";
    $query = $this->db->query($hospital);
    foreach ($query->result_array() as $row) 
            {
                $id=$row['id'];
     ...
     $hospital1="select id,category from hospital_package_category where sub_category='10'";
    $query1 = $this->db->query($hospital1);
    foreach ($query1->result_array() as $row1) 
            {
                $id1=$row1['id'];
...
public function hospital_list_v2($user_id, $latitude, $longitude, $category_id,$page,$type,$keyword,$sort) 
{
    $radius = $page*500;
    $limit = 10;
    $start = 0;
       ...
       if($category_id!="0")
       {
           ...
           {
               $data2=array();
                $hospital2="select id from hospital_category where sub_category='4'";
                $query2 = $this->db->query($hospital2);
                foreach ($query2->result_array() as $row2) 
                        {
                             $id2=$row2['id'];
                ...
                $cat_new=implode("|",$data2);
               
               $cwh .='AND CONCAT(",", h.category, ",") REGEXP ",('.$cat_new.'),"';
           }
           else
           {
           $cwh .=" AND FIND_IN_SET('" . $category_id . "', h.category) ";
           }
       }
       $twh="";
       if($type=="5")
       {
           $twh .=" AND h.recommended='1' ";
       }
       $key="";
       if($keyword!="")
       {
           $key .=" AND h.name_of_hospital LIKE '%%$keyword%%' ";
       }
       $sorts="";
        ...
        if($type=="3")
             {
                 ...
                 if($sort=="3")
           {
           $sorts .="ORDER BY  TRIM(h.name_of_hospital) , h.user_discount DESC,distance";
           }
          elseif($sort=="4")
           {
              $sorts .= " ORDER BY  TRIM(h.name_of_hospital) DESC ,h.user_discount DESC, distance" ;
           } 
           else
           {
           ...
           $disc .="ORDER BY  h.user_discount DESC";
                 ...
                 if($sort=="3")
           {
           $sorts .="ORDER BY  TRIM(h.name_of_hospital) , distance";
           }
          elseif($sort=="4")
           {
              $sorts .= " ORDER BY  TRIM(h.name_of_hospital) DESC , distance" ;
           } 
             else
             {
                 $disc .="ORDER BY distance ";
             }
       ...
       if($type=="2")
       {
            ...
            $sql = sprintf("SELECT h.id, h.user_id, h.name_of_hospital,h.phone,h.about_us,h.certificates_accred, h.category, h.speciality, h.surgery,h.services,h.address,h.pincode,h.city,h.state,h.email, h.lat, h.lng, h.image, h.rating, h.review,  h.date, h.is_active,h.establishment_year,h.user_discount,h.recommended,h.mba,h.certified,( 6371 * acos( cos( radians($latitude) ) * cos( radians( h.lat ) ) * cos( radians( h.lng ) - radians($longitude) ) + sin( radians($latitude) ) * sin( radians( h.lat ) ) ) ) AS distance FROM hospitals as h left join hospitals_favourite as hf on (h.user_id = hf.listing_id ) WHERE h.is_approval='1' AND h.is_active='1' $cwh $twh $key  AND hf.user_id='$user_id' HAVING distance < '%s'  $disc $sorts LIMIT $start, $limit ", ($latitude), ($longitude), ($latitude), ($radius));
       }
       else
       {
         $sql = sprintf("SELECT h.id, h.user_id, h.name_of_hospital,h.phone,h.about_us,h.certificates_accred, h.category, h.speciality, h.surgery,h.services,h.address,h.pincode,h.city,h.state,h.email, h.lat, h.lng, h.image, h.rating, h.review,  h.date, h.is_active,h.establishment_year,h.user_discount,h.recommended,h.mba,h.certified,( 6371 * acos( cos( radians($latitude) ) * cos( radians( h.lat ) ) * cos( radians( h.lng ) - radians($longitude) ) + sin( radians($latitude) ) * sin( radians( h.lat ) ) ) ) AS distance FROM hospitals as h WHERE h.is_approval='1' AND h.is_active='1' $cwh $twh $key HAVING distance < '%s'  $disc $sorts LIMIT $start, $limit", ($latitude), ($longitude), ($latitude), ($radius));
       }
         $query = $this->db->query($sql);
...
public function add_favourite_hospital($user_id, $listing_id)
{
        date_default_timezone_set('Asia/Kolkata');
        $date = date('Y-m-d H:i:s');
        $pharmacy_view = $this->db->select('id')->from('hospitals_favourite')->where('user_id', $user_id)->where('listing_id', $listing_id)->get()->num_rows();
        if($pharmacy_view > 0)
        {
            $this->db->where('user_id', $user_id);
            $this->db->where('listing_id', $listing_id);
            $this->db->delete('hospitals_favourite');    
        ...
        else
        {
            ...
            $this->db->insert('hospitals_favourite', $data);  
...
public function wellness_list_v2($user_id, $latitude, $longitude, $category_id,$page,$type,$keyword,$sort) 
{
    $radius = $page*500;
    $limit = 10;
    $start = 0;
      ...
      $sorts="";
                    ...
                    if($sort!="")
       {
          if($sort=="3")
           {
           $sorts .="ORDER BY  TRIM(h.name_of_hospital) ,h.user_discount DESC";
           }
          elseif($sort=="4")
           {
              $sorts .= " ORDER BY  TRIM(h.name_of_hospital) DESC ,h.user_discount DESC" ;
           } 
           else
           {
               $disc .="ORDER BY  h.user_discount DESC";
                 ...
                 if($sort!="")
       {
          if($sort=="3")
           {
           $sorts .="ORDER BY  TRIM(h.name_of_hospital)";
           }
          elseif($sort=="4")
           {
              $sorts .= " ORDER BY  TRIM(h.name_of_hospital) DESC " ;
           } 
           else
           {
              $disc .="ORDER BY distance ";  
       ...
       if($type=="2")
       {
            ...
            $sql = sprintf("SELECT h.id, h.user_id, h.name_of_hospital,h.phone,h.about_us,h.certificates_accred, h.category, h.speciality, h.surgery,h.services,h.address,h.pincode,h.city,h.state,h.email, h.lat, h.lng, h.image, h.rating, h.review,  h.date, h.is_active,h.establishment_year,h.user_discount,h.recommended,h.mba,h.certified,( 6371 * acos( cos( radians($latitude) ) * cos( radians( h.lat ) ) * cos( radians( h.lng ) - radians($longitude) ) + sin( radians($latitude) ) * sin( radians( h.lat ) ) ) ) AS distance FROM wellness_clinic as h left join hospitals_favourite as hf on (h.user_id = hf.listing_id ) WHERE h.is_approval='1' AND h.is_active='1' $cwh $twh $key AND hf.user_id='$user_id' HAVING distance < '%s' $disc $sorts LIMIT $start, $limit", ($latitude), ($longitude), ($latitude), ($radius));
       ...
       else
       {
         ...
         $sql = sprintf("SELECT h.id, h.user_id, h.name_of_hospital,h.phone,h.about_us,h.certificates_accred, h.category, h.speciality, h.surgery,h.services,h.address,h.pincode,h.city,h.state,h.email, h.lat, h.lng, h.image, h.rating, h.review,  h.date, h.is_active,h.establishment_year,h.user_discount,h.recommended,h.mba,h.certified,( 6371 * acos( cos( radians($latitude) ) * cos( radians( h.lat ) ) * cos( radians( h.lng ) - radians($longitude) ) + sin( radians($latitude) ) * sin( radians( h.lat ) ) ) ) AS distance FROM wellness_clinic as h WHERE h.is_approval='1' AND h.is_active='1' $cwh $twh $key HAVING distance < '%s' $disc $sorts LIMIT $start, $limit", ($latitude), ($longitude), ($latitude), ($radius));
       }
         $query = $this->db->query($sql);
        ...
        if ($count > 0) {
             ...
             foreach ($query->result_array() as $row) {
              ...
              /*  $wellness_surgery_list = array();
                ...
                $branch_list  = array();
                $branch_query = $this->db->query("SELECT * FROM `wellness_branch` WHERE hospital_id='$hospital_user_id' order by id asc");
...
public function wellness_list_surgery($user_id, $latitude, $longitude, $category_id,$page,$type,$keyword,$sort,$filter_id) 
{
    $surgey_discount=0;
    $radius = $page*500;
    $limit = 10;
    $start = 0;
       ...
       if($category_id!="0")
       {
           $cwh .=" AND FIND_IN_SET('" . $category_id . "', w.category) ";
       }
       $key="";
       if($keyword!="")
       {
           $key .=" AND (w.name_of_hospital LIKE '%%$keyword%%' OR wp.package_name LIKE '%%$keyword%%') ";
       }
      $disc ="";
              $sorts="";      
                 if($sort=="3")
           {
            $sorts .="ORDER BY  TRIM(wp.package_name)";
           }
          elseif($sort=="4")
           {
              $sorts .= " ORDER BY  TRIM(wp.package_name) DESC" ;
           } 
          if(empty($sort))
           {
                             
                   $disc .="ORDER BY wp.discount desc , distance desc";
        ...
        $fliter="";      
                 if($filter_id=="0")
           {
            $fliter .="AND FIND_IN_SET('" . $category_id . "', wp.package_type)";
           }
         
           
   
         $sql = sprintf("SELECT w.*,wp.package_name,wp.id as package_id,wp.discount,wp.price_to,( 6371 * acos( cos( radians($latitude) ) * cos( radians( w.lat ) ) * cos( radians( w.lng ) - radians($longitude) ) + sin( radians($latitude) ) * sin( radians( w.lat ) ) ) ) AS distance FROM wellness_clinic as w INNER join wellness_packages as wp on (w.user_id = wp.user_id ) WHERE w.is_approval='1' AND w.is_active='1' $cwh  $key HAVING distance < '%s'  $disc $sorts LIMIT $start, $limit", ($latitude), ($longitude), ($latitude), ($radius));
       ...
       $i=0;
        ...
        $sql = sprintf("SELECT w.*,wp.package_name,wp.id as package_id,wp.discount,wp.price_to,wp.package_details,( 6371 * acos( cos( radians($latitude) ) * cos( radians( w.lat ) ) * cos( radians( w.lng ) - radians($longitude) ) + sin( radians($latitude) ) * sin( radians( w.lat ) ) ) ) AS distance FROM wellness_clinic as w INNER join wellness_packages as wp on (w.user_id = wp.user_id ) WHERE w.is_approval='1' AND w.is_active='1' $cwh  $key HAVING distance < '%s'  $disc $sorts LIMIT $start, $limit", ($latitude), ($longitude), ($latitude), ($radius));
        ...
        if ($count > 0) {
                foreach ($query->result_array() as $row) {
                    ...
                    $certified = $row['certified'];
                    $profile_views = '0';
                    $surgey_discount = $row['discount'];
                    $package_name = $row['package_name'];
                    $packageamount=$row['price_to'];
                    $package_id=$row['package_id'];
                    $package_details=$row['package_details'];
                    $package_image     = 'https://s3.amazonaws.com/medicalwale/images/SurgeriesImages/'; 
                    ...
                    if($surgey_discount!=0)
                    {
                    $new=($packageamount*$surgey_discount)/100;
                    $final_amount=$packageamount-$new;
                    }
                    else
                    {
                    ...
                    $resultpost[] = array(
                        ...
                        'package_id'=>$package_id,
                        'package_name' => $package_name,
                        'package_discount' =>$surgey_discount,
                        'package_desc' =>$package_details,
                        'package_image' =>$package_image,
                        'old_price'=>$packageamount,
...
public function hospital_list_surgery($user_id, $latitude, $longitude, $category_id,$page,$type,$keyword,$sort,$filter_id) 
{
    $surgey_discount=0;
    $radius = $page*500;
    $limit = 10;
    $start = 0;
       ...
       if($keyword!="")
       {
           $key .=" AND (h.name_of_hospital LIKE '%%$keyword%%' OR h.package_name LIKE '%%$keyword%%') ";
       }
      $disc ="";
              $sorts="";      
                 if($sort=="3")
           {
            $sorts .="ORDER BY  TRIM(hp.package_name)";
           }
          elseif($sort=="4")
           {
              $sorts .= " ORDER BY  TRIM(hp.package_name) DESC" ;
           } 
          if(empty($sort))
           {
                             
                   $disc .="ORDER BY hp.package_discount desc , distance desc";
        ...
        $fliter="";      
                 if($filter_id!="0" )
           {
            $fliter .="AND FIND_IN_SET('" . $filter_id . "', hp.package_type)";
           }
         
          // echo $fliter;
   
         $sql = sprintf("SELECT h.id, h.user_id, h.name_of_hospital,h.phone,h.about_us,h.certificates_accred, h.category, h.speciality, h.surgery,h.services,h.address,h.pincode,h.city,h.state,h.email, h.lat, h.lng, h.image, h.rating, h.review,  h.date, h.is_active,h.establishment_year,h.user_discount,h.recommended,h.mba,h.certified,hp.package_name,hp.surgery_id,hp.package_discount,hp.package_amount,( 6371 * acos( cos( radians($latitude) ) * cos( radians( h.lat ) ) * cos( radians( h.lng ) - radians($longitude) ) + sin( radians($latitude) ) * sin( radians( h.lat ) ) ) ) AS distance FROM hospitals as h INNER join hospital_packages as hp on (h.user_id = hp.hospital_id ) WHERE h.is_approval='1' AND h.is_active='1' $cwh  $key $fliter HAVING distance < '%s'  $disc $sorts LIMIT $start, $limit", ($latitude), ($longitude), ($latitude), ($radius));
       ...
       $i=0;
        ...
        $sql = sprintf("SELECT h.id, h.user_id, h.name_of_hospital,h.phone,h.about_us,h.certificates_accred, h.category, h.speciality, h.surgery,h.services,h.address,h.pincode,h.city,h.state,h.email, h.lat, h.lng, h.image, h.rating, h.review,  h.date, h.is_active,h.establishment_year,h.user_discount,h.recommended,h.mba,h.certified,hp.package_name,hp.surgery_id,hp.id as package_id,hp.package_discount,hp.package_amount,( 6371 * acos( cos( radians($latitude) ) * cos( radians( h.lat ) ) * cos( radians( h.lng ) - radians($longitude) ) + sin( radians($latitude) ) * sin( radians( h.lat ) ) ) ) AS distance FROM hospitals as h INNER join hospital_packages as hp on (h.user_id = hp.hospital_id ) WHERE h.is_approval='1' AND h.is_active='1' $cwh  $key $fliter HAVING distance < '%s'  $disc $sorts LIMIT $start, $limit", ($latitude), ($longitude), ($latitude), ($radius));
        ...
        if ($count > 0) {
                foreach ($query->result_array() as $row) {
                    ...
                    $certified = $row['certified'];
                    $profile_views = '0';
                    $surgey_discount = $row['package_discount'];
                    $package_name = $row['package_name'];
                    $packageamount=$row['package_amount'];
                    $package_id=$row['package_id'];
                  
                 
                    $sql = "SELECT * FROM `hospital_packages` WHERE id='$package_id'";
                    $query = $this->db->query($sql);
                    $count = $query->num_rows();
                    $qRow=$query->row_array();
            
                 
                    $type2              = $qRow['treatment_type'];
                    ...
                    $type               = $qRow['type_room'];
                    $package_treatment  = $qRow['package_type'];
                
                    $category_query = $this->db->query("SELECT category FROM `hospital_package_category` WHERE id='$package_treatment'");
                    $category_glist=$category_query->row_array();
                    $package_category = $category_glist['category'];
                   ...
                   // $package_type       = $qRow['package_type'];
                    ...
                    $s_id = $qRow['surgery_id'];
                    $surgey_id = explode(",",$s_id);
                    $hospital_surgery=array();
                    for($i=0;$i<count($surgey_id);$i++)
                        {
                        //echo "SELECT * FROM surgery_master WHERE id = '$s_id'";
                        $sgquery = $this->db->query("SELECT * FROM surgery_master WHERE id = '$surgey_id[$i]'");
                        $sgquerys = $sgquery->result_array();
                         $sgquery_count = $sgquery->num_rows();
                         if($sgquery_count > 0)
                         {
                ...
                $hospital_wards_query = $this->db->query("SELECT p.*, h.id as ward,h.hospital_id,h.room_type,h.capacity,h.details,h.created_at,hp.package_amount FROM package_wards as p LEFT JOIN hospital_packages as hp ON (p.package_id=hp.id) LEFT JOIN hospital_wards as h ON (p.ward_id=h.id) WHERE p.hospital_id = '$hospital_user_id' and p.package_id='$package_id'");
                ...
                else
                {
                    ...
                    elseif($type=="without room")
                     {
                         /*echo "SELECT * FROM `hospital_wards` WHERE hospital_id = '$hospital_user_id' ";*/
                    $hospital_wards_query = $this->db->query("SELECT * FROM `hospital_wards` WHERE hospital_id = '$hospital_user_id' ");
                    $hospital_wards_count = $hospital_wards_query->num_rows();
                    $hospital_wards       = $hospital_wards_query->result_array();
                    $hospital_wards_list= array();
                    if($hospital_wards_count>0)
                    ...
                    {
                   // $new=($packageamount*$surgey_discount)/100;
                    $final_amount=$packageamount-$surgey_discount;
                    }
                    else
                    {
                      $final_amount = $packageamount;
                    ...
                    $resultpost[] = array(
                        ...
                        'name_of_hospital' => $name_of_hospital,
                        'listing_type' => "8",
                        'hospitals_package_name' => $package_name,
                        'hospitals_surgery_discount' =>$surgey_discount,
                        'hospitals_surgery_name' =>"",
                        'old_price'=>$packageamount,
                        'new_price'=>$final_amount,
                        'address' => $address,
                        'mobile' => $mobile,
 ...
 public function elasticsearchsize3($index_id,$hospital_id,$keyword){
        $returndoctor = array();
        $perc=array();
     	$data = array("query"=>array("bool"=>array("should"=>array(array("match"=>array("id"=>"$hospital_id" )),array("match"=>array("package_name"=>"$keyword" ))))),"suggest"=>array("my-suggestion"=>array("text"=>$keyword, "term"=>array("field"=>"package_name")))); 
...
public function hospital_detail_surgery($user_id, $latitude, $longitude, $category_id,$page,$type2,$keyword,$sort,$hospital_id,$sorts) 
{
    $radius = $page*500;
    $limit = 10;
    $start = 0;
       ...
       if($category_id!="0")
       {
           $cwh .=" AND FIND_IN_SET('" . $category_id . "', package_type) ";
       }
        $key="";
       if($keyword!="")
       {
           $key .=" AND package_name LIKE '%%$keyword%%' ";
       }
         $sorts ="";
        if($sort=="3")
           {
           $sorts .="ORDER BY  TRIM(package_name)";
           }
        elseif($sort=="4")
           {
              $sorts .= " ORDER BY  TRIM(package_name) DESC " ;
           } 
      if($keyword!=""){
       $index_id="hospital_package";
        $sql=$this->elasticsearchsize3($index_id,$hospital_id,$keyword); 
         $count = count($sql);
        $query1=$sql;
        
      }else{
        $sql = "SELECT * FROM `hospital_packages` WHERE hospital_id='$hospital_id' and FIND_IN_SET('" . $type2 . "', treatment_type) $cwh $sorts LIMIT $start, $limit ";
         $query = $this->db->query($sql);
         $count = $query->num_rows();
        ...
        if ($count > 0) {
               foreach($query1 as $qRow)
            {
              ...
              if($type=="with room")
                 {
            $hospital_wards_query = $this->db->query("SELECT p.*, h.id as ward,h.hospital_id,h.room_type,h.capacity,h.details,h.created_at,hp.package_amount FROM package_wards as p LEFT JOIN hospital_packages as hp ON (p.package_id=hp.id) LEFT JOIN hospital_wards as h ON (p.ward_id=h.id) WHERE p.hospital_id = '$hospital_id' and p.package_id='$package_id'");
            $hospital_wards_count = $hospital_wards_query->num_rows();
            $hospital_wards       = $hospital_wards_query->result_array();
            $hospital_wards_list= array();
            if($hospital_wards_count>0)
          ...
          elseif($type=="without room")
          {
            $hospital_wards_query = $this->db->query("SELECT * FROM `hospital_wards` WHERE hospital_id = '$hospital_id' ");
            $hospital_wards_count = $hospital_wards_query->num_rows();
            $hospital_wards       = $hospital_wards_query->result_array();
            $hospital_wards_list= array();
            if($hospital_wards_count>0)
 ...
 public function hospital_doctor_list_new_v1($mlat, $mlng,$hospital_id,$category_id,$page,$user_id) {
     ...
     $radius = '3';
      $limit = 10;
       ...
       if($category_id!="0")
       {
           $cwh .=" AND FIND_IN_SET('" . $category_id . "', category) ";
       }
        
        
        $query = $this->db->query("SELECT doctor_list.mba,doctor_list.consultaion_video,doctor_list.consultaion_chat,doctor_list.consultation_voice_call,doctor_list.recommended,doctor_list.certified,doctor_list.user_id,doctor_list.doctor_name,doctor_list.email,doctor_list.gender,doctor_list.telephone,doctor_list.dob,doctor_list.category,doctor_list.speciality,doctor_list.service,doctor_list.qualification,doctor_list.experience,doctor_list.reg_council,doctor_list.reg_number,doctor_list.image,doctor_list.discount,doctor_clinic.clinic_name,doctor_clinic.address,doctor_clinic.city,doctor_clinic.state,doctor_clinic.pincode,doctor_clinic.lat,doctor_clinic.lng FROM doctor_list INNER JOIN  doctor_clinic ON doctor_list.user_id=doctor_clinic.doctor_id WHERE  doctor_list.is_active = 1 and doctor_clinic.hospital_id=$hospital_id $cwh LIMIT $start, $limit");
 ...
 public function hospital_doctor_list_new_v2($mlat, $mlng,$hospital_id,$category_id,$page,$user_id) {
     ...
     $radius = '3';
      $limit = 10;
       ...
       if($category_id!="0")
       {
        ...
        $query1 = $this->db->query("SELECT hd.*,h.name_of_hospital from hospital_doctor_list as hd LEFT JOIN hospitals as h on (h.user_id = hd.hospital_id ) WHERE hd.hospital_id='$hospital_id' $cwh LIMIT $start, $limit");
      //  $result = $query->result_array(); 
            ...
            foreach ($query1->result_array() as $row1) 
                    {
                        ...
                        $query = $this->db->query("SELECT doctor_list.mba,doctor_list.consultaion_video,doctor_list.consultaion_chat,doctor_list.consultation_voice_call,doctor_list.recommended,doctor_list.certified,doctor_list.user_id,doctor_list.doctor_name,doctor_list.email,doctor_list.gender,doctor_list.telephone,doctor_list.dob,doctor_list.category,doctor_list.speciality,doctor_list.service,doctor_list.qualification,doctor_list.experience,doctor_list.reg_council,doctor_list.reg_number,doctor_list.image,doctor_list.discount,doctor_clinic.clinic_name,doctor_clinic.address,doctor_clinic.city,doctor_clinic.state,doctor_clinic.pincode,doctor_clinic.lat,doctor_clinic.lng FROM doctor_list INNER JOIN  doctor_clinic ON doctor_list.user_id=doctor_clinic.doctor_id WHERE doctor_list.hospital_doctor_id IN ($id)");
                        $count = $query->num_rows();
                        if($count > 0)
                        {
                            $row=$query->row_array();
                        ...
                        else
                        {
                            ...
                            $degree = $row1['qualifications'];
                            $experience = $row1['experience'];
                            $reg_council = $row1['reg_council'];
                            $reg_number = $row1['reg_number'];
                            $doctor_user_id = $row1['id'];
                            $clinic_name = $row1['name_of_hospital'];
                            ...
                            $mba = $row1['mba'];
                            $certified = $row1['certified'];
                            $recommended = $row1['recommended'];
                            $video = $row1['consultaion_video'];
                            $chat  = $row1['consultaion_chat'];
                            $call  = $row1['consultation_voice_call'];
                            $followers           = $this->db->select('id')->from('follow_user')->where('parent_id', $doctor_user_id)->get()->num_rows();
                            $following           = $this->db->select('id')->from('follow_user')->where('user_id', $doctor_user_id)->get()->num_rows();
                            $is_follow           = $this->db->select('id')->from('follow_user')->where('user_id', $user_id)->where('parent_id', $doctor_user_id)->get()->num_rows();
                            if ($is_follow > 0) {
                            ...
                            $new_consultation_charges=array();
                            $doctor_practices = array();
                             $sql2             = sprintf("SELECT * FROM  hospitals WHERE user_id='$hospital_id' ");
                            $query_practices  = $this->db->query($sql2);
                            $total_practices  = $query_practices->num_rows();
                            if ($total_practices > 0) 
                               {
                                ...
                                foreach ($query_practices->result_array() as $get_pract) 
                                        {
                                            ...
                                            $clinic_phone         = $get_pract['phone'];
                                            $clinic_address       = $get_pract['map_location'];
                                            $clinic_state         = $get_pract['state'];
                                            $clinic_city          = $get_pract['city'];
                                            $clinic_pincode       = $get_pract['pincode'];
                                            $clinic_image         = $get_pract['image'];
                                            $opening_hours        = $row1['timing'];
                                            $consultation_charges = $row1['consultation'];
                                            if ($clinic_image != '') {
                                                $clinic_image = 'https://d2c8oti4is0ms3.cloudfront.net/images/doctor_images/' . $clinic_image;
                                            } else {
                                                $clinic_image = '';
                                    ...
                                    $queryTiming1 = $this->db->query("SELECT * FROM `hospital_doctor_slot_details` WHERE `doctor_id` = '$doctor_user_id' and consultation_type='visit'" );
                                    $countTiming1 = $queryTiming1->num_rows();
                                    if(count($countTiming1) > 0 )
                                    {
                                    // die();
...
public function hospital_detail_surgery_search($user_id,$category_id,$type2,$hospital_id) 
{
       ...
       if($category_id!="0")
       {
        ...
        $sql = "SELECT * FROM `hospital_packages` WHERE hospital_id='$hospital_id' and FIND_IN_SET('" . $type2 . "', treatment_type) $cwh ";
         $query = $this->db->query($sql);
         $count = $query->num_rows();
         $query1=$query->result_array();
...
public function hospitals_appointment($user_id, $hospital_id, $surgery_id, $patient_name, $gender, $age, $mobile, $ts1_date, $ts1_time, $ts2_date, $ts2_time, $medical_condition) {
    ...
    public function add_review($user_id, $listing_id, $rating, $review, $service) {
     ...
     public function edit_review($review_id,$user_id, $listing_id, $rating, $review, $service) {
        ...
        $review_array = array(
           ...
           $this->db->where('user_id',$user_id);
           $this->db->update('hospital_review',$review_array);
 ...
 $resultcomment = array();
    ...
    public function hospital_booking($user_id,$listing_id,$package_id,$ward_id,$name,$gender, $patient_name, $patient_relation, $patient_dob, $patient_gender, $amount, $patient_age, $patient_allergies, $emergency, $patient_preferred_date, $patient_addiction, $ambulance_pickup_address,$patient_id, $ambulance_drop_address) {
        ...
        $gallery_query = $this->db->query("SELECT * FROM booking_master WHERE user_id='$user_id' AND  listing_id = '$listing_id' AND vendor_id='8' AND status = 'Pending'");
        ...
        $lastid=$this->db->insert_id();
            ...
            if ($customer_token_count > 0) {
                ...
                $this->send_gcm_notify($title, $reg_id, $msg, $img_url, $tag, $agent);
                 if(!empty($user_email))
                     {
                        $this->hospital_booking_sendmail($user_email, $msg);
                     }
     ...
     public function hospital_booking_v2($user_id,$listing_id,$package_id,$ward_id,$amount,$emergency, $patient_preferred_date, $ambulance_pickup_address,$patient_id, $ambulance_drop_address,$patient_allergies,$patient_addiction) {
        $lastid ="";
        date_default_timezone_set('Asia/Kolkata');
        $date = date('Y-m-d H:i:s');
        $booking_id  = date("YmdHis");
        ...
        $lastid=$this->db->insert_id();
           ...
           /* $ledger_id='0';
            ...
            if($lastid>0 ){
    				...
    				$trans_status='';
    				$payment_type='';
                    //$res=$this->LedgerModel->create_ledger($user_id, $booking_id, $ledger_owner_type, $listing_id, $listing_id_type, $credit, $amount, $payment_type, $user_comments, $mw_comments,$vendor_comments,$order_type,$transaction_of,$transaction_id,$trans_status);
   ...
   public function wellness_clinic_list($latitude, $longitude, $user_id, $category_name,$page,$keyword)
   {
       if($page==""){
         $page=1;   
        }
     ...
     if($keyword!=""){
        $sql = sprintf("SELECT `id`, `user_id`, `name_of_hospital`,`phone`,`about_us`, `establishment_year`,`certificates_accred`, `category`, `speciality`, `surgery`,`services`, `address`, `pincode`, `city`, `state`, `email`, `lat`, `lng`, `image`, `rating`, `review`,  `date`, `is_active`,`establishment_year`,`user_discount`,( 6371 * acos( cos( radians($latitude) ) * cos( radians( lat ) ) * cos( radians( lng ) - radians($longitude) ) + sin( radians($latitude) ) * sin( radians( lat ) ) ) ) AS distance FROM wellness_clinic WHERE is_approval='1' AND is_active='1' and name_of_hospital LIKE '%%$keyword%%' HAVING distance < '%s' ORDER BY distance LIMIT $startk, $limitk", ($latitude), ($longitude), ($latitude), ($radius));
    }
   else
   {
        $sql = sprintf("SELECT `id`, `user_id`, `name_of_hospital`,`phone`,`about_us`,`establishment_year`, `certificates_accred`, `category`, `speciality`, `surgery`,`services`, `address`, `pincode`, `city`, `state`, `email`, `lat`, `lng`, `image`, `rating`, `review`,  `date`, `is_active`,`establishment_year`,`user_discount`,( 6371 * acos( cos( radians($latitude) ) * cos( radians( lat ) ) * cos( radians( lng ) - radians($longitude) ) + sin( radians($latitude) ) * sin( radians( lat ) ) ) ) AS distance FROM wellness_clinic WHERE  is_approval='1' AND is_active='1' HAVING distance < '%s' ORDER BY distance  LIMIT $start, $limit", ($latitude), ($longitude), ($latitude), ($radius));
    }
        $query = $this->db->query($sql);
        $count = $query->num_rows();
         if ($count > 0) {
   ...
   //***************************added for wellness clinic details by zak***********************************
    ...
    public function nursing_home_list($latitude, $longitude, $user_id, $category_name,$page,$keyword)
   {
        if($page==""){
         $page=1;   
        }
            ...
            if($query_count>0)
              {
                ...
                $wellness_service_list = array();
                if($services != ''){
                    $wellness_services_query = $this->db->query("SELECT `service_name` FROM `nursing_metarinity_services` WHERE FIND_IN_SET(id,'" . $services . "')");
                    foreach ($wellness_services_query->result_array() as $get_serlist) {
                        $service_name = $get_serlist['service_name'];
                        $wellness_service_list[] = array(
                            "service_name" => $service_name
              ...
              //  echo"SELECT * FROM `wellness_branch` WHERE hospital_id='$wellness_user_id' order by id asc";
                ...
                if ($branch_count > 0) {
                    foreach ($branch_query->result_array() as $branch_row) {
                        ...
                        $approval_date                           = $branch_row['approval_date'];
                        $is_active_date                          = $branch_row['is_active_date'];
                        if(empty($certificates_accred_list))
                        {
                            $certificates_accred_list=array();
                        }
                        else
 ...
 if(empty($branch_category))
                        ...
                        $wellness_service_list_1 = array();
                if($hospitals_service_list != ''){
                    $wellness_services_query_1 = $this->db->query("SELECT `service_name` FROM `nursing_metarinity_services` WHERE FIND_IN_SET(id,'" . $hospitals_service_list . "')");
                    foreach ($wellness_services_query_1->result_array() as $get_serlist_1) {
                        $service_name_1 = $get_serlist_1['service_name'];
                        $wellness_service_list_1[] = array(
              ...
              if(empty($hospitals_surgery_list))
              {
                  $hospitals_surgery_list=array();
              }
              else
              {
               ...
               $wellness_speciality_list_1 = array();
                if($hospitals_speciality_list != ''){
                    $wellness_speciality_query_1 = $this->db->query("SELECT `id`,`doctors_category`,`name`, image FROM `nursing_metarinity_specialist` WHERE FIND_IN_SET(name,'" . $speciality . "')");
                    foreach ($wellness_speciality_query_1->result_array() as $get_splist_1) {
                        $specialist_id = $get_splist_1['id'];
                        $specialist_name = $get_splist_1['name'];
                        $doctors_category = $get_splist_1['doctors_category'];
                        $specialist_image = $get_splist_1['image'];
                ...
                else
                {
                    $wellness_speciality_list_1=array();
                        ...
                        $branch_list[] = array(
                            ...
                            'certificates_accred_list'=>array(),
                            'category' => $branch_category,
                            'speciality' => $wellness_speciality_list_1,
                            'surgery' => $hospitals_surgery_list,
                            'services' => $wellness_service_list_1,
                            'address' => $branch_address,
                            'pincode' => $branch_pincode,
                            'phone' => $branch_phone,
                            'lat' => $branch_lat,
   ...
   $distances = str_replace(',', '.', GetDrivingDistance($latitude, $lat, $longitude, $lng));
    ...
    {
        $customer_token       = $this->db->query("SELECT email,name,token,agent,token_status,web_token FROM users WHERE id='$listing_id'");
        $customer_token_count = $customer_token->num_rows();
        if ($customer_token_count > 0) {
            $token_status = $customer_token->row_array();
            ...
            $this->send_gcm_notify_booking($title, $reg_id, $msg, $img_url, $tag, $agent, $booking_date, $booking_time, $appointment_id, $connect_type);
             ...
             $notification_array = array(
                ...
                $this->db->insert('All_notification_Mobile', $notification_array);
                 if(!empty($user_email))
                     {
                        $this->hospital_booking_sendmail($user_email, $msg_mail);
                     }
   ...
   public function confirm_cash_on_delivery_status($user_id, $booking_id, $listing_id)
      ...
      public function notifyHospitalMethod($listing_id, $user_id,$title,$msg, $booking_date, $booking_time, $booking_id, $consultation_type, $patient_name)
    {
          ...
          $customer_token = $this->db->query("SELECT email,name,token,agent,token_status FROM users WHERE id='$listing_id'");
          $customer_token_count = $customer_token->num_rows();
            if ($customer_token_count > 0) {
                $token_status = $customer_token->row_array();
                // $getusr = $user_plike->row_array();
  ...
  public function surgey_category($latitude,$longitude,$user_id,$type)
    {
        // 1- popular category , 2 - popular surgey  Start Here
        date_default_timezone_set('Asia/Kolkata');
        $current_date = date('Y-m-d H:i:s');
        
          if($type=="1")
          {
        $sqldi   =  "SELECT * from surgery_master_category LIMIT 10 ";
        $querydi = $this->db->query($sqldi);
        $countdi = $querydi->num_rows();
        if ($countdi > 0) {
            
            foreach ($querydi->result_array() as $row) 
            {
                $id            = $row['id']; 
         ...
         // genral Doctor End Here
          ...
          elseif($type=="2")
          {
               $sqldi   =  "SELECT * from surgery_master where category_id !='' ORDER BY id desc LIMIT 10 ";
        $querydi = $this->db->query($sqldi);
        $countdi = $querydi->num_rows();
        if ($countdi > 0) {
            ...
            {
                $id            = $row['id']; 
                $category_name = $row['surgery_name'];
                $cat_id=$row['subcategory_id'];
                $resultpost[]  = array(
                                        'id' => $id,
                                        'category_id'=>$cat_id,
                                        'surgery_name' => $category_name,
                                        'surgey_image' => ""
    ...
    public function view_all_category($latitude,$longitude,$user_id,$page)
    {
        ...
        $current_date = date('Y-m-d H:i:s');
        $sqldi   =  "SELECT * from surgery_master_category LIMIT $start, $limit ";
        $querydi = $this->db->query($sqldi);
        $countdi = $querydi->num_rows();
        if ($countdi > 0) {
            ...
            foreach ($querydi->result_array() as $row) 
            {
                ...
                $sqldi2   =  "SELECT * from surgery_master where subcategory_id ='$id'";
        $querydi2 = $this->db->query($sqldi2);
        $countdi2 = $querydi2->num_rows();
        if ($countdi2 > 0) {
            
            foreach ($querydi2->result_array() as $row2) 
            {
                $id2            = $row2['id']; 
                $category_name2 = $row2['surgery_name'];
                $resultpost2[]  = array(
                                        'id' => $id2,
                                        'surgery_name' => $category_name2,
                                        'surgey_image' => ""
