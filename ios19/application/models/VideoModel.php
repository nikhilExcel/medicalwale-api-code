     ...
     public function med_tube($user_id)
    {
        ...
        if ($other_count > 0) {
            ...
            foreach ($other_query->result_array() as $row) {  
                ...
                if ($type == 'health_news') {
                    if ($video_thumbnail != '') {
                        $video           = 'https://d2c8oti4is0ms3.cloudfront.net/images/health_news/' . $video;
                        $video_thumbnail = 'https://d2c8oti4is0ms3.cloudfront.net/images/health_news/thumb/' . $video_thumbnail;
                    } else {
                        $video_thumbnail = '';
                    }
                    $health_news[] = array(
                        ...
                        'total_views' => $total_views,
                        'like_yes_no' => $like_yes_no,
                        'url' => 'https://medicalwale.com/apphealthnews/' . $id
                    );
                }
                if ($type == 'health_test') {
                    if ($video_thumbnail != '') {
                        $video           = 'https://d2c8oti4is0ms3.cloudfront.net/images/health_test/' . $video;
                        $video_thumbnail = 'https://d2c8oti4is0ms3.cloudfront.net/images/health_test/thumb/' . $video_thumbnail;
                    } else {
                        $video_thumbnail = '';
                    }
                    $health_test[] = array(
                        ...
                        'total_views' => $total_views,
                        'like_yes_no' => $like_yes_no,
                        'url' => 'https://medicalwale.com/apphealthtest/' . $id
                    );
                }
                if ($type == 'survivor') {
                    if ($video_thumbnail != '') {
                        $video           = 'https://d2c8oti4is0ms3.cloudfront.net/images/survivor/' . $video;
                        $video_thumbnail = 'https://d2c8oti4is0ms3.cloudfront.net/images/survivor/thumb/' . $video_thumbnail;
                    } else {
                        $video_thumbnail = '';
                    }
                    $survivor[] = array(
                        ...
                        'total_views' => $total_views,
                        'like_yes_no' => $like_yes_no,
                        'url' => 'https://medicalwale.com/appsurvivor/' . $id
                    );
                }
                if ($type == 'home_remedies') {
                    if ($video_thumbnail != '') {
                        $video           = 'https://d2c8oti4is0ms3.cloudfront.net/images/home_remedies/' . $video;
                        $video_thumbnail = 'https://d2c8oti4is0ms3.cloudfront.net/images/home_remedies/thumb/' . $video_thumbnail;
                    } else {
                        $video_thumbnail = '';
                    }
                    $home_remedies[] = array(
                        ...
                        'total_views' => $total_views,
                        'like_yes_no' => $like_yes_no,
                        'url' => 'https://medicalwale.com/apphomeremedies/' . $id
                    );
                }
            }
        } else {
