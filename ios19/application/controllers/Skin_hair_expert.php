                ...
                if ($response['status'] == 200) {
                    ...
                    if ($params['user_id'] == "" || $params['user_name'] == "" || $params['question'] == "" || $params['type'] == "") {
                       ...
                       // $article_title = $_POST['article_title'];
                        ...
                        $resp = $this->Skin_hair_expert_model->skin_hair_edit_question($type,$user_id,$post_id, $for_user_id, $user_name, $user_image, $question, $age, $height, $weight, $diet_preference, $post_location, $skin_type, $skin_color, $skin_concern, $skin_concern_other, $is_anonymous);
                    }
                    simple_json_output($resp);
                }
            }
