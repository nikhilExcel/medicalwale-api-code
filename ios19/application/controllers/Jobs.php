    ...
    public function user_profile() {
        ...
        if ($method != 'POST') {
            ...
            if ($user_id == "" || $first_name == "" || $last_name == "" || $mobile == "" || $email == "")  {
                ...
                $result = $this->JobsprofileModel->user_profile($user_id, $first_name, $last_name, $mobile,$email,$dob,$gender,$marital_status,$languages_known,$nationality, $address_line1, $address_line2, $city, $state,$country, $pincode, $mother_tongue);
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    if ( $params['user_id'] =="" || $params['company_id'] =="") {
                        ...
                        $resp = $this->JobsprofileModel->company_job_listing($user_id,$company_id,$page);
                    }
                    json_outputs($resp);
                }
            }
