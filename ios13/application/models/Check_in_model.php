...
class Check_in_model extends CI_Model
{
    ...
    $distances = str_replace(',', '.', GetDrivingDistance($mlat, $lat, $mlng, $lng));
     ...
     public function addCheckInDetails($user_id,$vendor_id,$amount,$tags)
    {
        ...
        $date = date('Y-m-d H:i:s');
         ...
         $p_results = $this->db->query("INSERT INTO `check_in_data`(`vendor_id`, `user_id`, `bill_image`, `tags`, `amount`, `created_at`) VALUES('$vendor_id','$user_id','$profile_pic' ,'$tags', '$amount','$date')");
