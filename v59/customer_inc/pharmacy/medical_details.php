...
if (isset($_POST['user_id'])) {
    ...
    while ($row = mysqli_fetch_array($res)) {
        ...
        $resultpost[] = array(
            ...
            'opening_day' => $opening_daydistance
        );
    }
    $resultset = array(
        'status' => '200',
