            ...
            if ($check_auth_client == true) {
                ...
                if ($mno_id == "" ||  $invoice_no == "") {
                    ...
                    if($res ==  1){
                        ...
                        $data = array();
                        $data = $this->PartnermnoModel->order_details($invoice_no);
                        $resp = array(
                            'status' => 200,
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    if ($params['mno_id'] == "") {
                        ...
                        $res = $this->PartnermnoModel->suggested_pharmacy_list($mno_id,$page_no,$per_page);
                        if($res['mno_exists'] == 0){
                             $resp = array(
                                'status' => 400,
                                'message' => 'Night night owl found',
        ...
        if ($method != 'POST') {
            ...
            if ($check_auth_client == true) {
                ...
                if ($mno_id == "" || $invoice_no == "") {
                    ...
                    $res = $this->PartnermnoModel->order_to_pharmacy($mno_id, $invoice_no);
                    if(sizeof($res) > 0){
                        $resp = array(
                            'status' => 200,
                            'message' => 'success',
