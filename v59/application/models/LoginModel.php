    ...
    public function checkUserDetails($user_id) {
	   ...
	   $gmtdate= gmdate('D, d M Y H:i:s \G\M\T', time());
        return array(
            ...
            'is_Miss_belly_activated' => $Miss_belly_status,
	'ServerTime'=>$gmtdate,
	'OfferDate'=>'12 Jun 2019',
	'OfferStartTime'=>'11 Jun 2019 | 11:59 PM',
	'OfferEndTime'=>'12 Jun 2019 | 11:59 PM',
	'OfferImageUrl'=>'https://medicalwale.s3.amazonaws.com/images/Festival_offer/onedayofferimage.png'	
        );
    }
...
$count = $query->num_rows();
    ...
    public function save_pdf_file($pdf_file_name, $user_id, $listing_id, $vendor_type, $type, $reason,$password) {
        ...
        if ($customer_token_count > 0) {
            ...
            $path ="/data/web/live.medicalwale.com/user_pdf/" . $pdf_file_name . ".pdf";
        ...
        return array(
            'status' => 201,
            'message' => 'success',
            'path' => 'https://newlive.medicalwale.com/user_pdf/' . $pdf_file_name . ".pdf"
        );
    }
