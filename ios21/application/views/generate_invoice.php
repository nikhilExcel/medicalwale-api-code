...
<table  cellpadding="1" cellspacing="0" style="width:35%">
    <tbody>
        ...
        <tr>
            <td colspan='2' style="border:1px solid #ddd;border-right:none!important;vertical-align:baseline;" >
            ...
            <td colspan='3' style="border:1px solid #ddd;border-left:none!important;border-right:none!important;vertical-align:baseline;" >
       ...
       // $ap= $this->PharmacyPartnerModel->get_pro_name($dat->product_id);
        ...
        <tr>
            ...
            <td style="border:1px solid #ddd;border-top:none!important;border-right:none!important;text-align:right;font-size:8px;text-align:center;"><?php echo number_format($cgst,2) ; ?></td>
            ...
            <td style="border:1px solid #ddd;border-top:none!important;border-right:none!important;text-align:right;font-size:8px;text-align:center;"><?php echo number_format($sgst,2) ; ?></td>
       ...
       // $ap= $this->PharmacyPartnerModel->get_pro_name($dat->product_id);
        ...
        <tr>
            ...
            <td style="border:1px solid #ddd;border-top:none!important;border-right:none!important;text-align:center;font-size:8px;text-align:center;"><?php echo number_format($cgst,2) ; ?></td>
            ...
            <td style="border:1px solid #ddd;border-top:none!important;border-right:none!important;text-align:center;font-size:8px;text-align:center;"><?php echo number_format($sgst,2) ; ?></td>
