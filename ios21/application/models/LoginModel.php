...
/*fOR *th dec event added $amount = 99 : Please change the logic and connect it with coupon code - Swapnali */          
        $query1 = $this->db->query("SELECT * FROM vendor_offers WHERE name='$coupon' and (vendor_id='$listing_id' || vendor_id='0') and end_date >= '$current_date' and min_amount <= '$amount' AND '$amount' = '99' AND `status` = '0' ");
