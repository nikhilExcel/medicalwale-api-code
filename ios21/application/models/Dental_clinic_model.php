    ...
    public function service_cart_list($user_id)
    {
        ...
        if(!empty($ser))
        {
            foreach ($ser as $mser1) {
                ...
                $Querys1 = $this->db->query("SELECT image,price,discount FROM dental_services_offered WHERE service_name='$service_name' $w LIMIT  1");
