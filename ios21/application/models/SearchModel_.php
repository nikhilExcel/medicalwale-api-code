...
*/
            ...
            $resultpost = array_merge($people_array, $doctor_array,$dental_clinic_array, $pharmacy_array,  $labs_array, $nursing_array, $fitness_array,$spa_center_array, $hospital_array, $healthwall_array, $article_array,$tips_array,$skin_array,$mom_array, $survivor_array,$hm_product_array,$jobs_array);
