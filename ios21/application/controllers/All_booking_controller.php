...
class All_booking_controller extends CI_Controller
{
      ...
      public function all_booking_details()
    {
      ...
      public function all_booking_details_v1()
    {
        $this->load->model('All_booking_model');
        $method = $_SERVER['REQUEST_METHOD'];
        if ($method != 'POST') {
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    if ($params['user_id'] == "") {
                        ...
                        $user_id    = $params['user_id'];
                        $page = $params['page'];
                        $resp       = $this->All_booking_model->all_booking_details_v1($user_id,$page);
                    }
     ...
     public function all_booking_details_v2()
    {
        $this->load->model('All_booking_model');
        $method = $_SERVER['REQUEST_METHOD'];
        if ($method != 'POST') {
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    if ($params['user_id'] == "") {
                        ...
                        $user_id    = $params['user_id'];
                        $page = $params['page'];
                        $v_id = $params['vendor_type'];
                        $resp       = $this->All_booking_model->all_booking_details_v2($user_id,$page,$v_id);
                    }
                    json_outputs($resp);
                }
            }
      ...
      public function subscription_bachat_booking()
    {
        $this->load->model('All_booking_model');
        $method = $_SERVER['REQUEST_METHOD'];
        if ($method != 'POST') {
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    if ($params['user_id'] == "") {
                        ...
                        $user_id    = $params['user_id'];
                        $page = $params['page'];
                        $resp       = $this->All_booking_model->subscription_bachat_booking($user_id,$page);
                    }
                    simple_json_output($resp);
                }
            }
     ...
     public function all_booking_details_noti()
    {
        $this->load->model('All_booking_model');
        $method = $_SERVER['REQUEST_METHOD'];
        if ($method != 'POST') {
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    if ($params['user_id'] == "") {
                        ...
                        $v_id = $params['vendor_type'];
                        $resp       = $this->All_booking_model->all_booking_details_noti($user_id,$booking_id,$v_id);
                    }
                    json_outputs($resp);
                }
            }
      ...
      public function all_booking_details_v12()
    {
        $this->load->model('All_booking_model');
        $method = $_SERVER['REQUEST_METHOD'];
        if ($method != 'POST') {
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    if ($params['user_id'] == "") {
                        ...
                        $user_id    = $params['user_id'];
                        $page = $params['page'];
                        $resp       = $this->All_booking_model->all_booking_details_v12($user_id,$page);
                    }
                    simple_json_output($resp);
                }
            }
      ...
      public function all_booking_details_search()
    {
        $this->load->model('All_booking_model');
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    if ($params['user_id'] == "") {
                        ...
                        //$v_id = $params['vendor_type'];
                        $keyword = $params['keyword'];
                        $resp       = $this->All_booking_model->all_booking_details_search($user_id,$keyword);
                    }
                    json_outputs($resp);
                }
            }
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    if ($params['user_id'] == "" || $params['lat'] == "" || $params['lng'] == "") {
                        ...
                        $vendor_id  = $params['vendor_id'];
                        $keyword  = $params['keyword'];
                        $resp       = $this->All_booking_model->all_vendor_list($user_id, $lat, $lng,$page,$vendor_id,$keyword);
                    }
                    json_outputs($resp);
                }
            }
