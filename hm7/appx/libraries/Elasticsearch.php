...
class Elasticsearch
{
    ...
    public function __construct()
    {
        ...
        $this -> server = "https://search-mw-domain01-sr5e5n4szx6xtfbqbujw7engbe.us-east-1.es.amazonaws.com";
    ...
    {
        return $this -> call($index_id,'_search?' . http_build_query(array('q' =>"name:".$query, 'size' => $size)));
    }
