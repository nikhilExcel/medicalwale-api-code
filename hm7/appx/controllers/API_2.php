...
public function get_personal_care_products(){
	...
	public function rapid_pickup(){
	    ...
	    return $result = $this->MedicalMall_model_2->rapid_pickup($invoice_no,$name,$mobileno,$address,$address1,$pincode,$landmark,$city,$state,$amount,$paym);
	}
			...
			if($check_auth_client == true){
		        ...
		        if($response == 200){
                    ...
                    // place orde
                            ...
                            // print_r($pro);die;
                            $products = $pro;
                            $result[] = $this->MedicalMall_model_2->place_order1($data, $allowed,$products);
