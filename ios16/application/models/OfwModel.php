...
$ch = curl_init('http://sandboxapi.medicalwale.com/v51/ofw/get_menstrual_cycle_data_calendar_wise');
curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
		...
		<table border="0" class="table-head" cellspacing="0" cellpadding="0">
         <h3 class="mb-0"><b>Patient Details:</b></h3>
          ...
          <tr>
      	 ...
      	 $output.='<table border="0" class="table-head" cellspacing="0" cellpadding="0">
         <h3 class="mb-0"><b>Activity Details:</b></h3>';
      
      $query = $this->db->query("SELECT sub_category,child_category,status,date,image from Menstraul_cycle_subcategory_status where user_id='$user_id' and profile_id='$profile_id'");
           ...
           <tr>
            <td><b>Activity:</b> '.$category_name.'</td>        
            <td><b>Type:</b> '.$child_category.'</td>        
          </tr> ';    
