            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    if ($params['lat'] == "" || $params['long'] == "" || $params['cat_id'] == "" || $params['type'] == "") {
                        ...
                        $resp = $this->HospitalModel->hospital_list_surgery($user_id, $latitude, $longitude, $category_id,$page,$type,$keyword,$sort);
                    }
                    json_outputs($resp);
                }
            }
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    if ($params['latitude'] == "" || $params['longitude'] == "" ) {
                        ...
                        $latitude = $params['latitude'];
                        $longitude = $params['longitude'];
                        $resp = $this->HospitalModel->list_surgey_category($latitude, $longitude, $user_id);
                    }
                    json_outputs($resp);
                }
            }
        ...
        if ($method != 'POST') {
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    $params = json_decode(file_get_contents('php://input'), TRUE);
                    ///print_r($params);
                    if ($params['user_id'] == "" || $params['listing_id'] == "" || $params['package_id'] == "" || $params['ward_id']==""  || $params['amount'] == ""  || $params['patient_preferred_date'] == "" ) {
                       // $resp = array('status' => 400, 'message' => 'please enter fields');
                        json_output(400, array('status' => 400, 'message' => 'please enter fields'));
                      //  echo json_output($resp);
                         //echo "undashfdsgklnhfsdgdfghgdlkhnzfxfdf";
