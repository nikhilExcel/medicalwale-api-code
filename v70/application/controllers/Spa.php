...
$package_id=$params['package_id'];
                        ...
                        $resp = $this->SpaModel->spa_package($user_id,$package_id);
                    }
                    json_outputs($resp);
                }
            }
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    if ($params['user_id'] == "") {
                        ...
                        $resp = $this->SpaModel->spa_package_list_categorywise($user_id,$main_category,$sub_category,$tab_id,$sort,$latitude,$longitude,$price);
                    }
                    json_outputs($resp);
                }
            }
    ...
    public function related_spa_center_list_v2() {
        $this->load->model('SpaModel');
        $method = $_SERVER['REQUEST_METHOD'];
        if ($method != 'POST') {
            json_output(400, array(
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    $params = json_decode(file_get_contents('php://input'), TRUE);
                    if ($params['latitude'] == "" || $params['longitude'] == "" || $params['listing_id']== "") {
                        $resp = array(
                            'status' => 400,
                            'message' => 'please enter fields'
                        );
                        ...
                        $resp = $this->SpaModel->related_spa_center_list_v2($user_id,$latitude, $longitude, $listing_id, $page);
                    }
                    json_outputs($resp);
                }
            }
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    if ( $params['user_id'] == "" || $params['status'] == "" || $params['booking_id'] == "") {
                        ...
                        $resp = $this->SpaModel->user_payment_approval($status, $booking_id, $user_id);
                    }
                }
                simple_json_output($resp);
            }
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    $params = json_decode(file_get_contents('php://input'), TRUE);
                        ...
                        $resp = $this->SpaModel->spa_category_v3();
                ...
                if ($response['status'] == 200) {
                    ...
                    if ($this->input->post('user_id') == "" || $this->input->post('listing_id') == "" || $this->input->post('package_id') == "" || $this->input->post('branch_id') == "" || $this->input->post('category_id') == "") {
                       ...
                       /* $user_diet_preference= $params['diet_preference'];
                        ...
                        $resp = $this->SpaModel->add_bookings($user_id,$patient_id, $listing_id, $package_id, $branch_id, $category_id, $trail_booking_date, $trail_booking_time, $user_name, $user_mobile, $user_email, $user_gender,$user_age,$trainer_id,$address_id,$instruction,$amt,$payment_method,$transaction_id);
                    }
                    simple_json_output($resp);
                }
            }
    ...
    public function other_branch_packages() {
        $this->load->model('SpaModel');
        $method = $_SERVER['REQUEST_METHOD'];
        if ($method != 'POST') {
            json_output(400, array(
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    if ($params['user_id'] == "" || $params['listing_id'] == "" ) {
                        ...
                        $resp = $this->SpaModel->other_branch_packages($user_id, $listing_id, $package_id, $package_name, $package_price, $branch_id);
                    }
                    json_outputs($resp);
                }
            }
    ...
    public function spa_packages_categorywise()
    {
        $this->load->model('SpaModel');
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    if ($params['user_id'] == "") {
                        ...
                        $price = $params['price'];
                        $page = $params['page'];
                        $resp = $this->SpaModel->spa_packages_categorywise($user_id,$category_id,$tab_id,$sort,$latitude,$longitude,$price,$page);
    ...
    public function spa_packages_typewise()
    {
        $this->load->model('SpaModel');
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    if ($params['user_id'] == "") {
                        ...
                        $price = $params['price'];
                        $page = $params['page'];
                        $resp = $this->SpaModel->spa_packages_typewise($user_id,$category_id,$tab_id,$sort,$latitude,$longitude,$price,$page);
        ...
        if ($method != 'POST') {
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                   ...
                   // $resp = $this->SpaModel->update_ledger($user_id, $ledger_id, $invoice_no,$transaction_id , $trans_status,$type);
                    $this->load->model('LedgerModel');
                   $resp= $this->LedgerModel->update_ledger($user_id, $ledger_id, $invoice_no,$transaction_id , $trans_status,$type);
