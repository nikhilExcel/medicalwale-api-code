...
class PartnerModel extends CI_Model
{
    ...
    {
        if ($phone == '8655369076' || $phone=='8983779523') {
            $otp_code = '123456';
        } else {
    ...
    {
        $query = $this->db->query("SELECT id,name,gender,email,phone,city,vendor_id,otp_code FROM users WHERE phone='$phone' and vendor_id='5'");
        $count = $query->num_rows();
        if ($count > 0) {
