...
<?php echo $this->session->unset_userdata("type"); ?>
        ...
        $(document).on('click', '.btnaction', function () {
            ...
            if (action == 'view') {
                $.ajax({
                    type: 'post',
                    url: '<?php echo $this->config->base_url() ?>admin/viewDriver',
                    data: "user_id=" + id,
            ...
            if (action == 'edit') {
                $.ajax({
                    type: 'post',
                    url: '<?php echo $this->config->base_url() ?>admin/getDriver',
                    data: "user_id=" + id,
                    success: function (data) {
                        $("#confirm").modal("show");
                        $("#response").html(data);
                    ...
                    <div class="panel-body">
                        <div class="panel widget">
                            <div  class="panel-body table-responsive">
                                <div class="col-md-12">
                                    <form action="<?= $this->config->base_url() . 'admin/drivers_search' ?>" method="post">
                                        ...
                                        <?php if (!empty($chk)) { ?>
                                            <div class="col-md-1" style="margin-top:29px;width:105px;margin-left:14px">
                                                <a href="<?= $this->config->base_url() . 'admin/drivers' ?>" style="color: red">Clear search</a>
                                            </div>
                                        <?php } ?>
                            ...
                            <div class="panel-heading vd_bg-grey">
                                <h3 class="panel-title" style="color:white"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span> Drivers </h3>
                            </div>
                            <div  class="panel-body table-responsive">
