        ...
        $(document).on('click', '.btnaction', function () {
            ...
            if (action == 'edit' || action == "view") {
                ...
                $.ajax({
                    ...
                    url: '<?php echo $this->config->base_url() ?>admin/get_Comm',
                        ...
                        <div class="panel widget">
                            ...
                            <div  class="panel-body table-responsive">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <form action="<?= $this->config->base_url() . 'admin/Com_search' ?>" method="post">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input class="form-control" type="text" value="<?php echo!empty($data['driver_name']) ? $data['driver_name'] : ''; ?>" name="driver_name"/>
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <select class="form-control" name="type_id">
                                                ...
                                                <option <?php echo!empty($data['type_id']) ? $data['type_id'] == '2' ? 'selected' : '' : ''; ?>  value="2">Ambulance</option>

                                                <option <?php echo isset($data['type_id']) ? $data['type_id'] == '3' ? 'selected' : '' : ''; ?>  value="3">Doctor</option>

                                                <option <?php echo isset($data['type_id']) ? $data['type_id'] == '4' ? 'selected' : '' : ''; ?>  value="4">Nurse</option>
                                        ...
                                        <?php if (!empty($chk)) { ?>
                                            ...
                                            <div class="col-md-1" style="margin-top:29px;width:105px;margin-left:14px">
                                                ...
                                                <a href="<?= $this->config->base_url() . 'admin/Earnings' ?>" style="color: red">Clear search</a>
                            ...
                            <div class="panel-heading vd_bg-grey">
                                ...
                                <h3 class="panel-title" style="color:white"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span> Earnings </h3>
                                            ...
                                            foreach ($result as $val) {
                                              ...
                                              ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?= $val->type_name."/".$val->subtype_name ?></td>

                                                    <td><?= $val->pay_mode ?></td>

                                                   <!--  <td class="color"><?php// echo $status; ?></td> -->
                                                <?php
                                                 ...
                                                 if($val->payment_status == '0'){ 
                                                  ...
                                                  ?>
                                                    ...
                                                    <td><?= $val->Ad_commission ?></td>

                         <td><span class="menu-action hiderow<?= $val->ride_id ?>"><a id="<?= $val->ride_id ?>" data-original-title="edit" data-toggle="tooltip" data-placement="top" class="btnaction btn menu-icon vd_bd-yellow vd_yellow"> <i class="fa fa-pencil"></i> </a> </span></td>
