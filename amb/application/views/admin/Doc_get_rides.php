                    ...
                    <div class="panel-body">
                        <div class="panel widget">
                            <div  class="panel-body table-responsive">
                                <div class="col-md-12">
                                    <form action="<?= $this->config->base_url() . 'admin/Docs_rides_search' ?>" method="post">

                                        <div class="col-md-4">
                                            <label>Search from Doctor</label>
                                        ...
                                        <?php if (!empty($chk)) { ?>
                                            <div class="col-md-1" style="margin-top:29px;width:105px;margin-left:14px">
                                                <a href="<?= $this->config->base_url() . 'admin/Doctor_getrides' ?>" style="color: red">Clear search</a>
                                            </div>
                                        <?php } ?>
                            ...
                            <div class="panel-heading vd_bg-grey">
                                <h3 class="panel-title" style="color:white"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span> VISITS </h3>
                            </div>
                            <div  class="panel-body table-responsive">
                                                ...
                                                <tr>
                                                   ...
                                                   <!--  <td><?= $val->remark ?></td>  -->                                                   
                                                    <td><?php if ($val->status == 'COMPLETED') { ?>
                                                        ...
                                                        <?php }
                                                        ?></td>
                                                    <td><a id="<?= $val->user_id ?>" data-original-title="view" data-toggle="tooltip" data-placement="top" class="btnaction btn menu-icon vd_bd-green vd_green"> <i class="fa fa-eye"></i> </a></td>
                                                </tr>
                                                <?php
                                            }
                                        }
