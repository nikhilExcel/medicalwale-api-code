...
<?php echo $this->session->unset_userdata("type"); ?>
        ...
        $(document).on('click', '.btnaction', function () {
            ...
            if (action == 'edit' || action == "view") {
                $.ajax({
                    type: 'post',
                    url: '<?php echo $this->config->base_url() ?>admin/Ambulance_getrides',
                    data: "user_id=" + id,
                    ...
                    <div class="panel-body">
                        <div class="panel widget">
                            <div  class="panel-body table-responsive">
                                <div class="col-md-12">
                                    <form action="<?= $this->config->base_url() . 'admin/Amb_rides_search' ?>" method="post">
                                        ...
                                        <?php if (!empty($chk)) { ?>
                                            <div class="col-md-1" style="margin-top:29px;width:105px;margin-left:14px">
                                                <a href="<?= $this->config->base_url() . 'admin/Ambulance_getrides' ?>" style="color: red">Clear search</a>
                                            </div>
                                        <?php } ?>
                            ...
                            <div class="panel-heading vd_bg-grey">
                                <h3 class="panel-title" style="color:white"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span> Rides </h3>
                            </div>
                            <div  class="panel-body table-responsive">
