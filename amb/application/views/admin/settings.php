                    ...
                    <div class="panel-body">
                        <div class="panel widget">
                         ...
                         <!--            <div class="form-group">
                            ...
                            <div class="panel-heading vd_bg-grey">
                                <h3 class="panel-title" style="color:white"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span>Mail SMTP settings</h3>
                            </div>
                            <div  class="panel-body table-responsive left">
                                <form class="form-horizontal"  action="<?= $this->config->base_url() ?>admin/mail_setting" method="post" role="form" id="register-form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div id="first-name-input-wrapper"  class="controls col-md-8">
                                            <input type="text" placeholder="Format: admin@gmail.com" value="<?php echo $set[6]->value ?>" class="width-120 required"  name="FROM" id="smtp_from" required >
                                            <br/>
                                            <label class="control-label  col-md-5">example:- demo@gmail.com</label>
                                        </div>
