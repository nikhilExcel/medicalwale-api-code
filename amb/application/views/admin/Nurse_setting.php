                    ...
                    <div class="panel-body">
                        <div class="panel widget">
                            <div class="panel-heading vd_bg-grey">
                                <h3 class="panel-title" style="color:white"> <span class="menu-icon"> <i class="fa fa-dot-circle-o"></i> </span>Change Nurse Setting</h3>
                            </div>
                            <div  class="panel-body table-responsive left">
                                <form class="form-horizontal"  action="<?= $this->config->base_url() ?>admin/Nur_select" method="post" role="form" id="register-form">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label  col-md-2">Nurse Rate in %<span class="vd_red">*</span></label>
                                        <div id="first-name-input-wrapper"  class="controls col-md-8">
                                            <input type="text" placeholder="Nurse rate" value="<?php echo $res->Nurse_rate ?>" class="width-120 required"  name="  Nurse_rate" id="driver_rate" required >
                                        </div>
                                    </div>
                                    <div class="form-group">
