...
<div class="panel widget light-widget col-md-12">
    ...
    <div class="panel-body">
        ...
        <h3 class="mgbt-xs-20">Edit Doctor</h3>

        <hr/>

        <form enctype="multipart/form-data" class="form-horizontal"  action="<?php echo $this->config->base_url() ?>admin/Doctor/update" method="post" role="form" id="register-form">
...
<!--            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-md-12">
                    ...
                    <label class="control-label col-md-4" >License No. <span class="vd_red">*</span></label>

                    <div id="email-input-wrapper"  class="controls col-sm-6 col-md-8">

                        <input type="text" placeholder="Email" class="width-120 required" required value="<?php echo!empty($post['identification']) ? $post['identification'] : ''; ?>" name="identification" id="identification">
...
<!--            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-md-12">
                    ...
                    <label class="control-label col-md-4">License image</label>
