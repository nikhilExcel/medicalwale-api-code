<div class="panel widget light-widget col-md-12">
    ...
    <div class="panel-body">
        ...
        <h3 class="mgbt-xs-20">View Nurse Information</h3>
        ...
        <form enctype="multipart/form-data" class="form-horizontal"  action="<?php echo $this->config->base_url() ?>admin/Nurse/update" method="post" role="form" id="register-form">
            ...
            <div class="form-group">
                ...
                <div class="col-md-12">
                    ...
                    <label class="control-label  col-md-4"><b>Remark</b></label>

                    <div id="first-name-input-wrapper"  class="controls col-md-8">

                        <label class="control-label" ><?php echo!empty($post['remark']) ? $post['remark'] : ''; ?></label>
