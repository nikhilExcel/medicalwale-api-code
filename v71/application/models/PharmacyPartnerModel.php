   ...
   /*  public function __construct()
    ...
    public function get_versions(){
        /*if(ENVIRONMENT == 'development' || ENVIRONMENT =='dev'){
            $folder = '/home/h8so2sh3q97n/public_html/vendorsandbox.medicalwale.com/pharmacy_new/';
            $url = 'http://vendorsandbox.medicalwale.com/pharmacy_new/';
        } else {
            $folder = "/data/web/vendor.medicalwale.com/pbioms/";
            $url = "https://pbioms.medicalwale.com/";
        }*/
        $is_live = true;
        ...
        if($is_live == true){
	        ...
	        $whatsapp_notifications_link = "https://vendor.medicalwale.com/whatsapp/public/whatsapp";	
        } else {
	        ...
	        $whatsapp_notifications_link = "http://vendorsandbox.medicalwale.com/whatsapp/public/whatsapp";	
        }
	    
	    
        $data['folder'] = $folder;
        $data['url'] = $url;
	    $data['whatsapp_notifications_link'] = $whatsapp_notifications_link;
            ...
            */
            ...
            if(!empty($pbioms_record))
            {
                ...
                foreach($pbioms_record as $pbioms_record1)
                {
                    $total_admin += $pbioms_record1->total_admin;
                    $total_staff += $pbioms_record1->total_staff;
                    $pbioms_end_date = $pbioms_record1->end_date;
                }
            }
            else
            {
            ...
            if($pbioms == 1 &&  $pbioms_end_date < date('Y-m-d')){
                return array(
                    'status' => 403,
                    'message' => 'PBIOMS subscription ended'
                ); 
            } else {
                $date_array = array(
                    'listing_id' => $id,
                    ...
                    'is_active' => $is_active,
                    'pbioms' => "$pbioms",
                    'pbioms_end_date' => $pbioms_end_date,
                    'total_admin' => "$total_admin",
    ...
    public function order_status_count($listing_id)
    {
        ...
        $query1 = $this->db->query("select * from user_order where CONCAT(',', user_order.listing_id, ',') REGEXP CONCAT(',(', REPLACE('$listing_id', ',', '|'), '),') AND draft='0' group by invoice_no");
        $count1 = $query1->num_rows();
        
        $query2 = $this->db->query("select * from user_order where CONCAT(',', user_order.listing_id, ',') REGEXP CONCAT(',(', REPLACE('$listing_id', ',', '|'), '),') AND order_status='Awaiting Confirmation' AND draft='0' group by invoice_no");
        $count2 = $query2->num_rows();
        
        $query3 = $this->db->query("select * from user_order where CONCAT(',', user_order.listing_id, ',') REGEXP CONCAT(',(', REPLACE('$listing_id', ',', '|'), '),') AND order_status='Awaiting Customer Confirmation' AND draft='0' group by invoice_no");
        $count3 = $query3->num_rows();
        
        $query4 = $this->db->query("select * from user_order where CONCAT(',', user_order.listing_id, ',') REGEXP CONCAT(',(', REPLACE('$listing_id', ',', '|'), '),') AND order_status='Order Confirmed' AND draft='0' group by invoice_no");
        $count4 = $query4->num_rows();
        
        $query5 = $this->db->query("select * from user_order where CONCAT(',', user_order.listing_id, ',') REGEXP CONCAT(',(', REPLACE('$listing_id', ',', '|'), '),') AND order_status='Order Delivered' AND draft='0' group by invoice_no");
        $count5 = $query5->num_rows();
        
        $query6 = $this->db->query("select * from user_order where CONCAT(',', user_order.listing_id, ',') REGEXP CONCAT(',(', REPLACE('$listing_id', ',', '|'), '),') AND order_status='Awaiting Delivery Confirmation' AND draft='0' group by invoice_no");
        $count6 = $query6->num_rows();
        
        $query7 = $this->db->query("select * from user_order where CONCAT(',', user_order.listing_id, ',') REGEXP CONCAT(',(', REPLACE('$listing_id', ',', '|'), '),') AND order_status='Order Cancelled' AND draft='0' group by invoice_no");
    ...
    public function order_status_count_draft($listing_id)
    {
        $list = $listing_id;
        $sql11= "SELECT user_id FROM medical_stores where user_id = '".$listing_id."' AND pharmacy_branch_user_id=0";
	        $result11 = $this->db->query($sql11)->row();
        ...
        $query1 = $this->db->query("select * from user_order where CONCAT(',', user_order.listing_id, ',') REGEXP CONCAT(',(', REPLACE('$listing_id', ',', '|'), '),') AND draft='1' group by invoice_no");
        $count1 = $query1->num_rows();
        
        $query2 = $this->db->query("select * from user_order where CONCAT(',', user_order.listing_id, ',') REGEXP CONCAT(',(', REPLACE('$listing_id', ',', '|'), '),') AND order_status='Awaiting Confirmation' AND draft='1' group by invoice_no");
        $count2 = $query2->num_rows();
        
        $query3 = $this->db->query("select * from user_order where CONCAT(',', user_order.listing_id, ',') REGEXP CONCAT(',(', REPLACE('$listing_id', ',', '|'), '),') AND order_status='Awaiting Customer Confirmation' AND draft='1' group by invoice_no");
        $count3 = $query3->num_rows();
        
        $query4 = $this->db->query("select * from user_order where CONCAT(',', user_order.listing_id, ',') REGEXP CONCAT(',(', REPLACE('$listing_id', ',', '|'), '),') AND order_status='Order Confirmed' AND draft='1' group by invoice_no");
        $count4 = $query4->num_rows();
        
        $query5 = $this->db->query("select * from user_order where CONCAT(',', user_order.listing_id, ',') REGEXP CONCAT(',(', REPLACE('$listing_id', ',', '|'), '),') AND order_status='Order Delivered' AND draft='1' group by invoice_no");
        $count5 = $query5->num_rows();
        
        $query6 = $this->db->query("select * from user_order where CONCAT(',', user_order.listing_id, ',') REGEXP CONCAT(',(', REPLACE('$listing_id', ',', '|'), '),') AND order_status='Awaiting Delivery Confirmation' AND draft='1' group by invoice_no");
        $count6 = $query6->num_rows();
        
        $query7 = $this->db->query("select * from user_order where CONCAT(',', user_order.listing_id, ',') REGEXP CONCAT(',(', REPLACE('$listing_id', ',', '|'), '),') AND order_status='Order Cancelled' AND draft='1' group by invoice_no");
        $count7 = $query7->num_rows();
    ...
    public function order_list($status, $listing_id, $listing_type, $order_type, $page,$keyword, $date_from, $date_to,$customer_invoice,$branch_id,$order_deliver_by,$order_status,$payment_mode,$order_created_by)
    {
        $l ="";
        if($page == "")
        {
        ...
        $whereListing = "";
        if($listing_type == 0){
            $whereListing = " AND (user_order.listing_type='13' or user_order.listing_type='44')";
        } else {
            $whereListing = " AND (user_order.listing_type='13' or user_order.listing_type='44')";
        }
        ...
        if($keyword!="")
        {
            $whereListing .=" AND (user_order.mno_bill_no LIKE '%$keyword%' OR user_order.invoice_no LIKE '%$keyword%' OR user_order.auto_invoice_no LIKE '%$keyword%' OR user_order.order_type LIKE '%$keyword%' OR user_order.order_status LIKE '%$keyword%' 
                                          OR user_order.name LIKE '%$keyword%' OR user_order.mobile LIKE '%$keyword%' OR user_order.actual_cost LIKE '%$keyword%') ";
        }
                
        if(sizeof($customer_invoice) > 0){
            $selected_payment_modes = "";
            foreach($customer_invoice as $pm){
               
                $selected_payment_modes .= $selected_payment_modes != "" ? ',' : '' ;
                $selected_payment_modes .= "'".$pm['invoice_no'] . "'";
            }
            $whereListing .= " AND user_order.invoice_no IN  ($selected_payment_modes) "; 
        }        
                
         if($date_from!="" && $date_to!="")
                {
                    //$whereListing .=" AND (order_date >= '$date_from' AND order_date <= '$date_to') ";BETWEEN 
                    if($date_from != $date_to) {
                    $whereListing .=" AND (user_order.order_date BETWEEN '$date_from' AND '$date_to') "; }
                    else if($date_from == $date_to){
                    $whereListing .=" AND user_order.order_date LIKE '%$date_from%' ";
                    }
                }        
         if($status != "")
         {
             $whereListing .= " AND user_order.order_status='$status' ";
         }
         
        if(sizeof($order_created_by) > 0){
            
            $selected_created_by = "";
            foreach($order_created_by as $oc){
                $selected_created_by .= $selected_created_by != "" ? ',' : '' ;
                $selected_created_by .= "'".$oc . "'";
            }
            $whereListing .= " AND user_order.created_by IN  ($selected_created_by) ";
        }
        ...
        if(sizeof($payment_mode) > 0){
            ...
            foreach($payment_mode as $pm){
                $selected_payment_modes .= $selected_payment_modes != "" ? ',' : '' ;
                $selected_payment_modes .= "'".$pm . "'";
            }
            $whereListing .= " AND uvl.payment_method IN  ($selected_payment_modes) "; 
        }
        ...
        if(sizeof($order_status) > 0){
            ...
            $whereListing .= " AND user_order.order_status IN ($order_statuses) ";
            
            
        }
     
        if(sizeof($order_deliver_by) > 0){
           
            $deliver_by = "";
            foreach($order_deliver_by as $o){
                $deliver_by .= $deliver_by != "" ? ',' : '' ;
                $deliver_by .= "'".$o . "'";
                
            }
            $whereListing .= " AND user_order.order_deliver_by IN ($deliver_by) ";
        }
      ...
      //echo "select * from user_order where CONCAT(',', user_order.listing_id, ',') REGEXP CONCAT(',(', REPLACE('$uid', ',', '|'), '),') $whereListing group by invoice_no order by order_id desc $l ";
       $query = $this->db->query("select user_order.*,uvl.payment_method from user_order as user_order left join user_vendor_ledger as uvl on (uvl.invoice_no = user_order.invoice_no AND uvl.transaction_of = 2 AND uvl.trans_status = 1) where CONCAT(',', user_order.listing_id, ',') REGEXP CONCAT(',(', REPLACE('$listing_id', ',', '|'), '),') $whereListing AND user_order.draft='0' group by user_order.invoice_no order by user_order.order_id desc $l ");
        $count = $query->num_rows();
      ...
      if ($count > 0) { 
            foreach ($query->result_array() as $row) {
                ...
                $delivery_time_clock = $row['delivery_time_clock'];
                $order_type          = $row['order_type'];
                $listing_id          = $row['listing_id'];
                $listing_name        = $row['listing_name'];
                $listing_type        = $row['listing_type'];
                $invoice_no          = $row['invoice_no'];
                $auto_invoice_no          = $row['auto_invoice_no'];
                $chat_id             = $row['chat_id'];
           ...
           if(!empty($product_resultpost1) && !empty($prescription_resultpost2))
	        ...
	        else
	        {
                ...
                $resultpost[] = array(
                    ...
                    "delivery_time_clock" => $delivery_time_clock,
                    ...
                    'delivered_sign' => $delivered_sign,
                    'bill_url'  => $bill_url,
                    'mno_bill_no' => $mno_bill_no,
    ...
    public function order_list_draft($status, $listing_id, $listing_type, $order_type, $page,$keyword, $date_from, $date_to,$customer_invoice,$branch_id,$order_deliver_by,$order_status,$payment_mode,$order_created_by)
    {
        $l ="";
        if($page == "")
        {
        ...
        if($keyword!="")
        {
            $whereListing .=" AND (user_order.mno_bill_no LIKE '%$keyword%' OR user_order.invoice_no LIKE '%$keyword%' OR user_order.order_type LIKE '%$keyword%' OR user_order.order_status LIKE '%$keyword%' 
                                          OR user_order.name LIKE '%$keyword%' OR user_order.mobile LIKE '%$keyword%' OR user_order.actual_cost LIKE '%$keyword%') ";
        }
       ...
       /* echo "select user_id,order_id,order_type,action_by,delivery_time,cancel_reason,action_by,listing_id,delivery_charge,listing_name,listing_type,invoice_no,chat_id,address_id,name,mobile,pincode,address1,address2,landmark,city,state,order_total,payment_method,order_date,order_status from user_order where FIND_IN_SET('" . $listing_id . "',listing_id) and listing_type='$listing_type' group by invoice_no order by order_id desc";*/
        //$query = $this->db->query("select * from user_order where FIND_IN_SET('" . $listing_id . "',listing_id) $whereListing group by invoice_no order by order_id desc $l ");
      //echo "select * from user_order where CONCAT(',', user_order.listing_id, ',') REGEXP CONCAT(',(', REPLACE('$uid', ',', '|'), '),') $whereListing group by invoice_no order by order_id desc $l ";
       $query = $this->db->query("select user_order.*,uvl.payment_method from user_order as user_order left join user_vendor_ledger as uvl on (uvl.invoice_no = user_order.invoice_no AND uvl.transaction_of = 2 AND uvl.trans_status = 1) where CONCAT(',', user_order.listing_id, ',') REGEXP CONCAT(',(', REPLACE('$listing_id', ',', '|'), '),') $whereListing AND user_order.draft='1' group by user_order.invoice_no order by user_order.order_id desc $l ");
        $count = $query->num_rows();
    ...
    public function order_list_tracking($status, $listing_id, $listing_type, $order_type, $page,$keyword, $date_from, $date_to)
    {
        $l ="";
        if($page == "")
        {
        ...
        if($listing_type == 0){
          ...
          if($keyword!="")
                {
                    $whereListing .=" AND (mno_bill_no LIKE '%$keyword%' OR invoice_no LIKE '%$keyword%' OR order_type LIKE '%$keyword%' OR order_status LIKE '%$keyword%' 
         ...
         if($date_from!="" && $date_to!="")
                {
                    //$whereListing .=" AND (order_date >= '$date_from' AND order_date <= '$date_to') ";BETWEEN 
                    if($date_from != $date_to) {
                    $whereListing .=" AND (order_date BETWEEN '$date_from' AND '$date_to') "; }
                    else if($date_from == $date_to){
                    $whereListing .=" AND order_date LIKE '%$date_from%' ";
                    }
                }        
         if($status != "")
         {
       ...
       /* echo "select user_id,order_id,order_type,action_by,delivery_time,cancel_reason,action_by,listing_id,delivery_charge,listing_name,listing_type,invoice_no,chat_id,address_id,name,mobile,pincode,address1,address2,landmark,city,state,order_total,payment_method,order_date,order_status from user_order where FIND_IN_SET('" . $listing_id . "',listing_id) and listing_type='$listing_type' group by invoice_no order by order_id desc";*/
        //$query = $this->db->query("select * from user_order where FIND_IN_SET('" . $listing_id . "',listing_id) $whereListing group by invoice_no order by order_id desc $l ");
      //echo "select * from user_order where CONCAT(',', user_order.listing_id, ',') REGEXP CONCAT(',(', REPLACE('$uid', ',', '|'), '),') $whereListing group by invoice_no order by order_id desc $l ";
       $query = $this->db->query("select * from user_order where listing_id != '' $whereListing group by invoice_no order by order_id desc LIMIT 1 ");
        $count = $query->num_rows();
    ...
    /*  print_r($prescription_resultpost2);
        ...
        $total_created_by = $this->db->query("SELECT name FROM users where id='$created_by'");			
        $get_list1   = $total_created_by->row_array();
        if(!empty($get_list1)) {
         $created_by_name =  $get_list1['name'];
        }
        else
        {
            $created_by_name = "";
         ...
         $total_invoice_by = $this->db->query("SELECT name FROM users where id='$invoice_by'");			
        $get_list2   = $total_invoice_by->row_array();
        if(!empty($get_list2)) {
         $invoice_by_name =  $get_list2['name'];
        }
        else
        {
            $invoice_by_name =  "";
          ...
          $total_query_p = $this->db->query("SELECT pname FROM inventory_payment_details where invoice='$invoice_no' LIMIT 1");			
        $get_list3   = $total_query_p->row_array();
        if(!empty($get_list3)) {
         $invoice_pay_name =  $get_list3['pname'];
        }
        else
        {
            $invoice_pay_name = "";
                ...
                $resultpost = array(
                    ...
                    "payment_by_name" => $invoice_pay_name ,
                    "mno_status" => $mno_status,
                    "lat" => $lat,
                    "lng" => $lng,
                    'pharmacy_lat' => $pharmacy_lat,
     ...
     public function order_details($invoice_no)
    {
       ...
       /* echo "select user_id,order_id,order_type,action_by,delivery_time,cancel_reason,action_by,listing_id,delivery_charge,listing_name,listing_type,invoice_no,chat_id,address_id,name,mobile,pincode,address1,address2,landmark,city,state,order_total,payment_method,order_date,order_status from user_order where FIND_IN_SET('" . $listing_id . "',listing_id) and listing_type='$listing_type' group by invoice_no order by order_id desc";*/
        $query = $this->db->query("select created_by,invoice_by,mno_bill_no,bill_url,lat,lng,order_deliver_by,user_id,order_id,order_type,action_by,delivery_time,cancel_reason,action_by,listing_id,delivery_charge,listing_name,listing_type,invoice_no,auto_invoice_no,chat_id,address_id,name,mobile,pincode,address1,address2,landmark,city,state,order_total,payment_method,order_date,order_status from user_order where  invoice_no = '$invoice_no' group by invoice_no");
        ...
        else
        {
            $invoice_pay_name = "";
                ...
                $resultpost[] = array(
                    ...
                    'created_by_name' => $created_by_name,
                    'invoice_by_name' => $invoice_by_name,
                    'invoice_pay_name' => $invoice_pay_name,
                    "final_calculation"=> $data2
                );
            }
        } else {
    ...
    public function po_tracker($user_id, $invoice_no){
        $data = array();
       // echo "SELECT * FROM `po_tracking` WHERE `invoice_no` LIKE '$invoice_no' ORDER BY `created_at` ASC";
        $getStatuses = $this->db->query("SELECT * FROM `po_tracking` WHERE `invoice_no` LIKE '$invoice_no' ORDER BY `created_at` ASC")->result_array();
    ...
    public function order_status_common($order_id_data, $prescription_id_data,$order_details,$prescription_details,$delivery_charges,$delivery_charges_by_customer,$sub_all_total,$discount,$gst,$order_deliver_by)
    {
       ...
       $this->db->where('order_id',$order_id_data);
        ...
        foreach ($order_product_data as $result) {
            ...
            $product_discount     = $result['product_discount'];
            $product_discount_rupee     = $result['product_discount_in_rupee'];
            ...
            $p_insert_id = $this->db->insert('user_order_product', $arr);
                            	       ...
                            	       if($created_new_table['table_name'] != ""){
                                            ...
                                            if($p_insert_id != "") {
                                              ...
                                              //$stock_id = $details['stock_id'];
                    	                        ...
                    	                        $array_out = array('stock_id' => $stock_id,
                    	                                           'product_id' => $product_order_id,
                    	                                           'quantity' => $product_qunatity,
                    	                                           'reaosn' => 'order from user',
                    	                                           'invoice_no' => $invoice_no,
                    	                                           'order_id' => $order_id_data,
                    	                                           'created_at' => date('Y-m-d H:i:s'),
                    	                                           'created_by' => ""
                    	                                           );
                    	                       $this->db->insert('stock_out_log',$array_out);                    
                    	                    }
                            	       }
           
                $grand_total = $grand_total + $sub_total;
                $total_discount = $total_discount + $product_discount_rupee;
       ...
       $this->db->update('user_order',array('listing_name' => $medical_name));
        ...
        $query = $this->db->query("UPDATE user_order SET order_status='$order_status',delivery_time='$delivery_time',listing_id='$listing_id',delivery_charge = '$delivery_charges',actual_cost='$grand_total',order_total='$grand_total',discount='$discount',gst='$gst',draft='0' where order_id='$order_id_data'");
        ...
        // $this->OrderModel->update_status($invno,$orderStatus, $action_by_status);
         ...
         foreach ($prescription_order as $result) {
            ...
            $prescription_discount_rupee = $result['prescription_discount_rupee'];
          ...
          // if($prescription_status == "Available" || $prescription_status == "available"){
                $grand_total = $grand_total + $sub_total;
                  $total_discount = $total_discount + $prescription_discount_rupee;
          // }  
       ...
       $query = $this->db->query("UPDATE user_order SET order_status='$order_status',delivery_time='$delivery_time',delivery_charge = '$delivery_charges',listing_id='$listing_id',actual_cost='$grand_total',order_total='$grand_total',discount='$total_discount',gst='$gst',draft='0' where `invoice_no`='$invoice_no'");
    ...
    $userOrderDetails_dc = $this->db->query("SELECT total_without_dc,refferal_code,refferal_user_id FROM `user_order` WHERE `order_id` = '$order_id' ")->row_array();
        $total_without_dc = $userOrderDetails_dc['total_without_dc'];
        $refferal_code = $userOrderDetails_dc['refferal_code'];
        $refferal_user_id = $userOrderDetails_dc['refferal_user_id'];    
        if($refferal_user_id!="" && $refferal_code!="")
        {
           
               $upadte_user_points = array(
                'user_id'        => $refferal_user_id,
                'order_id'       => $invoice_no,
                'trans_id'       => 0,
                'points'         => (int)round($total_without_dc),
                'created_at'     => $updated_at,
                'expire_at'      => $updated_at,    
                'status'         => 'active'
            );
            $this->db->insert('user_points', $upadte_user_points);
            $referral_code_id = $this->db->insert_id();
                $referralCode['referral_code_id'] = $referral_code_id;
                $referralCode['order_id'] = $order_id;
                $referralCode['used_by'] = $user_id;
                $referralCode['user_id'] = $refferal_user_id;
                $referralCode['points_added'] = (int)round($total_without_dc);
                $this->db->insert('used_referral_codes_medicines',$referralCode);
    ...
    public function edit_order_common($order_id_data, $prescription_id_data,$order_details,$prescription_details,$delivery_charges,$delivery_charges_by_customer,$sub_all_total,$discount,$gst)
    {
        // echo $order_deliver_by; die();
        $total_discount = $grand_total = 0;
        $title = "";
       ...
       // $order_status  = $product_details_new['order_status'];
        ...
        foreach ($order_product_data as $result) {
            ...
            $this->db->where($arr);            
            $getQ = $this->db->get('user_order_product')->row();
            if(!empty($getQ))
            {
       ...
       // $order_status       = $prescription_details_new['order_status'];
        ...
        $query = $this->db->query("UPDATE user_order SET listing_id='$listing_id',delivery_charge = '$delivery_charges',actual_cost='$grand_total',order_total='$grand_total',discount='$discount',gst='$gst' where order_id='$order_id_data'");
        $invNoArray = $this->db->query("select `invoice_no` from `user_order` WHERE order_id = '$order_id_data'")->row_array();
        $invno = $invNoArray['invoice_no'];
        ...
        // $this->OrderModel->update_status($invno,$orderStatus, $action_by_status);
             ...
             $this->db->where('order_id',$order_id);
        $this->db->delete('prescription_order_list');
         foreach ($prescription_order as $result) {
             $sub_total = 0;
            $prescription_name     = $result['prescription_name'];
            $prescription_quantity = $result['prescription_quantity'];
            ...
            $query = $this->db->query("INSERT INTO `prescription_order_list`(`order_id`, `prescription_name`, `prescription_quantity`, `prescription_price`, `prescription_discount`, `prescription_status`,`gst`,`stock_id`,`batch_no`,`barcode`) VALUES ('$prescription_id_data', '$prescription_name', '$prescription_quantity', '$prescription_price', '$prescription_discount', '$prescription_status','$prescription_gst','$stock_id','$batch_no','$barcode')");
       ...
       $query = $this->db->query("UPDATE user_order SET delivery_charge = '$delivery_charges',listing_id='$listing_id',actual_cost='$grand_total',order_total='$grand_total',discount='$total_discount',gst='$gst' where `invoice_no`='$invoice_no'");
     ...
     return array(
            'status' => 200,
            'message' => 'success',
            'order_status' => "edited Successfull"
        );
    ...
    public function order_status($order_id, $delivery_time, $order_status, $listing_id, $listing_type, $order_data_list,$delivery_charges,$delivery_charges_by_customer,$sub_all_total,$discount,$gst,$order_deliver_by)
    {
       ...
       $this->db->update('user_order',array('listing_name' => $medical_name));
        ...
        $query = $this->db->query("UPDATE user_order SET order_status='$order_status',delivery_time='$delivery_time',delivery_charge = '$delivery_charges',listing_id='$listing_id',actual_cost='$grand_total',order_total='$grand_total',discount='$total_discount',gst='$gst',draft='0' where order_id='$order_id'");
    ...
    public function order_status_draft($order_id, $delivery_time, $order_status, $listing_id, $listing_type, $order_data_list,$delivery_charges,$delivery_charges_by_customer,$sub_all_total,$discount,$gst,$order_deliver_by)
    {
        $total_discount = $grand_total = 0;
         $title = "";
    ...
    public function edit_general_order($order_id, $listing_id, $listing_type, $order_data_list,$delivery_charges,$delivery_charges_by_customer,$sub_all_total,$discount,$gst)
    {
        $total_discount = $grand_total = 0;
         $title = "";
        ...
        $query = $this->db->query("UPDATE user_order SET delivery_charge = '$delivery_charges',listing_id='$listing_id',actual_cost='$grand_total',order_total='$grand_total',discount='$total_discount',gst='$gst' where order_id='$order_id'");
        /*
        $invNoArray = $this->db->query("select `invoice_no`, `listing_name` from `user_order` WHERE order_id = '$order_id'")->row_array();
        $invno = $invNoArray['invoice_no'];
        $listing_name = $invNoArray['listing_name'];
        ...
        return array(
            'status' => 200,
            'message' => 'success',
            'order_status' => "edit_successfull"
        );
        
    }
    public function edit_general_order_draft($order_id, $listing_id, $listing_type, $order_data_list,$delivery_charges,$delivery_charges_by_customer,$sub_all_total,$discount,$gst)
    {
        $total_discount = $grand_total = 0;
         $title = "";
        ...
        foreach ($order_data_list as $result) {
            ...
            $batch_no              = $result['batch_no'];*/
             ...
             if(empty($product_id) )
            	            {
            	                 $product_order_product = array(
                                        
                                        'product_name' => str_replace("'","",$product_name),
                                     
                                        'product_price' => $product_price
                                        );
                                    $this->db->insert('product', $product_order_product);   
    ...
    public function add_address_v2($user_name,$user_mobile,$dob,$email,$gender,$blood,$type,$listing_id,$user_id,$address1,$address2,$landmark,$city,$state,$lat,$lng)
    {
        ...
        if($type=="add")
        {
            ...
            if ($count > 0) 
            {
                ...
                $query = $this->db->query("INSERT INTO `inventory_customer`(`vendor_id`, `user_id`, `cust_user_id`, `cname`, `address`, `state`, `city`, `cmobile`, `gender`, `date_of_birth`, `blood_group`,`cemail`, `type`, `lat`, `lng`, `created_date`) VALUES ('13','$listing_id','$user_id','$user_name','$address1','$state','$city','$user_mobile','$gender','$dob','$blood','$email','$type','$lat','$lng','$date_at')");
        ...
        if($type=="edit")
        {
                ...
                $this->db->update('inventory_customer',$array);
               // echo $this->db->last_query();
            return array(
                                'status' => 200,
                                'message' => 'success'
    ...
    public function edit_user_address($address_id,$address,$city,$state,$pincode,$lat,$lng)
    {
    ...
    public function del_customer($del_id)
    {
      
        $this->db->where('id',$del_id);
        $this->db->delete('inventory_customer');
            return array(
                                'status' => 200,
                                'message' => 'success'
                            );
     ...
     public function del_user_address($del_id)
    {
      
        $this->db->where('address_id',$del_id);
    ...
    public function customer_edit($user_id,$id)
    {
        $resultpost = array();
        
        $query = $this->db->query("select * from inventory_customer where id='$id' ");
        $count = $query->num_rows();
        ...
        if ($count > 0) {
            $row = $query->row_array();
                ...
                $user_name    = trim($row['cname']);
                $user_mobile  = $row['cmobile'];
                $user_dob     = $row['date_of_birth'];
                $user_gender  = $row['gender'];
                $user_email   = $row['cemail'];
                $user_blood   = $row['blood_group'];
               
                
               if($user_name != "") { 
                    $address_query = $this->db->query("SELECT * FROM `user_address` where user_id='$user_id' order by address_id desc");
                    $address_count = $address_query->num_rows();
                    if ($address_count > 0) {
                                foreach ($address_query->result_array() as $address_row) {
                                  
                                    $id = $address_row['address_id'];
                                    $landmark = $address_row['landmark'];
                                    $city = $address_row['city'];
                                    $state = $address_row['state'];
                                    $pincode = $address_row['pincode'];
                                    ...
                                    $relation_id = $address_row['relation_id'];
                                    $relation_ship=$address_row['relation_ship'];
                                    if($city == NULL)
                                    {
                                        $city = "";
                                    }
    ...
    public function list_address_v2($listing_id,$page_no,$per_page,$search,$from_date,$to_date,$from_date_c,$to_date_c,$disease)
    {
        if($per_page!="")
        {
        ...
        if($search != "")
        {
            $w .= "AND (i.cname LIKE '%$search%' OR i.cmobile LIKE '%$search%' OR i.date_of_birth LIKE '%$search%' OR i.gender LIKE '%$search%' OR i.cemail LIKE '%$search%' OR i.blood_group LIKE '%$search%'
             OR i.address LIKE '%$search%' OR i.city LIKE '%$search%' OR i.state LIKE '%$search%' OR i.pincode LIKE '%$search%' OR i.disease LIKE '%$search%' )";
        }
        
        if(sizeof($disease) > 0){
            $selected_created_by = "";
            foreach($disease as $oc){
                $selected_created_by .= $selected_created_by != "" ? ',' : '' ;
                $selected_created_by .= "'".$oc . "'";
            }
            $w .= " AND i.disease IN  ($selected_created_by) ";
        }
        $left = "";
       
          if($from_date !="" && $to_date != "")
          {
              $w .= "AND (u.order_date between  '$from_date' AND '$to_date') " ;
              $left = " LEFT JOIN user_order as u ON u.user_id=i.cust_user_id ";
              
          }
          
         if($from_date_c !="" && $to_date_c != "")
          {
              $w .= "AND (i.created_date_c between  '$from_date_c' AND '$to_date_c') " ;
          }
          
        $query1 = $this->db->query("select * from inventory_customer as i $left where i.user_id='$listing_id' AND i.cname != '' AND i.lead = '1' $w GROUP BY i.cust_user_id order by i.cname");
        $count1 = $query1->num_rows();
        // echo "select * from inventory_customer where user_id='$listing_id' AND cname != '' AND lead = '1' $w GROUP BY cust_user_id order by cname $limit";
        $query = $this->db->query("select * from inventory_customer as i $left where i.user_id='$listing_id' AND i.cname != '' AND i.lead = '1' $w GROUP BY i.cust_user_id order by i.cname $limit");
        $count = $query->num_rows();
    ...
    public function product_sales_report($listing_id,$page_no,$per_page,$search,$order_quantity,$repeat_orders,$idsort)
    {
        ...
        if($search != "")
        {
            $w .= " AND (product_id LIKE '%$search%' OR product_name LIKE '%$search%') ";
        }
        
        $q1 = $q2 = $r1 = $r2 = "";
        if($order_quantity != '' && strpos($order_quantity, '-') !== false) {
            $split_q = explode('-',$order_quantity);
            $q1 = $split_q[0];
            $q2 = $split_q[1];
           // $new_order_quantity = " having sum(u.product_quantity) BETWEEN $q1 AND $q2";
        }
        
        if($repeat_orders != '' && strpos($repeat_orders, '-') !== false) {
            $split_r = explode('-',$repeat_orders);
             $r1 = $split_r[0];
             $r2 = $split_r[1];
            //$new_rea = " having sum(u.product_quantity) BETWEEN $q1 AND $q2";
        }
        /*$query = $this->db->query("select s.*,sum(u.product_quantity) as order_quantity from $table_name as s LEFT JOIN user_order_product as u ON s.product_id=u.product_id LEFT JOIN user_order as o ON u.order_id=o.order_id  WHERE s.product_name != '' AND o.listing_id='$listing_id' $w group by s.product_id $limit ");
        $count = $query->num_rows();*/
        $order = "";
        if($idsort != '')
        {
            $sortsplit = explode('_',$idsort);
            $field = $sortsplit[0];
            $sort = $sortsplit[1];
            
            if($field=='id')
            $order = " order by u.product_id $sort";
             else  if($field=='name')
            $order = " order by u.product_name $sort";
              else  if($field=='quantity')
            $order = " order by sum(u.product_quantity) $sort";
            else  if($field=='price')
            $order = " order by sum(u.product_price) $sort";
        }
       
        $query = $this->db->query("SELECT o.order_id,u.product_id,p.product_name,sum(u.product_quantity) as order_quantity,sum(u.product_price) as order_value FROM user_order as o LEFT JOIN user_order_product as u ON o.order_id=u.order_id LEFT  JOIN product as p ON u.product_id=p.id  WHERE o.listing_id='$listing_id'  AND u.product_id !='' group by u.product_id $order $limit ");
        $count = $query->num_rows();
        ...
        if ($count > 0) {
            foreach ($query->result_array() as $row) {
                ...
                $mfg = "";
                $mrp= "";//$row['mrp']; 
                $query1 = $this->db->query("select selling_price as mrp from $table_name  WHERE product_id= '$product_id' order by id desc limit 1");
                ...
                $query2 = $this->db->query("select count(*) as repeat_orders from user_order as o LEFT JOIN user_order_product as u ON u.order_id=o.order_id WHERE o.listing_id='$listing_id' AND u.product_id= '$product_id' ");
                $repeat_orders = $query2->row()->repeat_orders;
               
                $query3 = $this->db->query("select count(DISTINCT o.user_id) as no_cust_orders from user_order as o LEFT JOIN user_order_product as u ON u.order_id=o.order_id WHERE o.listing_id='$listing_id' AND u.product_id= '$product_id' AND o.user_id !=''");
                $no_cust_orders = $query3->row()->no_cust_orders;
              
                $query4 = $this->db->query("select order_date from user_order as o LEFT JOIN user_order_product as u ON u.order_id=o.order_id WHERE o.listing_id='$listing_id' AND u.product_id= '$product_id' order by o.order_id desc LIMIT 1");
                if(!empty($query4->row())) {
                $order_date = $query4->row()->order_date;
                }
                else
                {
                    $order_date = "";
                ...
                if($r1 == "" && $r2 == "" && $q1 == "" && $q2 == "") {
                    ...
                    $resultpost[] = array(
                        ...
                        'no_cust_orders' => $no_cust_orders,
                        'order_date' => $order_date
                        
                    );
                }
                else if($q1 != "" && $q2 != "" && ($order_quantity >= $q1 && $order_quantity <= $q2) && $r1 != "" && $r2 != "" && ($repeat_orders >= $r1 && $repeat_orders <= $r2))
                {
                     $resultpost[] = array(
                        "stock_id"     => $id,
                        "product_id" => $product_id,
                ...
                else if($q1 != "" && $q2 != "" && ($order_quantity >= $q1 && $order_quantity <= $q2) && $r1 == "" && $r2 == "")
                {
                ...
                else if($r1 != "" && $r2 != "" && ($repeat_orders >= $r1 && $repeat_orders <= $r2) && $q1 == "" && $q2 == "")
                {
                     $resultpost[] = array(
                        "stock_id"     => $id,
                        "product_id" => $product_id,
    ...
    public function list_address_lead_v2($listing_id,$page_no,$per_page,$search,$from_date,$to_date,$disease)
    {
        if($per_page!="")
        {
            $offset = $per_page*($page_no - 1);
        ...
        if($search != "")
        {
            $w .= "AND (cname LIKE '%$search%' OR cmobile LIKE '%$search%' OR date_of_birth LIKE '%$search%' OR gender LIKE '%$search%' OR cemail LIKE '%$search%' OR blood_group LIKE '%$search%'
             OR address LIKE '%$search%' OR city LIKE '%$search%' OR state LIKE '%$search%' OR pincode LIKE '%$search%' OR disease LIKE '%$search%' )";
        }
        if(sizeof($disease) > 0)
        {
             $selected_created_by = "";
            ...
            $w .= " AND disease IN  ($selected_created_by) ";
        }
          if($from_date !="" && $to_date != "")
          {
              $w .= "AND (created_date between  '$from_date' AND '$to_date') " ;
          }
        $query1 = $this->db->query("select * from inventory_customer where user_id='$listing_id' AND cname != '' AND lead = '0' $w GROUP BY cust_user_id order by cname");
        $count1 = $query1->num_rows();
        $query = $this->db->query("select * from inventory_customer where user_id='$listing_id' AND cname != '' AND lead = '0' $w GROUP BY cust_user_id order by cname $limit");
      ...
      if ($count > 0) {
            foreach ($query->result_array() as $row) {
               ...
               if($user_name != "") { 
                    $address_query = $this->db->query("SELECT * FROM `inventory_customer` where user_id='$listing_id' AND cust_user_id='$user_id' order by id desc");
                    $address_count = $address_query->num_rows();
                    if ($address_count > 0) {
                                foreach ($address_query->result_array() as $address_row) {
                                    $aid              = $address_row['id'];
     ...
     public function prescription_status($order_id, $order_status, $prescription_order, $delivery_time,$listing_id,$delivery_charges,$delivery_charges_by_customer,$sub_all_total,$discount,$gst,$order_deliver_by)
    {
       ...
       // echo $invoice_no; die();
        ...
        foreach ($prescription_order as $result) {
            ...
            $prescription_price    = $result['prescription_price'];
            $prescription_discount = $result['prescription_discount'];
            $prescription_discount_per = $result['prescription_discount_per'];
            $prescription_status   = $result['prescription_status'];
            $prescription_gst = array_key_exists('gst', $result ) ? $result['gst']:0 ;
            if(array_key_exists('stock_id',$result)){
                $stock_id              = $result['stock_id'];
     ...
     public function edit_prescription_order($order_id, $prescription_order,$listing_id,$delivery_charges,$delivery_charges_by_customer,$sub_all_total,$discount,$gst)
    {
        $total_discount = $grand_total = 0;
        // echo $order_id; die();
        $this->load->model('OrderModel');
       ...
       /* $invNoArray = $this->db->query("select `invoice_no` , `listing_name` from `user_order` WHERE order_id = '$order_id'")->row_array();
        ...
        return array(
            'status' => 200,
            'message' => 'success',
            'order_status' => "edited Prescription Successfully"
        );
    }
    ...
    public function order_deliver_cancel($order_id, $cancel_reason, $type, $notification_type,$user_id)
    {
        ...
        $whatsapp_notifications_link =  $get_versions['whatsapp_notifications_link']; 
        ...
        if ($type == 'Order Delivered') {
            $invNoArray = $this->db->query("select  mobile, order_deliver_by, order_id, `invoice_no` , `listing_id` from `user_order` WHERE invoice_no = '$order_id'")->row_array();
            $user_order_id = $invNoArray['order_id'];
            $invoice_no = $invNoArray['invoice_no'];
            $order_deliver_by = $invNoArray['order_deliver_by']; 
             $listing_id = $invNoArray['listing_id'];
             $customer_phone = $invNoArray['mobile'];
            ...
            $invNoArray = $this->db->query("select `mno_bill_no`, `user_id`,`listing_type`,`listing_id`,`invoice_no` , `total_without_dc` , `listing_name` from `user_order` WHERE invoice_no = '$invoice_no'")->row_array();
            ...
            $listing_id = $invNoArray['listing_id'];
            $mno_bill_no = $invNoArray['mno_bill_no'];
            $this->db->query("UPDATE inventory_customer SET lead = 1 where user_id='$listing_id' AND cust_user_id='$user_id' ");
            $action_by_status = "Pharmacy";
            $orderStatus = 'Order delivered by '.$listing_name.' pharmacy';
            $this->OrderModel->update_status( $order_id,$orderStatus, $action_by_status);
            if($order_deliver_by == "walkin")
            {
                /*$wmessgg = "Your order #$invno with reference no. $mno_bill_no has been picked up by you from $listing_name.
 We hope you have a speedy recovery. Stay Healthy, Stay Safe.";*/
                if(strlen($customer_phone)== '10') {
                   
                $this->destinationPhone = "91".$customer_phone;
                $this->template_type ="template_41";
                $this->v1 = $invno != '' ? $invno : "NA";
                $this->v2 = $mno_bill_no != '' ? $mno_bill_no : "NA";
                $this->v3 = $listing_name != '' ? $listing_name : "NA";
               
                $data = json_encode($this, JSON_UNESCAPED_UNICODE);
                   
                        // $url = "http://vendorsandbox.medicalwale.com/whatsapp/public/whatsapp";
                      $url = $whatsapp_notifications_link;
                     ...
                     /*   if(!empty($resultw))
                        {
                            $this->db->query("UPDATE whatsapp_vendor_msg SET sent_msg = sent_msg + 1 WHERE user_id='$listing_id'");
                        }*/
                        //print_r($resultw);
                }
            }
            if($order_deliver_by == "pharmacy")
            {
                $wmessgg = "Your order #$invno";
                if($mno_bill_no != "") {
                    $wmessgg .= "with Reference No. $mno_bill_no.";
                } 
                $wmessgg .= " has been delivered to you from $listing_name.  We hope you have a speedy recovery. Stay Healthy, Stay Safe.";
            }
            
             if(strlen($customer_phone)== '10' && $wmessgg!="") {
                        $this->destinationPhone = "91".$customer_phone;
                        $this->template_type ="all";
                        $this->body = $wmessgg;
                        $data = json_encode($this, JSON_UNESCAPED_UNICODE);
                        // $url = "http://vendorsandbox.medicalwale.com/whatsapp/public/whatsapp";
                        $url = $whatsapp_notifications_link;
  ...
  public function pharmacy_partner_profile_list($listing_id)
    {
        ...
        $query = $this->db->query("SELECT *  FROM `medical_stores` WHERE user_id='$listing_id'");
        $count = $query->num_rows();
        if ($count > 0) {
            $license_no = '';
            foreach ($query->result_array() as $row) {
                ...
                $share_pro_a = array('status' => "1",'share_profile' => "https://medicalwale.com/Order_medicine/Pharmacy_Detail/".$listing_id);
                $mou_a = array('status' => "1",'discount'=> $row['discount'],'mou_pdf' => $row['mou_pdf'] );
                $recommended_a = array('status' => "1",'recommended' =>$row['recommended']);
                $mba_a = array('status' => "1",'mba' =>$row['mba']);
                $certified_a = array('status' => "1",'certified' =>$row['certified']);
                $discount_a = array('status' => "1",'medicalwale_discount' => $row['medicalwale_discount'],'max_discount'=>$row['discount'], 'perscribed_discount'=>$row['perscribed_discount'],'generic_discount'=> $row['generic_discount'],'surgical_discount'=> $row['surgical_discount'],'ethical_discount'=>$row['ethical_discount'],'otc_discount'=> $row['otc_discount']);
                
                $sqlq="SELECT q.vendor_qrcode, u.name FROM qrcode_vendor as q LEFT JOIN users as u ON q.vendor_id=u.id WHERE q.vendor_id='".$listing_id."'";
	            $resultq = $this->db->query($sqlq)->row_array();
                if(!empty($resultq)) {
                    $qr_code_a = array('status' => "1",'name'=> $resultq['name'],'qr_code' => $resultq['vendor_qrcode'] );
                }
                else
                {
                    $qr_code_a = array('status' => "1",'name'=> "",'qr_code' => "" );
                }
                $resultpost_a = array(
                 ...
                 $query_pass = $this->db->query("SELECT password  FROM `users` WHERE id='$listing_id'")->row();
                 if(!empty($query_pass))
                 {
                     $password=$query_pass->password;
                 }
                 else
                 {
                     $password = "";
                 }
                  $resultpost_pass = array(
                ...
                $in_temp_a = array('status'=>"1","template_invoice_id"=>$row['invoice_template'], "template"=>$this->get_invoice_templates($listing_id));
                
                $data[] = array(
                    "share_profile" => $share_pro_a,
                    "mou" => $mou_a,
                    "recommended" => $recommended_a,
                    "mba" => $mba_a,
                    "certified" => $certified_a,
                    "m_discount" => $discount_a,
                    "qr_code" => $qr_code_a,
                    "invoice_temlate" => $in_temp_a,
                    ...
                    "address" => $resultpost_a,
                    "password" => $resultpost_pass
                );
            ...
            if ($count > 0) {
                    ...
                    $query1 = $this->db->query("SELECT id FROM product WHERE id='$id'");
                        ...
                        if ($count1 > 0) {
                	       	...
                	       	$sql1="SELECT sum(quantity) as stock_quantity FROM $table_name where user_id='$user_id'  AND product_id='$id' AND warehouse_id='0'";
                            $stock=$this->db->query($sql1)->row();
                                    if(!empty($stock))
            	       	            {
    ...
    /*using*/
    public function order_on_call_old($delivery_by,$service,$delivery_time,$delivery_charge,$listing_id,$listing_name,$staff_user_id,$product_details,$total_quantity,$total_price,$discount,$net_amount,$payment_method,$gst,$customer_name,$customer_phone,$customer_phone1,$customer_phone2,$customer_email,$address1,$address2,$city,$state,$pincode,$lat,$lng,$map_location,$address_id,$delivery_charges_by_customer,$doctor_name,$landmark,$mno_bill_no)
    {
        ...
        if($customer_phone == ""){
            $medical_info = $this->db->query("SELECT id,dummy_user FROM `medical_stores` WHERE (`user_id` = '$listing_id' && `pharmacy_branch_user_id` = '0' )  || (`pharmacy_branch_user_id` = '$listing_id' )")->row_array(); ;
            $dummy_user = $medical_info['dummy_user']; 
            
            if($dummy_user > 0){
                $query1 = $this->db->query("SELECT name,id,email,token,agent,phone FROM users WHERE id='$dummy_user'")->row();
                $customer_phone = $query1->phone;
            } else {
                $customer_phone = $listing_id.'p1';
                $user_data = array(
                    'name'         => 'NA',
                ...
                $dummy_user = $cust_user_id = $this->db->insert_id();
                
                $medical_id = $medical_info['id'];
                
                $this->db->query("UPDATE medical_stores set dummy_user = '$cust_user_id' where id = '$medical_id'");
                
                $query1 = $this->db->query("SELECT name,id,email,token,agent,phone FROM users WHERE id='$cust_user_id'")->row();
        ...
        if(empty($cust_id))
        {
            $query = $this->db->query("SELECT id FROM inventory_customer WHERE cmobile='$customer_phone' AND user_id='$listing_id'")->row();
            if(empty($query))
            {
                ...
                $cust_data = array(
                    ...
                    'mobile1'      =>  $customer_phone1,
                    'mobile2'      =>  $customer_phone2,
        ...
        $created_at = date('Y-m-d H:i:s');
        $created_date = date('Y-m-d H:i:s');
        if(empty($address_id) && $dummy_user == 0)
        {
            $address_data = array(
                'user_id' => $user_id,
                'name' => $name,
        ...
        $user_order_name = $customer_name != '' ? $customer_name : $name ;
        $user_order = array(
            'invoice_no'    => $invoice_no,
            'order_type'    => $order_type, 
            'delivery_time' => $delivery_time,
        ...
        $final= "";
        if (isset($_FILES["image"]) && !empty($_FILES["image"]["name"]) && $order_id != "")
        {
            ...
            $targetPath = "images/MNObill/".$fiel_name;
            $s3->putObjectFile($sourcePath, $bucket, $targetPath, S3::ACL_PUBLIC_READ);
            $final='https://medicalwale.s3.amazonaws.com/'.$targetPath;
            //echo "UPDATE user_order SET bill_url='$final' WHERE order_id='$order_id'";
            $this->db->query("UPDATE user_order SET bill_url='$final' WHERE order_id='$order_id'");
        }
        
        //-------------------------whatsapp messages-------------------------
        $applink = "http://onelink.to/998684";
       
        if($order_id!="")
        {
             //$this->send_message_new($invoice_no,$mno_bill_no,$listing_name,$customer_phone,$applink,$delivery_by);
            if($mno_bill_no =="")
            {
                $mno_bill_no = "NA";
            }
            ...
            if($delivery_by == "walkin") {
              /* $wmessgg ="Thanks for placing order with $listing_name Your invoice number is # $invoice_no with Reference No. $mno_bill_no. Tap on the following link to view your invoice -  $final. Tap on this link to pay digitally - $applink
For more services regarding Health | Beauty | Fitness download Medicalwale Saathi App from Google Play or Apple App Store $applink and stay healthy";*/
            
            if(strlen($customer_phone)== '10') {
                   
                   
                $this->destinationPhone = "91".$customer_phone;
                $this->template_type ="template_43";
                $this->v1 = $listing_name;
                $this->v2 = $invoice_no;
                $this->v3 = $mno_bill_no;
                $this->v4 = $final;
                $this->v5 = $paylink;
            ...
            else if($delivery_by == "mno")
            {
               if(strlen($customer_phone)== '10') {
                   $tracklink = "http://pbioms.medicalwale.com/Web_view/order_tracking/".$invoice_no;
                 //  $m = "Thanks for placing order with {{1}} Your invoice number is # {{2}} with Reference No. {{3}}. Tap on the following link to view your invoice - {{4}}. Tap on the following link to Track your Order - {{5}}. For more services regarding Health | Beauty | Fitness download Medicalwale Saathi App from Google Play or Apple App Store {{6}} and stay healthy";
                $this->destinationPhone = "91".$customer_phone;
                $this->template_type ="template_46";
                $this->v1 = $listing_name;
                $this->v2 = $invoice_no;
                $this->v3 = $mno_bill_no;
                $this->v4 = $final;
            	            ...
            	            if(!empty($details['product_id']) && !empty($details['product_price']))
            	            {
            	               // print_r($product_details_new['product']); die();
            	                $product_gst = array_key_exists('gst',$details) ? $details['gst'] : 0;
            	                    $product_order = array(
                                        'order_id' => $order_id,
                                        'product_name' => str_replace("'","",$details['product_name']),
                                        'product_img' => '',
    ...
    public function send_message_new($invoice_no,$mno_bill_no,$listing_name,$customer_phone,$applink,$delivery_by)
    {
...
For more services regarding Health | Beauty | Fitness download Medicalwale Saathi App from Google Play or Apple App Store $applink and stay healthy";*/
            ...
            {
                $wmessgg = "Thanks for placing order with $listing_name Your invoice number is #$invoice_no ";
                if($mno_bill_no != "") {
                    $wmessgg .= "with Reference No. $mno_bill_no.";
                } 
                if($final !="") {     
                    $wmessgg .= "Tap on the following link to view your invoice -  $final";
                }
               // $wmessgg .= "Tap on this link to pay digitally - ";
                if($delivery_time !="") {     
                    $wmessgg .= "Your order is expected to reach in $delivery_time";
                }        
                $wmessgg .= "To track your order download Medicalwale Saathi App from Google Play or Apple App Store $applink";
            }
            else if($delivery_by == "mno")
            {
               if(strlen($customer_phone)== '10') {
                ...
                $this->destinationPhone = "91".$customer_phone;
                $this->template_type ="template_43";
                $this->v1 = $listing_name != '' ? $listing_name : "NA";
                $this->v2 = $invoice_no != '' ? $invoice_no : "NA";
                $this->v3 = $mno_bill_no != '' ? $mno_bill_no : "NA";
                $this->v4 = $final != '' ? $final : "NA";
                $this->v5 = $applink != "" ? $applink : "NA";
                $this->v6 = $applink != "" ? $applink : "NA";
    ...
    public function upload_bill($order_id,$mno_bill_no)
    {
        $final= "";
        if (isset($_FILES["image"]) && !empty($_FILES["image"]["name"]) && $mno_bill_no !="" && $order_id != "")
        {
            include('s3_config.php');
            ...
            $this->db->query("UPDATE user_order SET bill_url='$final', mno_bill_no='$mno_bill_no' WHERE order_id='$order_id'");
        }
        else if (isset($_FILES["image"]) && !empty($_FILES["image"]["name"]) && $order_id != "")
        {
            include('s3_config.php');
        ...
        else if($mno_bill_no !="" && $order_id != "" ) {
            $this->db->query("UPDATE user_order SET mno_bill_no='$mno_bill_no' WHERE order_id='$order_id'");
            return  $resultpost = array( 'status' => 200,
                                'message' => 'success');   
        }
        else
        {
           return  $resultpost = array( 'status' => 400,
    ...
    public function generate_invoice_v1($order_id,$invoice_no,$user_id)
    {
        $get_versions = $this->get_versions();
       
        $folder =  $get_versions['folder'];        
        $url_link = $get_versions['url'];
        ...
        if(!empty($order_id))
    	{
    	    ...
    	    if(count($ex)==1) {
    	         ...
    	         //AutoInvoice Number Logic By Mrunalini 01/10/2020
                    $orderinvoice_ini = $this->db->query("SELECT auto_invoice_no,listing_id FROM user_order as uo  WHERE uo.order_id = '$order_id'")->row_array();
                    if(!empty($orderinvoice_ini))
                    {
                        $auto_invoice_no = $orderDetails1['auto_invoice_no'];
                        $listing_id = $orderDetails1['listing_id'];
                        if($auto_invoice_no==NULL)
                        {
                            $orderinvoice_initials = $this->db->query("SELECT invoice_initials FROM medical_stores WHERE user_id = '$listing_id' AND pharmacy_branch_user_id='0'")->row_array();
                            
                            if(!empty($orderinvoice_initials)) 
                            {
                                $orderinvoice_initials1=$orderinvoice_initials['invoice_initials'];
                                if($orderinvoice_initials1 != "") {
                                    $orderinvoice_ini_all = $this->db->query("SELECT auto_invoice_index FROM user_order as uo  WHERE uo.listing_id = '$listing_id' AND auto_invoice_index!='0' order by auto_invoice_index desc LIMIT 1")->row_array();
                                    $incno = 1;
                                    if(empty($orderinvoice_ini_all))
                                    {
                                        $in_no = $orderinvoice_initials1."/1";
                                    }
                                    else
                                    {
                                        $ino = $orderinvoice_ini_all['auto_invoice_index'];
                                       
                                            $incno = $ino + 1;
                                            $in_no = $orderinvoice_initials1."/".$incno;
                                        
                                    }
                                    $this->db->query("UPDATE  user_order SET auto_invoice_no='$in_no', auto_invoice_index='$incno' WHERE order_id = '$order_id'");
    	       ...
    	       // $sql="SELECT ms.* , m.source as logo FROM medical_stores as ms left join users as u on (u.id = '$medical_id') left join media as m on (u.avatar_id = m.id) WHERE ms.user_id = '$medical_id' || ms.pharmacy_branch_user_id = '$medical_id' ";
    	         $sql="SELECT pit.view_name,pit.page_type,pit.page_alignment ,ms.* FROM medical_stores as ms left join pharmacy_invoice_templates as pit on (pit.template_id = ms.invoice_template) WHERE (ms.user_id = '$medical_id' AND ms.pharmacy_branch_user_id = '0') OR (ms.user_id > '0' AND ms.pharmacy_branch_user_id = '$medical_id')";
    	       //  echo $sql; die();  
    	            $detail = $this->db->query($sql)->row();
    	            //$detail = $this->post_m->fetch_pharmacy_details($this->session->userdata('id'));
                    $bill = $this->db->select('*')->from('user_order')->where('order_id',$order_id)->get()->row();
                    ...
                    {
                        /*changes by Swapnali waghunde on 16th May 2020 to add batch exp and mgf*/
                        $select_data = $table_join = "";
                        $pharmacy_id = $detail->user_id;
                        $check_table_existance = $this->PharmacyPartnerModel->stock_table_existance($pharmacy_id);
                        if($check_table_existance['status'] == true){
                            $table_name = $check_table_existance['table_name'];
                            $table_join = " left join $table_name as s on (s.product_id = l.product_id AND s.batch_no = l.batch_no  ) ";
                            $select_data = " , s.mgf_date, s.expiry_date ";
                        }
                        ...
                        //echo $this->db->last_query();
                        // print_r($bill_detail1);
                        $bill_detail1 = $this->db->query("SELECT `l`.*, p.hsn $select_data FROM `user_order_product` as `l` LEFT JOIN `user_order` as `u` ON (`u`.`order_id`=`l`.`order_id`) left join product as p on (p.id = l.product_id) $table_join WHERE `l`.`order_id` = '$order_id' AND (`l`.`product_status` = 'Available' OR `l`.`order_status` = 'Available') GROUP BY l.id")->result();
                    ...
                    else
                    {
                        ...
                        if($check_table_existance['status'] == true){
                            $table_name = $check_table_existance['table_name'];
                            $table_join = " left join $table_name as s on ( s.stock_id = l.stock_id AND s.batch_no = l.batch_no ) left join product as p on (p.id = s.product_id) ";
                            $select_data = " ,p.hsn,  s.mgf_date, s.expiry_date ";
                        }
                        ...
                        $bill_detail = $this->db->query("SELECT `l`.* $select_data FROM `prescription_order_list` as `l` LEFT JOIN `user_order` as `u` ON `u`.`order_id`=`l`.`order_id` $table_join WHERE `l`.`order_id` = '$order_id'  AND  (`l`.`prescription_status` = 'Available' or `l`.`prescription_status` = '') GROUP BY l.id")->result();
                        // echo $this->db->last_query();
    	...
    	if($detail->view_name !=""){
    	    $view_name = $detail->view_name;
    	} else {
    	    $view_name = 'generate_invoice';
    	}
    // 	print_r($detail); die();
    	$page_type = $detail->page_type != "" ? $detail->page_type : 'A4' ;
    	$page_alignment = $detail->page_alignment != "" ? $detail->page_alignment : 'P' ;
    	
    	$this->load->library('dpdf');
        $pdf = $this->dpdf->load();
        // $pdf->AddPage('A4');
        $pdf->addPage($page_alignment,$page_type);
    ...
    //   print_r($barcode_image); die();
         $data['detail'] = $detail;
    	   ...
    	   //if($orderDetails['bill_url'] == "" || $orderDetails['order_status'] != "Order Delivered" ){
    	        
        	    $html= $this->load->view($view_name, $data, true);
    	        $pdf->WriteHTML($html); 
                $actual_image_name = $output = 'invoice' . date('Ymdhis') . '.pdf';
                
                
                //$pdfFilePath = FCPATH."temporary_invoice/".$output;
                //echo $folder; die();
                $pdfFilePath = $folder."bill/".$output;
                $pdf->Output($pdfFilePath, 'F');
                
                include('s3_config.php');
                
                $actual_image_path = 'images/pharmacy_invoices/'.$pharmacy_id.'/' . $actual_image_name;
                if ($s3->putObjectFile($pdfFilePath, $bucket, $actual_image_path, S3::ACL_PUBLIC_READ)) {
                    $bill_url = "https://medicalwale.s3.amazonaws.com/images/pharmacy_invoices/".$pharmacy_id."/".$actual_image_name;
                }
                unlink($pdfFilePath);
        	    
        	    $this->db->query("UPDATE `user_order` SET `bill_url`='$bill_url',`invoice_by`='$user_id' WHERE `invoice_no` = '$invoice_no'"); 
    	   //} else {
    	   //    $bill_url = $orderDetails['bill_url'];
    	   //}     
    ...
    /*using*/
    public function inventory_stock_report_list_v1($page,$user_id,$staff_user_id,$find,$filter,$stock_limit,$brand,$purchase_order,$expiry_date_from,$expiry_date_to,$warehouse_id,$pid_sort,$pname_sort,$qty_from,$qty_to)
    {
        $resultpost = array();
        $limit = 15;
        $start = 0;
        ...
        {   
            ...
            if($find !="")
            {
                $whr .= " WHERE product_name like '%" .$find."%' ";
            }
            if($qty_from !="" && $qty_to !="")
            {
                 if($whr !="")
                 {
                     $whr .= " AND quantity BETWEEN $qty_from AND $qty_to";
                 }
                 else
                 {
                     $whr .= " WHERE quantity BETWEEN $qty_from AND $qty_to";
                 }
            }
            if($pid_sort != "")
            {
            ...
            $query = $this->db->query("SELECT * FROM $table_name $whr $sort LIMIT $start, $limit");
            $count = $query->num_rows();
            if ($count > 0) {
                foreach ($query->result_array() as $row) {
                    $id                     = $row['product_id'];
      ...
      public function Notification_All_list($user_id,$page)
    {
      ...
      //  $radius = $page*5;
        ...
        $query1 =$this->db->query("SELECT * FROM `pharmacy_notifications` where listing_id = '$user_id'");
        $count1 = $query1->num_rows();
        
       $query =$this->db->query("SELECT * FROM `pharmacy_notifications` where listing_id = '$user_id' order by id desc LIMIT $start, $limit");
        $count = $query->num_rows();
        if ($count > 0) {
            foreach($query->result_array() as $row_main)
             {
               ...
               $notification_type = $row_main['notification_type'];
                ...
                $query1 =$this->db->query("SELECT order_type FROM user_order where invoice_no = '$invoice_no'");
                $count1 = $query1->num_rows();
                $order_type = "";
                if ($count1 == 1) {
                    $rows = $query1->row();
                    if($rows->order_type == "prescription")
                    {
                        $order_type = "prescription";
                    }
                    if($rows->order_type == "order")
                    {
                        $order_type = "general";
                    }
                }
    ...
    {
         $updated_at = date('Y-m-d H:i:s');
         $query = $this->db->query("UPDATE pharmacy_notifications SET is_seen='1' WHERE id = '$noti_id'");
   ...
   public function order_tracking_mno($user_id, $invoice_no){
    ...
    public function product_list($user_id,$page_no,$per_page,$search,$from_date,$to_date,$distributor)
...
// echo $distributor; die;
        ...
        if($check_table_existance['status'] == true){
            ...
            $search_where = $search_date = "";

            if($search != ""){

                $search_where .= "AND (inr.rack like '%$search%' OR iw.wname like '%$search%' OR ind.distributor_name like '%$search%' OR ind.manufacturer_name like '%$search%' OR st.product_name  like '%$search%' OR  st.barcode  like '%$search%' OR st.size like '%$search%' OR st.ptr like '%$search%' OR st.mrp like '%$search%' OR st.expiry_date like '%$search%' OR st.quantity like '%$search%' OR st.selling_price like '%$search%' OR   st.bill_no like '%$search%' OR   st.batch_no like '%$search%' OR   st.bill_no like '%$search%')";
            ...
            if($from_date != "" && $to_date != ""){
                  ...
                  $search_date .=" AND (st.bill_date BETWEEN '$from_date' AND '$to_date') "; }

                    else if($from_date == $to_date){

                   $search_date .=" AND st.bill_date LIKE '%$from_date%' ";
    ...
    public function edit_product($stock_id,$user_id,$product_id, $size, $ptr, $mrp, $selling_price, $distributor_id, $statuss, $rack_id,$quantity,$expiry_date,$barcode,$brand,$max_disc,$loose_quantity_factor,$our_margin,$accept_mfg_date_of,$check_expiry_till,$min_qty_to_bill,$fixed_min_level,$fixed_max_level,$net_purch_rate,$calc_min_level,$cal_max_level,$pack,$pack_unit,$batch_no,$gst){
        ...
        if($check_table_existance['status']){
            ...
            if($set != ""){
                $update_query = "UPDATE ".$table_name." SET $set WHERE id = '$stock_id' "   ;
    ...
    public function select_distributor_payment_options($pharmacy_id,$vendor_type){

        $alreadyExists = 0;

        $spm = $data = array();

        $payment_methods = $this->db->query("SELECT ppm.user_id, p.* FROM payment_method as p left join distributor_payment_methods as ppm on (ppm.payment_method_id = p.id AND ppm.user_id = '$pharmacy_id' AND ppm.active = 1) WHERE p.status = '1' AND NOT EXISTS (SELECT * FROM payment_method WHERE parent_id = p.id) order by sequence_no asc")->result_array();
        ...
        if (sizeof($query) > 0) {
            ...
            foreach($query as $row){
                ...
                $resultpost1[] = array(
                    ...
                    //newly added as prajakta needs by Mrunalini 08/05/2020
                    "order_id" => "",
                    "product_order_id" => "",
                    "product_id" => $row['product_id'] != null ? $row['product_id'] : "",
                    "product_name" => $row['product_name'] != null ? $row['product_name'] : "",
                    "product_img" => "",
                    "product_quantity" => "",
                    "product_price" => "",
                    "product_unit" => "",
    ...
    public function product_find_with_batches_old($user_id,$hub_user_id,$find)
    {
        $resultpost = array();
        $check_table_existance = $this->PharmacyPartnerModel->stock_table_existance($user_id);
    ...
    public function get_customer_all_order($user_id,$number,$mobile2,$mobile3,$search)
    {
        $resultpost = array();
        $w = "";
       if($number!="")
       {
           $w .= " AND (mobile='$number' OR mobile1='$number' OR mobile2='$number' )";
       }
        if($mobile2 != "")
       {
           $w .= " AND (mobile='$mobile2' OR mobile1='$mobile2' OR mobile2='$mobile2' )";
       }
        if($mobile3 != "")
       {
           $w .= " AND (mobile='$mobile3' OR mobile1='$mobile3' OR mobile2='$mobile3' )";
       }
       if($search != "")
       {
           $w .=  " AND (mobile='$search' OR mobile1='$search' OR mobile2='$search' OR invoice_no='$search' )";
       }
            $query = $this->db->query("SELECT * FROM user_order  WHERE listing_id='$user_id' $w group by invoice_no order by order_id desc limit 5 ");
            $count = $query->num_rows();
                if ($count > 0) {
                    foreach ($query->result_array() as $row) {
                        $order_id               = $row['order_id'];
                        ...
                        $resultpost_product = array();
                        $resultpost_product1 = array();
                        $resultpost_product2 = array();
                        $query_1 = $this->db->query("SELECT * FROM user_order  WHERE  invoice_no='$invoice_no'");
                        $count_1 = $query_1->num_rows();
                        
                        if($count_1 == 1) {
                            if($order_type == "order") {
                            $query1 = $this->db->query("SELECT * FROM user_order_product  WHERE order_id='$order_id'");
                            $count1 = $query1->num_rows();
                                if ($count1 > 0) {
                                    foreach ($query1->result_array() as $row1) {
                                        ...
                                        $resultpost_product[] = array(
                                                    ...
                                                    'cost_price'              => $row1['product_price'],
                                                    'product_type_name'       => $row1['product_unit'],
                            ...
                            {
                                    $query1 = $this->db->query("SELECT * FROM prescription_order_list  WHERE order_id='$order_id'");
                                    $count1 = $query1->num_rows();
                                        if ($count1 > 0) {
                                            foreach ($query1->result_array() as $row1) {
                                                 $resultpost_product[] = array(
                                                    'product_discount'        => $row1['prescription_discount'],
                                                    'product_id'              => $row1['prescription_id'],
                                                    'product_name'            => $row1['prescription_name'],
                                                    'product_quantity'        => $row1['prescription_quantity'],
                                                    'product_price'           => $row1['prescription_price'],
                                                    'cost_price'              => $row1['prescription_price'],
                                                    'product_type_name'       => $row1['prescription_name'],
                                                    'sub_total'               => "0",
                                                    'stock_id'                => $row1['stock_id'],
                                                    'barcode'                 => $row1['barcode'],
                                                    'batch_no'                => $row1['batch_no'],
                        ...
                        if($count_1 > 1) 
                        {
                            $querys = $this->db->query("SELECT * FROM user_order  WHERE invoice_no='$invoice_no' AND order_type='order'");
                            $order_id1 = $querys->row()->order_id;   
                            $query1 = $this->db->query("SELECT * FROM user_order_product  WHERE order_id='$order_id1'");
                            $count1 = $query1->num_rows();
                                    if ($count1 > 0) {
                                        foreach ($query1->result_array() as $row1) {
                                ...
                                $queryss = $this->db->query("SELECT * FROM user_order  WHERE invoice_no='$invoice_no' AND order_type='prescription'");
                                $order_id2 = $queryss->row()->order_id;       
                                $query12 = $this->db->query("SELECT * FROM prescription_order_list  WHERE order_id='$order_id2'");
                                $count12 = $query12->num_rows();
                                    if ($count12 > 0) {
                                        foreach ($query12->result_array() as $row1) {
                                             $resultpost_product2[] = array(
                                                'product_discount'        => $row1['prescription_discount'],
                                                'product_id'              => $row1['prescription_id'],
                                                'product_name'            => $row1['prescription_name'],
                                   ...
                                   $resultpost_product = array_merge($resultpost_product1,$resultpost_product2); 
                           }
                        ...
                        $resultpost[] = array(
                                                ...
                                                'discount'      => $discount,
                                                'delivery_charges_by_customer' => $delivery_charges_by_customer,
                                                'medicine_list' => $resultpost_product
                                                );
                    }
                    $res = array('status'=>'200','message' => 'success','data'=>$resultpost);
                }else
                {
    ...
    public function get_customer_all_order_repeat($user_id,$invoice_no)
    {
        $resultpost = array();
       
            $query = $this->db->query("SELECT * FROM user_order  WHERE invoice_no='$invoice_no' limit 1 ");
            $count = $query->num_rows();
                if ($count > 0) {
                   $row =$query->row_array();
                        $order_id               = $row['order_id'];
    ...
    public function product_find_with_batches($user_id,$hub_user_id,$find)
    {
        ...
        if($check_table_existance['status'] == true){
            $table_name = $check_table_existance['table_name'];
            $query = $this->db->query("SELECT ins.gst,ins.id as stock_id,ins.batch_no,ins.expiry_date,ins.mgf_date,pr.image,ins.quantity,inc.category as category_name,ind.distributor_name,ind.manufacturer_name, pr.product_price,pr.product_name,pr.category, pr.sub_category, pr.group_id, pr.product_description, ipt.type as product_type ,pr.pack_unit, ins.id, ins.user_id, ins.product_id, ins.barcode, ins.selling_price  FROM $table_name as ins inner join product as pr   on (ins.product_id=pr.id) left join inventory_distributor as ind on (ind.id = ins.distributor_id)   left join inventory_category as inc on (pr.category = inc.category) left join inventory_product_type as ipt on (ipt.id = pr.product_type) WHERE pr.product_name LIKE '%" .$find."%'  AND ins.quantity > 0 AND ins.status = '1' GROUP BY ins.id limit 10 ")->result_array();
    ...
    public function product_find_with_batches_draft_edit($user_id,$hub_user_id,$find)
    {
        $stock_quantity = 0;
        $check_table_existance = $this->PharmacyPartnerModel->stock_table_existance($user_id);
        ...
        if($check_table_existance['status'] == true){
            $table_name = $check_table_existance['table_name'];
            $query = $this->db->query("SELECT ins.gst,ins.id as stock_id,ins.batch_no,ins.expiry_date,ins.mgf_date,pr.image,ins.quantity,inc.category as category_name,ind.distributor_name,ind.manufacturer_name, pr.product_price,pr.product_name,pr.category, pr.sub_category, pr.group_id, pr.product_description, ipt.type as product_type ,pr.pack_unit, ins.id, ins.user_id, ins.product_id, ins.barcode, ins.selling_price  FROM product as pr  LEFT JOIN $table_name as ins  on (ins.product_id=pr.id) left join inventory_distributor as ind on (ind.id = ins.distributor_id)   left join inventory_category as inc on (pr.category = inc.category) left join inventory_product_type as ipt on (ipt.id = pr.product_type) WHERE pr.product_name LIKE '%" .$find."%'  AND ins.quantity > 0 AND ins.status = '1' GROUP BY ins.id limit 10 ")->result_array();
    ...
    public function product_find_with_batches_draft_for_confirm($user_id,$hub_user_id,$find)
    {
        $stock_quantity = 0;
        $check_table_existance = $this->PharmacyPartnerModel->stock_table_existance($user_id);
    ...
    public function product_find_with_batches_draft($user_id,$hub_user_id,$find)
    {
        $stock_quantity = 0;
        $check_table_existance = $this->PharmacyPartnerModel->stock_table_existance($user_id);
        	       
       
        $query = $this->db->query("SELECT pr.id,pr.image, pr.product_price,pr.product_name,pr.category, pr.sub_category, pr.group_id, pr.product_description,pr.pack_unit FROM product as pr WHERE pr.product_name LIKE '%" .$find."%' limit 10 ")->result_array();
    ...
    public function get_invoice_templates($user_id){
        $return = array();
        $template = $this->db->query("SELECT * FROM `pharmacy_invoice_templates` WHERE `is_active` = '1'")->result_array();
        $return = sizeof($template) > 0 ? $template : $return; 
        return $return;
    }
    
    public function select_invoice_template($user_id,$template_id){
        $this->db->query("UPDATE `medical_stores` SET invoice_template = '$template_id' WHERE `user_id` = '$user_id' ");
        return true;
    }
    
    public function orders_to_call_mno($pharmacy_id,$page_no,$per_page,$search){
        $this->load->model('PaymentModel');
        $return = array();
        $pharmacy_list = $this->db->query("SELECT user_id,pharmacy_branch_user_id FROM `medical_stores` WHERE ((`user_id` = '$pharmacy_id' ) || (`user_id` > '0' && `pharmacy_branch_user_id` = '$pharmacy_id')) ")->result_array();
        $pharmacy_user_ids = array_column($pharmacy_list, 'user_id');
        $pharmacy_user_branc_ids = array_column($pharmacy_list, 'pharmacy_branch_user_id');
        $ids = array_merge($pharmacy_user_ids,$pharmacy_user_branc_ids);
        $pharmacy_ids = array_unique($ids);
        $pharmacy_ids = array_filter($pharmacy_ids);
        $pharmacy_ids = implode(',', $pharmacy_ids);

        $offset = $per_page*($page_no - 1);
        $limit = "LIMIT $per_page OFFSET $offset"; 
        $order_list = $this->db->query("SELECT uo.address1, uo.address2, uo.landmark, uo.city, uo.state,uo.pincode,uo.name,uo.mobile,uo.order_status,uo.invoice_no,mo.mno_id,mo.ongoing,mo.status,ml.mno_name, ml.phone from user_order as uo left join mno_orders as mo on (mo.invoice_no = uo.invoice_no) left join mno_list as ml on (mo.mno_id = ml.mno_id AND mo.status = 'accepted' AND mo.redircted_to = '0') WHERE uo.listing_id IN ($pharmacy_ids) AND uo.`order_status` != 'Order Delivered' AND uo.`order_status` != 'Order Cancelled' $limit")->result_array();
    ...
    public function  test_whatsapp($mobile,$delivery_by) {
    ...
    //-------------------------whatsapp messages-------------------------
        ...
        $order_id = "123";
        $mno_bill_no = "80123";
        $final = "http://vendorsandbox.medicalwale.com/pharmacy.medicalwale.com/bill/invoice20200306022948.pdf";
        $listing_name = "Dhaval Chemist";
        $invoice_no ="2020130502536";
...
For more services regarding Health | Beauty | Fitness download Medicalwale Saathi App from Google Play or Apple App Store $applink and stay healthy";
            ...
            else if($delivery_by == "mno")
            {
               ...
               // $wmessgg .= "Tap on this link to pay digitally - ";
                ...
                $wmessgg .= " For more services regarding Health | Beauty | Fitness download Medicalwale Saathi App from Google Play or Apple App Store $applink and stay healthy";
            }
    ...
    /*Created by Swapnali Waghunde on 18th May 2020 to get reports in Pharmacy*/
    /*
    STEPS : 
    1. Get all branch ids - DONE
    2. check all filters and conditions and set query
    3. Get all orders from user order table
    4. design response as per fronend requirment
    */
    public function get_report($user_id,$page_no,$per_page,$search,$order_created_by,$payment_mode,$to_date,$from_date,$order_status,$order_deliver_by){
        $this->load->model('PaymentModel');
        $search_order_status = $search_order_deliver_by = $date_search = $to_date_search = $from_date_search = $search_payment_mode = $search_created_by = $search_where = "";
        $final_data = $all_orders = $return = array();
        ...
        /*Search*/
        if($search != ""){
            $search_where = " AND (uo.listing_name like '%$search%' OR uo.name like '%$search%' OR uo.mobile like '%$search%' OR uo.invoice_no like '%$search%' OR uo.payment_method like '%$search%' OR uo.order_id like '%$search%' OR uo.mno_bill_no like '%$search%' ) ";
        }
        
        /*order created by*/
        if(sizeof($order_created_by) > 0){
            // $search_created_by = " AND uo.created_by IN ($order_created_by) ";
            $selected_created_by = "";
            foreach($order_created_by as $oc){
                $selected_created_by .= $selected_created_by != "" ? ',' : '' ;
                $selected_created_by .= "'".$oc . "'";
            }
            $search_created_by = " AND uo.created_by IN  ($selected_created_by) ";
        }
        ...
        if(sizeof($payment_mode) > 0){
            ...
            $search_payment_mode = " AND uvl.payment_method IN  ($selected_payment_modes) "; 
        }
        ...
        /*$order_status*/
        if(sizeof($order_status) > 0){
            // $search_order_status = " AND uo.order_status LIKE '$order_status' ";
            ...
            $search_order_status = " AND uo.order_status IN ($order_statuses) ";
            
            
        }
        /*$order_deliver_by*/
        if(sizeof($order_deliver_by) > 0){
            // $deliver_by = implode(",",$order_deliver_by); //-> cannot use
            $deliver_by = "";
            foreach($order_deliver_by as $o){
                $deliver_by .= $deliver_by != "" ? ',' : '' ;
                $deliver_by .= "'".$o . "'";
            ...
            $search_order_deliver_by = " AND uo.order_deliver_by IN ($deliver_by) ";
        }
        
        /*order by*/
        $order_by = " order by order_id DESC ";
        $get_all_branches = $this->db->query("SELECT user_id, pharmacy_branch_user_id FROM `medical_stores` WHERE `user_id` = '$user_id' ")->result_array();
        $branches = array_column($get_all_branches, 'pharmacy_branch_user_id');
        $branches[] = $user_id;
        ...
        $from = " user_order as uo left join user_vendor_ledger as uvl on (uvl.invoice_no = uo.invoice_no AND uvl.transaction_of = 2 AND uvl.trans_status = 1) left join payment_method as pm on (pm.id = uvl.payment_method) " ; 
        $paid_amount = " ( ( SELECT CASE WHEN SUM(debit) IS NULL THEN '0' ELSE SUM(debit) END FROM user_vendor_ledger as led WHERE led.listing_id = '$user_id' AND led.invoice_no = uo.invoice_no AND led.transaction_of = 2 AND led.trans_status = 1) + (SELECT CASE WHEN SUM(credit) IS NULL THEN '0' ELSE SUM(debit) END FROM user_vendor_ledger as led WHERE led.user_id = '$user_id' AND led.invoice_no = uo.invoice_no AND led.transaction_of = 2 AND led.trans_status = 1) ) as paid_amount";
        $all_orders_query  = "SELECT $paid_amount, uvl.payment_method as payment_method_id,uo.order_date,uo.mno_bill_no,uvl.trans_status,pm.payment_method, uvl.ledger_owner_type, uvl.listing_id_type as payment_received_by, uvl.transaction_id,uvl.credit,uvl.debit,   uo.invoice_no, uo.name, uo.mobile, uo.bill_url, uo.order_deliver_by, uo.order_status FROM $from  WHERE uo.listing_id IN ($branches_str) $search_where $search_created_by $search_payment_mode $date_search $search_order_status $search_order_deliver_by GROUP BY uo.invoice_no ";
        // echo $all_orders_query; die();
        $all_orders = $this->db->query($all_orders_query . $order_by . $limit)->result_array();
        
        foreach($all_orders as $o){
            $invoice_no = $o['invoice_no'];
            
            $value  = $o['order_deliver_by'];
            if($value == 'mno'){
                $title = 'Night owl';
            ...
            $o['order_deliver_by'] = $title;
            
            
            $get_invoice_costing = $this->PaymentModel->get_invoice_costing($invoice_no);
            $o['cost'] = $get_invoice_costing['data'];
            $final_data[] = $o;
        }
        
        /*Total orders count query*/
        $total_count_query = " (SELECT  COUNT(DISTINCT uo.invoice_no)  FROM $from WHERE uo.listing_id IN ($branches_str)  $search_where $search_created_by $search_payment_mode $date_search $search_order_status $search_order_deliver_by )  as total_orders";
        /*Cancel orders count query*/
        $cancel_count_query = " (SELECT  COUNT(DISTINCT uo.invoice_no) FROM $from WHERE uo.listing_id IN ($branches_str) AND `order_status` LIKE 'Order Cancelled' $search_where $search_created_by $search_payment_mode $date_search $search_order_status $search_order_deliver_by ) as cancelled_orders_count";
        /*Delivered orders count query*/
        $delivered_count_query = " (SELECT  COUNT(DISTINCT uo.invoice_no) FROM $from WHERE uo.listing_id IN ($branches_str) AND `order_status` LIKE 'Order Delivered' $search_where $search_created_by $search_payment_mode $date_search $search_order_status $search_order_deliver_by )  as delivered_orders_count";
        /*Pending orders count query*/
        $pending_count_query = " (SELECT  COUNT(DISTINCT uo.invoice_no) FROM $from WHERE uo.listing_id IN ($branches_str) AND `order_status` NOT LIKE 'Order Cancelled' AND `order_status` NOT LIKE 'Order Delivered' $search_where $search_created_by $search_payment_mode $date_search $search_order_status $search_order_deliver_by  ) as pending_orders ";
        /*Total orders cost query*/
        $total_cost_query = " (SELECT SUM(uo.actual_cost + uo.delivery_charges_by_customer - uo.discount + uo.chc) FROM $from WHERE uo.listing_id IN ($branches_str)  $search_where $search_created_by $search_payment_mode $date_search $search_order_status $search_order_deliver_by ) as total_orders_cost ";
        /*Cancel orders cost query*/
        $cancel_cost_query = " (SELECT SUM(uo.actual_cost + uo.delivery_charges_by_customer - uo.discount + uo.chc) FROM $from WHERE uo.listing_id IN ($branches_str) AND `order_status` LIKE 'Order Cancelled' $search_where $search_created_by $search_payment_mode $date_search $search_order_status $search_order_deliver_by ) as cancelled_orders_cost  ";
        /*Delivered orders cost query*/
        $delivered_cost_query = " (SELECT SUM(uo.actual_cost + uo.delivery_charges_by_customer - uo.discount + uo.chc) FROM $from WHERE uo.listing_id IN ($branches_str) AND `order_status` LIKE 'Order Delivered' $search_where $search_created_by $search_payment_mode $date_search $search_order_status $search_order_deliver_by )  as delivered_orders_cost";
        /*Pending orders cost query*/
        $pending_cost_query = " (SELECT SUM(uo.actual_cost + uo.delivery_charges_by_customer - uo.discount + uo.chc) FROM $from WHERE uo.listing_id IN ($branches_str) AND `order_status` NOT LIKE 'Order Cancelled' AND `order_status` NOT LIKE 'Order Delivered' $search_where $search_created_by $search_payment_mode $date_search $search_order_status $search_order_deliver_by )  as pending_orders_cost";
        
        $counts_query = "SELECT $total_count_query , $cancel_count_query  , $delivered_count_query , $pending_count_query ,  $total_cost_query , $cancel_cost_query  , $delivered_cost_query , $pending_cost_query" ;
        $counts = $this->db->query($counts_query)->row_array();
        
        $return['counts'] = $counts;
        $return['orders'] = $final_data;
        return $return;
    }
    
    public function get_orders_details($user_id){
        $get_all_branches = $this->db->query("SELECT user_id, pharmacy_branch_user_id FROM `medical_stores` WHERE `user_id` = '$user_id' ")->result_array();
        $branches = array_column($get_all_branches, 'pharmacy_branch_user_id');
        $branches[] = $user_id;
        $branches = array_unique($branches);
        ...
        /*Total orders count query*/
        $total_count_query = " (SELECT COUNT(order_id) FROM `user_order` WHERE listing_id IN ($branches_str) ) ";
        
        /*Cancel orders count query*/
        $cancel_count_query = " (SELECT COUNT(order_id) FROM `user_order` WHERE listing_id IN ($branches_str) AND `order_status` LIKE 'Order Cancelled') ";
        
        /*Delivered orders count query*/
        $delivered_count_query = " (SELECT COUNT(order_id) FROM `user_order` WHERE listing_id IN ($branches_str) AND `order_status` LIKE 'Order Delivered') ";
        
        /*Pending orders count query*/
        $pending_count_query = " (SELECT COUNT(order_id) FROM `user_order` WHERE listing_id IN ($branches_str) AND `order_status` NOT LIKE 'Order Cancelled' AND `order_status` NOT LIKE 'Order Delivered') ";
        
        $counts_query = "SELECT $total_count_query as total_orders , $cancel_count_query as cancelled_orders_count , $delivered_count_query as delivered_orders_count , $pending_count_query as pending_orders" ;
    ...
    public function get_staff($user_id)
    {
        ...
        if($branches_str != ""){
            ...
            $sql_query = "SELECT m.source,u.is_active,u.avatar_id,u.id,u.name,u.phone,u.email , 0 as admin FROM users as u left join media as m on (m.id = u.avatar_id) WHERE u.staff_hub_user_id IN ($branches_str) AND vendor_id='13' UNION SELECT m.source,u.is_active,u.avatar_id,u.id,u.name,u.phone,u.email, 1 as admin  FROM users as u left join media as m on (m.id = u.avatar_id) WHERE u.admin_hub_user_id IN ($branches_str) AND vendor_id='13' order by id ASC";
            ...
            foreach ($query->result_array() as $row) {
                ...
                if ($source != '') {
                    ...
                    $profile_pic = 'https://d2c8oti4is0ms3.cloudfront.net/images/healthwall_avatar/' . $source;
                } else {
                    $profile_pic = 'https://d2c8oti4is0ms3.cloudfront.net/images/img/default_medical_app.png';
                }
    ...
    /*Created by Swapnali Waghunde on 21st MAY 2020 to fetch data to show in filter options*/
    public function get_filters_data($user_id){
        $order_status = $retrun = array();
        $vendor_type = 13;
        /*branches*/
        $get_branches = $this->get_branches($user_id);
        $branches = $get_branches['status'] == 1 ? $branches =  $get_branches['data'] : array() ;
        
        /*payment options*/
        $select_payment_options = $this->select_payment_options($user_id,$vendor_type);
        
        /*staff*/
        $get_staff = $this->get_staff($user_id);
        
        /*status*/
        $order_status = $this->order_status_by_user($user_id);
        
        /*order_delivery_options*/
        $order_delivery_options = $this->order_delivery_options($user_id);
        
        $retrun['order_status'] = $order_status['order_status'];
        $retrun['branches'] = $branches;    
        $retrun['staff_members'] = $get_staff;
        $retrun['payment_modes'] = $select_payment_options['data'];
        $retrun['order_delivery_options'] = $order_delivery_options['order_delivery'];
        
        return $retrun;
    }
   
    /*Created by swapnali waghunde on 23rd May 2020*/
    public function order_status_by_user($user_id){
        $order_status = array();
        $get_all_branches = $this->db->query("SELECT user_id, pharmacy_branch_user_id FROM `medical_stores` WHERE `user_id` = '$user_id' ")->result_array();
        $branches = array_column($get_all_branches, 'pharmacy_branch_user_id');
        $branches[] = $user_id;
        ...
        $branches_str = implode(",",$branches);
        if($branches_str != ""){
            $order_status = $this->db->query("SELECT order_status as status from user_order WHERE listing_id IN ($branches_str) AND order_status != '' AND order_status != '0'  GROUP BY order_status")->result_array();
        }
        $return['order_status'] = $order_status;
        return $return;
    }
 
    /*Created by swapnali waghunde on 25rd May 2020*/
    public function order_delivery_options($user_id){
        $delivery = $order_delivery_by = array();
        $get_all_branches = $this->db->query("SELECT user_id, pharmacy_branch_user_id FROM `medical_stores` WHERE `user_id` = '$user_id' ")->result_array();
        $branches = array_column($get_all_branches, 'pharmacy_branch_user_id');
        $branches[] = $user_id;
        $branches = array_unique($branches);
        ...
        $branches_str = implode(",",$branches);
        if($branches_str != ""){
            $order_delivery_by = $this->db->query("SELECT order_deliver_by from user_order WHERE listing_id IN ($branches_str) AND  order_deliver_by != ''  GROUP BY order_deliver_by")->result_array();
        }
        foreach($order_delivery_by as $od){
            $value = $o['value'] = $od['order_deliver_by'];
            if($value == 'mno'){
                $title = 'Night owl';
            } else if($value == 'walkin') {
                $title = 'Walk-in';
        ...
        $return['order_delivery'] = $delivery;
        return $return;
    }
    public function route_order($array1,$order_id,$user_id,$invoice_no)
    {
            $this->db->select('listing_id');
            $this->db->from('user_order');
            $this->db->where('order_id',$order_id);
            ...
            $this->db->where('order_id',$order_id);
            if($this->db->update('user_order',$array1)){
                $bill ="";
                $only_view= "";
              $this->PharmacyPartnerModel->estimate_cost_mno($user_id,$invoice_no,$bill,$only_view);
    ...
    public function pharmacy_store_address($listing_id)
    {
        $resultpost = array();
        $query = $this->db->query("SELECT medical_stores.reg_date,medical_stores.profile_pic, medical_stores.medical_name, medical_stores.store_manager, medical_stores.lat, medical_stores.lng, medical_stores.address1, medical_stores.address2, medical_stores.pincode, medical_stores.city, medical_stores.state, medical_stores.store_since FROM medical_stores  WHERE medical_stores.user_id='$listing_id'");
    ...
    public function pharmacy_store_address_update($listing_id,$address1,$address2,$state,$city,$pincode)
    {
        $resultpost = array();
        ...
        $this->db->where('user_id',$listing_id);        
        $this->db->update('medical_stores',$resul);
        if($this->db->affected_rows() >0 ) {
            return array("status"=> 200,"message"=>"Update Successfully");
        }
        else
        {
            return array("status"=> 201,"message"=>"Unable to Update");
        }
        
    }
    public function update_invoice_template($listing_id, $template_id)
    {
            $querys = $this->db->query("UPDATE medical_stores SET invoice_template = '$template_id' WHERE user_id='$listing_id'");
    ...
    public function update_discounts($listing_id, $medicalwale_discount, $max_discount, $perscribed_discount, $generic_discount, $surgical_discount, $ethical_discount, $otc_discount)
    {
         $discount_a = array('medicalwale_discount' => $medicalwale_discount,
         ...
         //$querys = $this->db->query("UPDATE medical_stores SET invoice_template = '$template_id' WHERE user_id='$listing_id'");
           $this->db->where('user_id',$listing_id);
           $this->db->update('medical_stores',$discount_a);
            if($this->db->affected_rows() > 0) { 
                return array(
                    'status' => 200,
                    'message' => 'success',
            ...
            else
            {
                 return array(
                    'status' => 201,
                    'message' => 'unable to update discounts',
                );
            }
    }
     public function update_order_customer_details($listing_id, $invoice_no, $name, $lat, $lng, $mobile, $address, $city, $state, $pincode)
    {
        $this->db->query("UPDATE user_order SET name='$name', mobile='$mobile', address1='$address', city='$city', state='$state', pincode='$pincode', lat='$lat', lng='$lng'  WHERE invoice_no='$invoice_no'");
     ...
     public function change_password($listing_id, $pass)
    {
        $p = md5($pass);
            $querys = $this->db->query("UPDATE users SET password = '$p' WHERE id='$listing_id'");
    ...
    public  function download_qrcode($user_id)
    {
         $this->load->library('ci_qr_code');
        $this->config->load('qr_code');
        ...
        $qr_code_config['imagedir'] = '/home/h8so2sh3q97n/public_html/vendorsandbox.medicalwale.com/pharmacy_new/qrcode/';
        ...
        $sql="SELECT q.*, u.name FROM qrcode_vendor as q LEFT JOIN users as u ON q.vendor_id=u.id WHERE q.vendor_id='".$user_id."'";
	    $user_details = $this->db->query($sql)->row();
	
        $image_name = $user_details->vendor_qrcode . ".png";
        $image_name_pdf = $user_details->vendor_qrcode .".pdf";
        // create user content
        $codeContents = "$user_details->vendor_qrcode";
        ...
        $data['qr_code_image_url'] = $qr_code_config['imagedir'] . $image_name;

        // save image path in tree table
        // then redirect to see image link
         $file = $params['savename'];
        $data['file_name'] = 'http://vendorsandbox.medicalwale.com/pharmacy_new/qrcode/'. $image_name; 
        $data['qrcode'] = $user_details->vendor_qrcode;
        $data['vendor_name'] = $user_details->name;
        if(file_exists($file)){
          
            $html= $this->load->view('qr_code_pdf', $data, true);
           	$this->load->library('dpdf');
        $pdf = $this->dpdf->load();
            $pdf->WriteHTML($html);
            $output ='/home/h8so2sh3q97n/public_html/vendorsandbox.medicalwale.com/pharmacy_new/qrcode/'.$user_details->vendor_qrcode .'.pdf';
            $pdfFilePath =  $image_name_pdf;
        
            $pdf->Output($output, 'F'); 
         return array(
                    'status' => 200,
                    'message' => 'success',
                    "pdf_link" => "http://vendorsandbox.medicalwale.com/pharmacy_new/qrcode/".$user_details->vendor_qrcode .".pdf"
                );
            exit;
        }
         return array(
                    'status' => 201,
                    'message' => 'unable to download Qrcode',
                    "pdf_link" => ""
                );
    ...
    /*Created by Swapnali waghunde on 22nd July 2020 : It is copy of , need to do major changes thats why append _old to old API*/
    public function order_on_call($delivery_by,$service,$delivery_time,$delivery_charge,$listing_id,$listing_name,$staff_user_id,$product_details,$total_quantity,$total_price,$discount,$net_amount,$payment_method,$gst,$customer_name,$customer_phone,$customer_phone1,$customer_phone2,$customer_email,$address1,$address2,$city,$state,$pincode,$lat,$lng,$map_location,$address_id,$delivery_charges_by_customer,$doctor_name,$landmark,$mno_bill_no,$refferal_code,$refferal_user_id)
    {
        $get_versions = $this->get_versions();       
        $whatsapp_notifications_link =  $get_versions['whatsapp_notifications_link']; 
        ...
        $user_order = array(
            ...
            'refferal_user_id' => $refferal_user_id
        );
        $this->db->insert('user_order', $user_order);
        $order_id = $this->db->insert_id(); 
        ...
        if (isset($_FILES["image"]) && !empty($_FILES["image"]["name"]) && $order_id != "")
        {
            ...
            $targetPath = "images/MNObill/".$fiel_name;
            $s3->putObjectFile($sourcePath, $bucket, $targetPath, S3::ACL_PUBLIC_READ);
            $bill_url = $final='https://medicalwale.s3.amazonaws.com/'.$targetPath;
            //echo "UPDATE user_order SET bill_url='$final' WHERE order_id='$order_id'";
            $this->db->query("UPDATE user_order SET bill_url='$final' WHERE order_id='$order_id'");
        }
...
For more services regarding Health | Beauty | Fitness download Medicalwale Saathi App from Google Play or Apple App Store $applink and stay healthy";*/
            ...
            else if($delivery_by == "mno")
            {
               if(strlen($customer_phone)== '10') {
                ...
                $this->v3 = $mno_bill_no != "" ? $mno_bill_no : "NA" ;
                $this->v4 = $final != "" ? $final : "NA" ;
                $this->v5 = $tracklink != "" ? $tracklink : "NA" ;
                $this->v6 = $applink != "" ? $applink : "NA" ;
            	                ...
            	                $product_gst = array_key_exists('gst',$details) ? $details['gst'] : 0;
            	                   ...
            	                   /*create table*/
                            	       ...
                            	       if($created_new_table['table_name'] != ""){
                                            ...
                                            if($p_insert_id != "") {
                                                $product_qunatity = $details['quantity'];
                                                $stock_id = $details['stock_id'];
                                                $quantity_query = $this->db->query("UPDATE $table_name SET quantity = quantity - $product_qunatity where id='$stock_id'");
                    	                        $array_out = array('stock_id' => $stock_id,
                    	                                           'product_id' => $details['product_id'],
                    	                                           'quantity' => $product_qunatity,
                    	                                           'reaosn' => 'order on call',
                    	                                           'invoice_no' => $invoice_no,
                    	                                           'order_id' => $order_id,
                    	                                           'created_at' => date('Y-m-d H:i:s'),
                    	                                           'created_by' => $staff_user_id
     ...
     public function order_on_call_draft($delivery_by,$service,$delivery_time,$delivery_charge,$listing_id,$listing_name,$staff_user_id,$product_details,$total_quantity,$total_price,$discount,$net_amount,$payment_method,$gst,$customer_name,$customer_phone,$customer_phone1,$customer_phone2,$customer_email,$address1,$address2,$city,$state,$pincode,$lat,$lng,$map_location,$address_id,$delivery_charges_by_customer,$doctor_name,$landmark,$mno_bill_no)
    {
        $get_versions = $this->get_versions();       
        $whatsapp_notifications_link =  $get_versions['whatsapp_notifications_link']; 
            ...
            if($service == "pbioms")
            {
                ...
                if(!empty($order_id))
        	    {
            	        ...
            	        foreach($product_details_new['product'] as $details)
            	        {
            	            ...
            	            {
            	                $new_product_id = $details['product_id'];
            	            }
    ...
    public function generate_invoice_s3($order_id,$invoice_no,$user_id)
    {
        $get_versions = $this->get_versions();
        $folder = $get_versions['folder'];
        $url = $get_versions['url'];
    	    ...
    	    if(count($ex)==1) {
    	       ...
    	       //  echo $sql; die();  
                    ...
                    else
                    {
                        ...
                        $bill_detail = $this->db->query("SELECT `l`.* $select_data FROM `prescription_order_list` as `l` LEFT JOIN `user_order` as `u` ON `u`.`order_id`=`l`.`order_id` $table_join WHERE `l`.`order_id` = '$order_id'  AND  `l`.`prescription_status` = 'Available' GROUP BY l.id")->result();
                        // echo $this->db->last_query();
    ...
    public function send_invoice_notification($order_id,$invoice_no,$user_id)
    {
        $customer_token1 = $this->db->select('user_id,bill_url,listing_type')->from('user_order')->where('order_id', $order_id)->get()->row();
        if(!empty($customer_token1))
        {
            $user_id   = $customer_token1->user_id;
            $bill_url   = $customer_token1->bill_url;
            $listing_type   = $customer_token1->listing_type;
            if($bill_url != "") {
                $customer_token = $this->db->select('name,token,agent,token_status')->from('users')->where('id', '35383')->get()->row();
                $token_status   = $customer_token->token_status;
                $notification_type = "medicine_invoice_notification";
                if ($token_status > 0) {
                    ...
                    $title = 'Dear '.$name.', View your medicine invoice.';
                    $msg   = 'Click here....';
                   
                    $this->send_gcm_notify_invoice($title, $reg_id, $msg, $img_url, $tag, $agent,$bill_url,$notification_type,$order_id,$invoice_no,$listing_type);
                    return array('status'=>'200','message'=>'success');
                }
            }
            else
            {
                return array('status'=>'201','message'=>'Bill URL is empty');
            }
        }
        else
        {
            return array('status'=>'201','message'=>'Data not found');
        }
    }
    function send_gcm_notify_invoice($title, $reg_id, $msg, $img_url, $tag,$agent, $bill_url,$notification_type,$order_id,$invoice_no,$listing_type)
        {
            if (!defined("GOOGLE_GCM_URL"))
                define("GOOGLE_GCM_URL", "https://fcm.googleapis.com/fcm/send");
    ...
    public function get_refferal_code($listing_id,$code)
    {
        $customer_token1 = $this->db->query("select * from refferal_code_order_medicines where code ='$code' AND status ='0'")->row();
        if(!empty($customer_token1))
        {
            $id   = $customer_token1->id;
            $user_id   = $customer_token1->user_id;
            $code   = $customer_token1->code;
            
             $customer_token = $this->db->select('name')->from('users')->where('id', $user_id)->get()->row();
                if (!empty($customer_token)) {
                    $name     = $customer_token->name;
                }
                else
            ...
            return array('status'=>'200','message'=>'Success','data'=>$array);              
        }
        else
        {
            return array('status'=>'201','message'=>'Data not found');
	 ...
	 public function payment_procedure($ledger_id) //For getting data of last entry in user_vendor_ledger table, Hitesh
    {
        // print_r($ledger_id); die;
        $this->db->select('*');
        $this->db->from('user_vendor_ledger');
    ...
    public function entry_in_inventory($user_id,$ledger_id,$invoice_no,$debit,$transaction_id,$payment_method,$created_at) // Hitesh
    {
        $data = array(
            'user_id'=>$user_id,
            'ledger_id'=>$ledger_id,
    ...
    public function send_transaction_noti($user_id, $transaction_id, $debit) // Hitesh
        {
              
            $customer_token = $this->db->select('name,token,agent,token_status')->from('users')->where('id', $user_id)->get()->row();
            $token_status   = $customer_token->token_status;
            $notification_type = "medicine_invoice_notification";
            if ($token_status > 0) {
                $name     = $customer_token->name;
                ...
                $tag       = 'text';
                $key_count = '1';
                $title = 'Awesome! ðŸ˜‰ '.$name.' your purchase is completed.';
                $msg   = 'Your transaction of Rs.'.$debit.'/- with transaction ID '.$transaction_id.' is completed';
                $bill_url = '';
                $order_id = '';
                $invoice_no = '';
                $listing_type = '';
                $this->send_gcm_notify_invoice1($title, $reg_id, $msg, $img_url, $tag, $agent,$bill_url,$notification_type,$order_id,$invoice_no,$listing_type);
                return array('status'=>'200','message'=>'success');
            }
            else
            {
                return array('status'=>'201','message'=>"Notification couldn't be sent.");
            }
        }
        
    function send_gcm_notify_invoice1($title, $reg_id, $msg, $img_url, $tag,$agent, $bill_url,$notification_type,$order_id,$invoice_no,$listing_type)
        {
            if (!defined("GOOGLE_GCM_URL"))
                define("GOOGLE_GCM_URL", "https://fcm.googleapis.com/fcm/send");
	 ...
	 public function get_gstreport($user_id,$page_no,$per_page,$search,$to_date,$from_date){
        ...
        /*Search*/
        if($search != ""){
            $search_where = " AND (u.name like '%$search%' OR u.mobile like '%$search%'  OR u.order_id like '%$search%') ";
        }
        ...
        if($to_date != "" && $from_date != ""){
            $to_date = date('Y-m-d', strtotime($to_date . ' +1 day'));
            $date_search = " AND u.order_date BETWEEN '$from_date' AND '$to_date' ";
        } else if($to_date != "" && $from_date == ""){
            $to_date = date('Y-m-d', strtotime($to_date . ' +1 day'));
            $from_date = "0000-00-00";
            $date_search = " AND u.order_date BETWEEN '$from_date' AND '$to_date' ";
...
round((p.product_price/(1+ (0.01 * p.gst))),2) as Item_rate,
p.product_quantity as Quantity,
round(p.product_quantity*(p.product_price / ( 1+ (0.01 * p.gst))),2) as Item_value,
(p.product_price * p.product_quantity) as MRP_Value,
p.gst as GST_percentage,
 p.product_discount as discount_percentage,
((p.product_price*p.product_quantity)*p.product_discount/100) as discount_Rupees,
u.delivery_charge,
round((p.product_price*p.product_quantity)-(p.product_price*p.product_quantity)*p.product_discount/100,2) as Payable_Amount,
round(((p.product_price*p.product_quantity)-(p.product_price*p.product_quantity)*p.product_discount/100)/(1+ (0.01 * p.gst)),2) as GST_Taxable_Value,
round((((p.product_price*p.product_quantity)-(p.product_price*p.product_quantity)*p.product_discount/100)/(1+ (0.01 * p.gst)) * (p.gst/100)/2),2) as CGST,
round((((p.product_price*p.product_quantity)-(p.product_price*p.product_quantity)*p.product_discount/100)/(1+ (0.01 * p.gst)) * (p.gst/100)/2),2) as SGST
FROM `user_order` as u right JOIN user_order_product as p ON
 p.order_id=u.order_id WHERE u.listing_id LIKE '$user_id' AND (u.listing_type='13' OR u.listing_type='44')
 ";

//echo $all_orders_query . $date_search. $search_where . $order_by . $limit;
 

   if($search != ""){
             
              $all_orders = $this->db->query($all_orders_query . $date_search . $search_where . $order_by . $limit)->result_array();
        }else{
            $all_orders = $this->db->query($all_orders_query . $date_search .  $order_by . $limit)->result_array();
        }
