    ...
    <tbody>
        ...
        <tr>
            ...
            <td colspan='3' style="border:1px solid #ddd;border-left:none!important;vertical-align:top;" >
                ...
                <?php if($bill->name != 'NA'){ ?><p style="font-size:9px;"><b><?php  echo $bill->name; ?></b></p><?php } ?>
                <p style="font-size:8px;"><?php if(ctype_digit($bill->mobile)){ echo $bill->mobile; } ?></p>
                ...
                <?php } ?>
                <p style="font-size:8px;"><?php echo $bill->city; ?> <?php if($bill->pincode > 0){ echo $bill->pincode; } ?></p>
