...
$ok1 = preg_match("/(\d\d\d\d\d\d)/", $bill->address1, $matches);
    ...
    if($abc1 > 0){
         ...
         $add1 =  str_replace($abc1," ",$bill->address1);
    }else{
      $add1 =    $bill->address1;
    }
    ...
    if($abc2 > 0){
         ...
         $add2 =  str_replace($abc2," ",$bill->address2);
    }else{
      $add2 =    $bill->address1;
    }
            ...
            <?php 
               ...
               // $ap= $this->PharmacyPartnerModel->get_pro_name($dat->product_id);
                   ...
                   $tot_sum += $total;
                    ...
                    if($gst_per > 0){
                        $sgst = $cgst = $gst_per / 2;
                         $gst_rup = $final_calculation['grand_total_customer'] - ($final_calculation['grand_total_customer'] / ( 1+ (0.01 * $gst_per))) ;
