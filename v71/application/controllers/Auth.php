...
class Auth extends CI_Controller {
               ...
               $response = $this->LoginModel->auth();
                if ($response['status'] == 200) {
                    ...
                    if ($params['user_id'] == "") {
                        ...
                        $resp = $this->LoginModel->check_recent_login($user_id,$vendor_id,$listing_id,$product_id);
                    }
    ...
    public function sociallogin() {
		...
		if(array_key_exists('referral_code', $params))
		    ...
		    $referral_code = "";
                ...
                $response = $this->LoginModel->sociallogin($email,$phone,$oauth_provider,$oauth_uid,$agent,$name,$gender,$image,$token,$referral_code);
                userlogin_json_output($response);
            }
        }
    }
   ...
   public function usersignup() {
	    ...
	    /*For FACEBOOK Login <===== added by Nikhil ( 06/07/2021) STARTS=====>*/
            if(!empty($this->input->post('auth_provider')))
            {
                $oauth_provider = $this->input->post('auth_provider');
            }
            else
            {
                $oauth_provider = "";
           ...
           if(!empty($this->input->post('auth_uid')))
            {
                $oauth_uid = $this->input->post('auth_uid');
            }
            else
            {
                $oauth_uid = "";
            }
            /*For FACEBOOK Login <===== added by Nikhil ( 06/07/2021) ENDS=====>*/	
                ...
                if ($name == "" || $mail == "" || $gender == "") {
                   // echo " android mail";
                    ...
                    if (isset($_FILES["image"]) AND ! empty($_FILES["image"]["name"])) {
                     ...
                     $resp = $this->LoginModel->usersignup($name, $phone, $mail, $gender, $dob, $image,$referral_code, $token, $agent, $is_mail, $deviceId,$oauth_provider,$oauth_uid);
                }
            } else {
...
/************************************************************/
   ...
   public function Profile_menu() {
    ...
    public function add_user_pic_movies()
    {
        $this->load->model('LoginModel');
         $method = $_SERVER['REQUEST_METHOD'];
        if ($method != 'POST') {
                ...
                if ($response['status'] == 200) {
                   ...
                   // $params = json_decode(file_get_contents('php://input'), TRUE);
                    ...
                    else 
                     {
                        ...
                        $resp  = $this->LoginModel->add_user_pic_movies($user_id,$fav_details,$type);
                    }
                    simple_json_output($resp);
                }
            }
    ...
    /*
    view user social profile (NIKHIL TIWARI - 26 DEC 2020)
    */
    public function view_user_social_profile()
    {
        $this->load->model('LoginModel');
         $method = $_SERVER['REQUEST_METHOD'];
        if ($method != 'POST') {
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    if ($params['user_id'] == "") {
                        ...
                        $resp        = $this->LoginModel->view_user_social_profile($user_id,$view_yourself,$self_user_id);
                    }
                    json_outputs($resp);
                }
            }
    ...
    public function add_user_social_profile()
    {
        $this->load->model('LoginModel');
         $method = $_SERVER['REQUEST_METHOD'];
        if ($method != 'POST') {
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    if ($params['user_id'] == "") {
                        ...
                        $resp        = $this->LoginModel->add_user_social_profile($user_id,$bio,$relationship_status,$languages_known);
                    }
                    json_outputs($resp);
                }
            }
    ...
    public function add_user_fav_details()
    {
        $this->load->model('LoginModel');
         $method = $_SERVER['REQUEST_METHOD'];
        if ($method != 'POST') {
                ...
                if ($response['status'] == 200) {
                   ...
                   // $params = json_decode(file_get_contents('php://input'), TRUE);
                    ...
                    else 
                     {
                        ...
                        $resp  = $this->LoginModel->add_user_fav_details($user_id,$fav_details,$type);
                    }
                    simple_json_output($resp);
                }
            }
    ...
    public function delete_users_fav_details()
    {
        $this->load->model('LoginModel');
        $method = $_SERVER['REQUEST_METHOD'];
        if ($method != 'POST') {
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    if ($user_id == "" || $media_id== "" ) {
                        ...
                        $resp = $this->LoginModel->delete_users_fav_details($user_id,$media_id); 
                    }
                    simple_json_output($resp);
                }
            }
    ...
    /*0-public 1-mycircle 2-onlyme*/
    public function user_privacy_profile_list() {
        $this->load->model('LoginModel');
        $method = $_SERVER['REQUEST_METHOD'];
        if ($method != 'POST') {
            json_output(400, array(
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    if ($params['user_id'] == "") {
                        ...
                        $resp = $this->LoginModel->user_privacy_profile_list($user_id);
                    }
                    simple_json_output($resp);
                }
            }
    ...
    public function user_privacy_profile() {
        $this->load->model('LoginModel');
        $method = $_SERVER['REQUEST_METHOD'];
        if ($method != 'POST') {
            json_output(400, array(
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    if ($params['user_id'] == "" || $params['field'] == "" || $params['privacy'] == "") {
                        ...
                        $resp = $this->LoginModel->user_privacy_profile($user_id, $field, $privacy);
                    }
                    simple_json_output($resp);
                }
            }
