...
class Labcenter extends CI_Controller {
        ...
        if ($method != 'POST') {
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    $invoice_no='20200317173514';
                    $vendor_id='59370';
                    $resp = $this->LabcenterModel->lalpathlabs_CreateOrder($invoice_no,$vendor_id);
                    if ($resp != '') {
                        json_outputs($resp);
                    } else {
    ...
    public function lab_search() {
        ...
        if ($method != 'POST') {
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    $params = json_decode(file_get_contents('php://input'), TRUE);
                    if ($params['keyword'] == "" || $params['page'] == "" || $params['lat'] == "" || $params['lng'] == "") {
                        ...
                        $lat = $params['lat'];
                        $lng = $params['lng'];
                        $resp = $this->LabcenterModel->lab_search($user_id,$keyword,$page,$lat,$lng);
                    }
                    if ($resp != '') {
                        json_outputs($resp);
                    } else {
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    if ($params['lat'] == "" || $params['lng'] == "") {
                        ...
                        // recommended 
                        if(array_key_exists('recommended',$params)){
                        ...
                        // certified
                        if(array_key_exists('certified',$params)){
                        ...
                        if(array_key_exists('mba',$params)){
                            $mba = $params['mba'];
                        } else {
                            $mba = "";
                        }
                        ...
                        $response = $this->LabcenterModel->labcenter_list($lat, $lng, $user_id, $category_id, $hospital_type,$per_page,$page_no,$featured,$recommended,$certified,$mba);
                        ...
                        $resp['total_count'] = $response['total_count'];
                        $resp['page_no'] = $response['page_no'];
                        $resp['per_page'] = $response['current_page_count'];
                        $resp['current_page_count'] = sizeof($response['center_list']);
                        $resp['last_page'] = $response['last_page'];
                        $resp['data'] = $response['center_list'];
    ...
    public function labcenter_list2() {
        $this->load->model('LabcenterModel');
        $method = $_SERVER['REQUEST_METHOD'];
        if ($method != 'POST') {
            json_output(400, array('staturems' => 400, 'message' => 'Bad request.'));
        } else {
            $check_auth_client = $this->LabcenterModel->check_auth_client();
            if ($check_auth_client == true) {
                $response = $this->LoginModel->auth();
    ...
    public function add_prescription() {
        ...
        if ($method != 'POST') {
            ...
            if ($user_id == "" && $mobile == "") {
                ...
                $this->LabcenterModel->add_prescription($user_id,$comment,$mobile,$address_id,$member_id);
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    if ($params['user_id'] == "") {
                        ...
                        $user_id = $params['user_id'];
                        $resp = $this->LabcenterModel->report_list($user_id,$page);
                    }
                    simple_json_output($resp);
                }
            }
    ...
    public function package_details()
    {
        ...
        if ($method != 'POST') {
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    $params = json_decode(file_get_contents('php://input'), TRUE);
                    if ($params['package_id'] == "" || $params['vendor_id'] == "") {
                        $resp = array('status' => 400, 'message' => 'please enter fields');
                    } else {
                        $package_id = $params['package_id'];
                        $vendor_id = $params['vendor_id'];
                        $resp = $this->LabcenterModel->package_details($package_id,$vendor_id);
                    }
                    simple_json_output($resp);
                }
            }
    ...
    public function test_details()
    {
        ...
        if ($method != 'POST') {
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    $params = json_decode(file_get_contents('php://input'), TRUE);
                    if ($params['test_id'] == "" || $params['vendor_id'] == "") {
                        $resp = array('status' => 400, 'message' => 'please enter fields');
                    } else {
                        $test_id = $params['test_id'];
                        $vendor_id = $params['vendor_id'];
                        $resp = $this->LabcenterModel->test_details($test_id,$vendor_id);
                    }
                    simple_json_output($resp);
                }
            }
    ...
    public function vendor_details()
    {
        ...
        if ($method != 'POST') {
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    $params = json_decode(file_get_contents('php://input'), TRUE);
                    if ($params['vendor_id'] == "" || $params['user_id'] == "") {
                        $resp = array('status' => 400, 'message' => 'please enter fields');
                    } else {
                        $vendor_id = $params['vendor_id'];
                        $user_id = $params['user_id'];
                        $resp = $this->LabcenterModel->vendor_details($vendor_id,$user_id);
                    }
                    json_outputs($resp);
                }
            }
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    if ($params['booking_id'] == "") {
                        ...
                        $resp = $this->LabcenterModel->booking_summary($booking_id);
                    }
                    simple_json_output($resp);
                }
            }
    ...
    public function remove_test_cart() {
        $this->load->model('LabcenterModel');
        $method = $_SERVER['REQUEST_METHOD'];
        if ($method != 'POST') {
            json_output(400, array('status' => 400, 'message' => 'Bad request.'));
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    if ($params['user_id'] == "" || $params['test_id'] == "") {
                        ...
                        $user_id   = $params['user_id'];
                        $test_id   = $params['test_id'];
                        $resp = $this->LabcenterModel->remove_test_cart($user_id,$test_id);
                    }
                    simple_json_output($resp);
                }
            }
    ...
    public function remove_vendor_cart() {
        $this->load->model('LabcenterModel');
        $method = $_SERVER['REQUEST_METHOD'];
        if ($method != 'POST') {
            json_output(400, array('status' => 400, 'message' => 'Bad request.'));
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    $params = json_decode(file_get_contents('php://input'), TRUE);
                    if ($params['user_id'] == "" || $params['test_id'] == "" || $params['package_id'] == "" || $params['vendor_id'] == "") {
                        $resp = array('status' => 400, 'message' => 'please enter fields');
                    } else {
                        $user_id   = $params['user_id'];
                        $test_id   = $params['test_id'];
                        $package_id   = $params['package_id'];
                        $vendor_id   = $params['vendor_id'];
                        $resp = $this->LabcenterModel->remove_vendor_cart($user_id,$test_id,$package_id,$vendor_id);
                    }
                    simple_json_output($resp);
                }
            }
    ...
    public function addtocart() {
        ...
        if ($method != 'POST') {
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    $params = json_decode(file_get_contents('php://input'), TRUE);
                    if ($params['user_id'] == "" || $params['test_id'] == "" || $params['vendor_id'] == "" || $params['package_id'] == "") {
                        $resp = array('status' => 400, 'message' => 'please enter fields');
                    } else {
                        $user_id   = $params['user_id'];
                        $test_id   = $params['test_id'];
                        $package_id   = $params['package_id'];
                        $vendor_id = $params['vendor_id'];
                        $resp = $this->LabcenterModel->addtocart($user_id,$test_id,$vendor_id,$package_id);
                    }
                    simple_json_output($resp);
                }
            }
    ...
    public function add_package() {
        ...
        if ($method != 'POST') {
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    $params = json_decode(file_get_contents('php://input'), TRUE);
                    if ($params['user_id'] == "" || $params['package_id'] == "" || $params['vendor_id'] == "" || $params['clear_all'] == "") {
                        $resp = array('status' => 400, 'message' => 'please enter fields');
                    } else {
                        $user_id   = $params['user_id'];
                        $package_id   = $params['package_id'];
                        ...
                        $resp = $this->LabcenterModel->add_package($user_id,$package_id,$vendor_id,$clear_all);
                    }
                    simple_json_output($resp);
                }
            }
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    if ($params['user_id'] == "" || $params['vendor_id'] == "" || $params['address_id'] == "" || $params['vendor_type'] == "" || $params['booking_date'] == "" || $params['booking_time'] == "" || $params['package_id'] == "" || $params['test_id'] == "" || $params['member_id'] == "" || $params['payment_type'] == "") {
                        ...
                        if(array_key_exists('payment_gateway',$params)){
                        ...
                        $bachat_type=0;
                        $resp = $this->LabcenterModel->add_order($user_id,$vendor_id,$address_id,$vendor_type,$booking_date,$booking_time,$package_id,$test_id,$member_id,$payment_type,$coupon_id,$bachat_type,$user_email,$payment_gateway);
    ...
    public function update_order() {
        ...
        if ($method != 'POST') {
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    $params = json_decode(file_get_contents('php://input'), TRUE);
                    if ($params['booking_id'] == "" || $params['ledger_id'] == "" || $params['payment_status'] == "" || $params['ledger_type'] == "") {
                        $resp = array('status' => 400, 'message' => 'please enter fields');
                    } else {
                        $booking_id     = $params['booking_id'];
    ...
    public function update_payment_method() {
        ...
        if ($method != 'POST') {
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    $params = json_decode(file_get_contents('php://input'), TRUE);
                    if ($params['booking_id'] == "" || $params['ledger_id'] == "" || $params['payment_type'] == "") {
                        $resp = array('status' => 400, 'message' => 'please enter fields');
                    } else {
                        $booking_id     = $params['booking_id'];
                        $ledger_id      = $params['ledger_id'];
                        $payment_type   = $params['payment_type'];
                        $resp = $this->LabcenterModel->update_payment_method($booking_id,$ledger_id,$payment_type);
                    }
                    simple_json_output($resp);
                }
            }
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    if ($params['page'] == "") {
                        ...
                        $per_page = '';
                        $resp = $this->LabcenterModel->all_lab_package($page,$category,$most_common_risk,$sort_type,$home_delivery,$vendor_id,$featured,$recommended,$keyword,$per_page);
                    }
                    simple_json_output($resp);
                }
            }
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    if ($params['page'] == "") {
                        ...
                        $resp = $this->LabcenterModel->all_lab_test($page,$category,$most_common_risk,$sort_type,$home_delivery,$vendor_id,$keyword,$per_page,$type);
                    }
                    simple_json_output($resp);
                }
            }
    ...
    public function vendor_list_by_test_id() {
        $this->load->model('LabcenterModel');
        $method = $_SERVER['REQUEST_METHOD'];
        if ($method != 'POST') {
            json_output(400, array('status' => 400, 'message' => 'Bad request.'));
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    if ($test_id=="") {
                        ...
                        $resp = $this->LabcenterModel->vendor_list_by_test_id($lat,$lng,$test_id);
                    }
                    simple_json_output($resp);
                }
            }
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    if ($params['user_id'] == "") {
                        ...
                        if(array_key_exists('home_delivery',$params)){
                            $home_delivery = $params['home_delivery'];
                        } else {
                            $home_delivery = "";
                        }
                        ...
                        $resp = $this->LabcenterModel->test_list_by_vendor($user_id,$lat,$lng,$page,$home_delivery,$sort_type);
                    }
                    simple_json_output($resp);
                }
            }
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    if ($params['user_id'] == "" || $params['lat'] == "" || $params['lng'] == "" || $params['page'] == "") {
                        ...
                        $lng = $params['lng'];
                        $page = $params['page'];
                        $resp = $this->LabcenterModel->lab_home($user_id,$lat,$lng,$page);
                        simple_json_output($resp);
                    }
                }
            }
