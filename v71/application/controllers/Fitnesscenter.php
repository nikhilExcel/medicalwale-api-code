...
class Fitnesscenter extends CI_Controller {
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    if ($params['user_id'] == "" || $params['listing_id'] == "") {
                        ...
                        $resp = $this->FitnesscenterModel->fitness_center_details_v2($user_id, $listing_id,$branch_id);
                    }
                     simple_json_output($resp);
                }
            }
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    if ($params['user_id'] == "" || $params['listing_id'] == "" || $params['rating'] == "" || $params['review'] == "" || $params['service'] == "") {
                        ...
                        $review = $params['review'];
                        $service = $params['service'];
                        $resp = $this->FitnesscenterModel->edit_review($review_id,$user_id, $listing_id, $rating, $review, $service);
                    }
                    simple_json_output($resp);
                }
            }
  ...
  public function review_with_comment() {
   ...
   // scheduled for next release 
    ...
    public function add_bookings_v31() {
        $this->load->model('FitnesscenterModel');
        $method = $_SERVER['REQUEST_METHOD'];
        if ($method != 'POST') {
            json_output(400, array(
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                  //  $params = json_decode(file_get_contents('php://input'), TRUE);
                    ...
                    if ($this->input->post('user_id') == "" || $this->input->post('listing_id') == "" || $this->input->post('package_id') == "" || $this->input->post('branch_id') == "" ||$this->input->post('trainer_id') == "" || $this->input->post('category_id') == "") {
                        $resp = array(
                            'status' => 400,
                            'message' => 'please enter fields'
                        );
                        ...
                        $resp = $this->FitnesscenterModel->add_bookings_v31($user_id, $listing_id, $package_id, $branch_id,$trainer_id, $category_id, $trail_booking_date, $trail_booking_time, $joining_date, $user_name, $user_mobile, $user_email, $user_gender,$user_age,$user_height,$height_cm_ft,$user_weight,$user_diet_preference,$user_exercise_level,$user_medical_condition,$user_ever_went_gym,$user_bmi,$user_dob,$user_blood_group);
                    }
                    simple_json_output($resp);
                }
            }
    ...
    public function fitness_center_recommended_list() {
        $this->load->model('FitnesscenterModel');
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    if ($params['latitude'] == "" || $params['longitude'] == "") {
                        ...
                        $resp = $this->FitnesscenterModel->fitness_center_recommended_list($user_id, $latitude, $longitude, $category,$term);
                    }
                  json_outputs($resp);
                }
            }
    ...
    public function fitness_center_category_list() {
        $this->load->model('FitnesscenterModel');
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    if ($params['user_id'] == "" ) {
                        ...
                        $resp = $this->FitnesscenterModel->fitness_center_category_list($user_id);
                    }
                  json_outputs($resp);
                }
            }
    ...
    public function fitness_center_category_wise_list() {
        $this->load->model('FitnesscenterModel');
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    if ($params['latitude'] == "" || $params['longitude'] == "") {
                        ...
                        $resp = $this->FitnesscenterModel->fitness_center_category_wise_list($user_id, $latitude, $longitude, $category,$term,$page_no,$per_page);
                    }
                  json_outputs($resp);
                }
            }
