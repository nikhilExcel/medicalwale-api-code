                    ...
                    $data['orders'] = $this->input->post('products');
                      ...
                      if ($this->input->post('user_id') == "") {
		                ...
		                if(array_key_exists('bachat_service_id',$_POST)){
                            $data['bachat_service_id']  = $this->input->post('bachat_service_id');
                        } else {
                            $data['bachat_service_id'] = "0";
                        }
                        ...
                        else
                        {
                            ...
                            if($count > 0)
                            {
                                 $resp = array(
                                                "status" => 200,
                                                "message" => "Success",
                                                "image" => "https://medicalwale.s3.amazonaws.com/images/healthmall/Banner/606c55993b04a20210406180537.png",
                                                "data"=>$resp1
                                             );
        ...
        if ($method != 'POST') {
            ...
            if ($check_auth_client == true) {
                ...
                if ($user_id  == "") {
                    ...
                    $response = $this->HealthmallModel->get_main_categories($user_id);
                    $resp = array(
                        'status' => 200,
                        'message' => 'success',
                        // 'description' => $response['description'],
        ...
        if ($method != 'POST') {
            ...
            if ($check_auth_client == true) {
                ...
                if ($user_id  == "" ) {
                    ...
                    $response = $this->HealthmallModel->get_about_data($user_id);
                    $resp = array(
                        'status' => 200,
                        'message' => 'success',
                        'data' => $response
