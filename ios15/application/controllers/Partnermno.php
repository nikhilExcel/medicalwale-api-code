            ...
            if ($check_auth_client == true) {
                ...
                if(array_key_exists('invoice_no',$params)){
                 ...
                 if ($mno_id == "" || $invoice_no == "") {
                    ...
                    $res = $this->PartnermnoModel->order_pickedup($mno_id,$invoice_no, $order_pickedup);
            ...
            if ($check_auth_client == true) {
                ...
                if(array_key_exists('invoice_no',$params)){
                 ...
                 if ($mno_id == "" || $invoice_no == "") {
                    $resp = array(
                        'status' => 400,
                        'message' => 'please enter mno_id, order_delivered true or false and invoice_no '
                    );
                } else {
                    
                    $res = $this->PartnermnoModel->order_delivered($mno_id,$invoice_no, $order_delivered);
            ...
            if ($check_auth_client == true) {
                ...
                if(array_key_exists('invoice_no',$params)){
                 ...
                 if ($mno_id == "" || $invoice_no == "") {
                    $resp = array(
                        'status' => 400,
                        'message' => 'please enter mno_id, at_store true or false and invoice_no '
                    );
                } else {
                    
                    $res = $this->PartnermnoModel->at_store($mno_id,$invoice_no, $at_store);
