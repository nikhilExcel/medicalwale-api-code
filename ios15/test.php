...
//added for doctor prescription list 
  ...
  public function doctor_prescription_list($user_id){
       ...
       //echo "SELECT dp.*,dbm.booking_id FROM  doctor_booking_master as dbm LEFT JOIN  doctor_prescription as dp ON dbm.booking_id=dp.booking_id  where dbm.user_id= '$user_id' ";
