...
if(isset($_POST['id']))
{
		...
		$trimesterQuery = mysqli_query($conn,"SELECT title, details, image FROM `pregnancy_mom` order by id asc");
		...
		$image='https://d2c8oti4is0ms3.cloudfront.net/images/ofw_images/mom/'.$image;
