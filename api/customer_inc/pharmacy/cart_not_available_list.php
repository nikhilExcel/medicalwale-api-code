...
WHERE cart_order.user_id='$user_id' AND cart_order.id='$order_id' and cart_order_products.product_status='Not Available'";
...
$true_false='true';
$order_no=$row['uni_id'];
$cart_order_list_id=$row['cart_order_list_id'];
$order_date=$row['date'];
