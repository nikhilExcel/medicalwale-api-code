...
*/
            $resultpost = array_merge($people_array, $doctor_array, $pharmacy_array,  $labs_array, $nursing_array, $fitness_array, $hospital_array, $healthwall_array, $article_array, $survivor_array);
        } else {
            $resultpost = array();
        }
        return $resultpost;
            ...
            if ($listing_type == '19') {
                ...
                if ($count > 0) {
                    ...
                    foreach ($query->result_array() as $row) {
                      ...
                      //  echo "SELECT id,packages FROM `pest_control` WHERE id='$pestcontrol_id'";
