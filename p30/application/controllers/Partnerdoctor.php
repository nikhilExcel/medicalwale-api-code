     ...
     $this->load->model('PartnerdoctorModel');
        ...
        if ($method != 'POST') {
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    $params = json_decode(file_get_contents('php://input'), TRUE);
                    if ($params['user_id'] == "" || $params['is_user'] =="" || $params['patient_id'] =="") {
                        $resp = array(
                            'status' => 400,
                            'message' => 'please enter fields'
                        );
                       ...
                       $patient_id = $params['patient_id'];
                        $resp = $this->PartnerdoctorModel->view_patient_details($is_user, $patient_id, $user_id);
                    }
                    json_outputs($resp);
                }
            }
...
public function doctor_edit_consultation() {
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    if ($params['user_id'] == "" ) {
                        ...
                        $resp        = $this->PartnerdoctorModel->doctor_list_gender($latitude, $longitude, $user_id,$gender);
                    }
                    json_outputs($resp);
                }
            }
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    if ($params['user_id'] == "" || $params['latitude'] == "" || $params['longitude'] == "") {
                        ...
                        $resp        = $this->PartnerdoctorModel->doctor_friends_list($latitude, $longitude, $user_id);
                    }
                    json_outputs($resp);
                }
            }
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    if ($params['user_id'] == "") {
                        ...
                        $resp        = $this->PartnerdoctorModel->view_doctor_profile($user_id,$view_yourself);
                    }
                    json_outputs($resp);
                }
            }
  ...
  public function add_doctor_pic_movies()
    ...
    public function create_doctor_album() {
      ...
      public function doctor_album_photos() {
        $this->load->model('PartnerdoctorModel');
        $method = $_SERVER['REQUEST_METHOD'];
        if ($method != 'POST') {
            json_output(400, array(
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    if ($params['user_id'] == "" ) {
                        ...
                        $resp = $this->PartnerdoctorModel->doctor_album_photos($user_id, $album_id);
                    }
                    simple_json_output($resp);
                }
            }
...
$resp  = $this->PartnerdoctorModel->add_doctor_education_details($user_id,$college_name,$qualification,$from_date,$to_date);
    ...
    /**********************************************/
    //added by zak for event calender 
   public function all_event_list()
    ...
    //added by zak for update status 
    ...
    //added by zakir for share event with user and friend list
