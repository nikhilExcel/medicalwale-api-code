...
//          if ($img_file_b != '') {
//                 $image = 'https://d2c8oti4is0ms3.cloudfront.net/images/healthwall_media/category/' . $img_file_b;
//             } else {
//                 $big_image = '';
//             }
               ...
               $resultpost_new_type=array();
                ...
                if(count($resultpost) % 5 == 0 && count($resultpost)> 0)  {
                 ...
                 $ad_img="";
                    ...
                    /*$query = $this->db->query("SELECT id,user_id,vendor_type,ad_main_cat,main_cat_id,ad_title,ad_description,ad_link,ad_image FROM sponsored_advertisements where NOT FIND_IN_SET(id, '$ad_array') and status='1' ORDER BY id desc limit $count_limit");
                    $count = $query->num_rows();
                    if ($count > 0) {
                        $row  = $query->row_array();
                        $ad_img      = $row['ad_image'];
