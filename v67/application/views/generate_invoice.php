    ...
    <tbody>
        ...
        <tr>
            <td  style="border:1px solid #ddd;border-right:none!important;vertical-align: top;">
                <?php if($logo_url != ''){?>
                    <img  src="<?php echo $logo_url; ?>" width="50">
                <?php  } ?>
            </td>
       ...
       // $ap= $this->PharmacyPartnerModel->get_pro_name($dat->product_id);
           ...
           if($dat->product_discount > 0)
           {
               ...
               $selling_price1 = ($dat->product_price - $disc_rupee1)*$dat->product_quantity;
           ...
           $total1 = $selling_price1 + $gst_rupee1;
           $tot_sum += $total1;
        ?>
        <tr>
            <td style="border:1px solid #ddd;text-align:right"><?php echo $i; ?></td>
        ...
        <tr >
            ...
            <td colspan='2' style="border:1px solid #ddd;text-align:left;border-right:none!important;">
                <p>Total Amount </p>
                <p>Discount</p>
                <?php $dicount_per = $final_calculation['gst_in_percent'] == "" ? 0 : $final_calculation['gst_in_percent']; ?>
                <p>GST (<?php echo $dicount_per;?> %) </p>
                <p>Delivery Charge</p>
                <p><b>Grand total</b></p>
            </td>
            <td colspan='2' style="border:1px solid #ddd;text-align:right;border-left:none!important;">
                <p><?php echo $final_calculation['sub_total'];?></p>
                <p><?php echo $final_calculation['discount'];?></p>
                <p><?php echo $final_calculation['gst_in_rupees'];?></p>
                <p><?php echo $final_calculation['delivery_charges_by_customer'];?></p>
                <p><b><?php echo $final_calculation['grand_total_customer'];?></b></p>
            </td>
        </tr>
        <tr>
            <td colspan="100" style="border:1px solid #ddd;text-align:right">Amount (in words) : <b><?php echo ucwords(numtowords($final_calculation['grand_total_customer'])); ?> Only</b></td>
        </tr>
        <tr >
