       ...
       /*     $email    = $this->input->post('email');*/
        ...
        /*    $password = $this->input->post('password');*/
            ...
            if ($name == "" || $phone == "" || $gender == "" ) {
                ...
                $resp = $this->LoginModel->usersignup($name, $phone, $gender, $dob,  $image, $token, $agent);
            }
        ...
        if ($method != 'POST') {
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    //$height_cm_ft       = $params['height_cm_ft'];
                    $height_cm_ft       = '';
                    if ($params['user_id'] == "") {
                        $respStatus = 400;
                        $resp       = array(
                        ...
                        $respStatus = 200;
                        $resp = $this->LoginModel->userprofile($user_id,$marital_status, $blood_group, $height, $height_cm_ft, $weight, $diet_fitness, $exercise_level, $health_condition, $allergies, $ask_saheli, $organ_donor, $bmi, $activity_level, $addiction, $health_insurance,$blood_is_active,$heradiatry_problem,$lat,$lng,$map_location);
                    }
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    if ($params['user_id'] == "" || $params['listing_type'] == "") {
                        ...
                        $resp    = $this->LoginModel->user_booking_details($user_id, $listing_type);
                    }
                    json_outputs($resp);
                }
            }
