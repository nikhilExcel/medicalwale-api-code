	...
	public function childprofile()
		{
			...
			$resp = $this->ChildcareModel->childprofile($name,$gender,$dob,$birth_place,$parent,$image,$user_id);
				} 
	...
	public function childprofile_update()
		{
			...
			if (isset($_FILES["image"]) AND !empty($_FILES["image"]["name"])) {					
				...
				$resp = $this->ChildcareModel->childprofile_update($name,$gender,$dob,$birth_place,$parent,$image,$user_id,$childprofile_id);
				} 
