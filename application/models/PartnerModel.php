...
class PartnerModel extends CI_Model
{
    ...
    {
            $query = $this->db->query("SELECT id,name,email,phone,city,vendor_id FROM users WHERE phone='$phone' and vendor_id>'0'");
            $count = $query->num_rows();
            if ($count > 0) {
           ...
           $multi_user = $this->db->query("SELECT id,name,email,phone,city,vendor_id FROM `users` WHERE  phone='$phone' AND vendor_id>'0'");
