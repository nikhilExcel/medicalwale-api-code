...
{ 
    ...
    public function fitness_center_list($user_id, $latitude, $longitude, $category)
    {
     $radius = '5';
        ...
        if ($count > 0) {
			...
			$is_order_query = $this->db->query("SELECT id FROM `booking_master` WHERE listing_id='$listing_id' AND branch_id='$branch_id' AND category_id='$category' AND user_id='$user_id' AND package_id='100'");
  ...
  public function fitness_center_details($user_id,$listing_id)
    ...
    public function add_bookings($user_id, $listing_id, $package_id, $branch_id, $category_id,$trail_booking_date,$trail_booking_time,$joining_date,$user_name,$user_mobile,$user_email,$user_gender)
    {
        date_default_timezone_set('Asia/Kolkata');  
