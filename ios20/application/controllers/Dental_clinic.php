...
class Dental_clinic extends CI_Controller {
        ...
        if ($method != 'POST') {
          ...
          //echo "mm";die;
            ...
            if ($user_id == "" || $listing_id == "" || $lat == "" || $lat == ""  ) {
                ...
                $result = $this->Dental_clinic_model->dental_booking_v2($user_id, $lat, $lng, $listing_id, $address_line1, $address_line2, $city, $state, $pincode, $user_name, $mobile, $email, $gender, $status, $payment_mode, $booking_date, $booking_location, $booking_address, $booking_mobile, $patient_id, $booking_id, $trail_booking_date, $trail_booking_time,$package_id,$type,$sub_type,$amount,$transaction_id,$coupon_id);
    ...
    public function treatment_master_list_with_treatments() {
        $this->load->model('Dental_clinic_model');
        $method = $_SERVER['REQUEST_METHOD'];
        if ($method != 'POST') {
            json_output(400, array(
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    if ($params['user_id'] == "" ) {
                        ...
                        $resp = $this->Dental_clinic_model->treatment_master_list_with_treatments($user_id,$page,$cat_id,$sub_cat_name,$lat,$lng);
                    }
                    json_outputs($resp);
                }
            }
    ...
    public function treatment_master_dental_clinic_v2() {
        $this->load->model('Dental_clinic_model');
        $method = $_SERVER['REQUEST_METHOD'];
        if ($method != 'POST') {
            json_output(400, array(
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    if ($params['user_id'] == "" ) {
                        ...
                        $sort   = $params['sort']; //AtoZ ZtoA nearby
                        //$sub_cat_name = $params['sub_cat_name'];
                        $resp = $this->Dental_clinic_model->treatment_master_dental_clinic_v2($user_id,$page,$service_name,$lat,$lng,$sort);
                    }
                    json_outputs($resp);
                }
            }
                    ...
                    if ($params['user_id'] == "" ) {
                      ...
                      //  $lat     = $params['lat'];
                       // $lng     = $params['lng'];
                        ...
                        $cat_id  = $params['cat_id'];
                        //$sub_cat_name = $params['sub_cat_name'];
                        $resp = $this->Dental_clinic_model->treatments_services_list($user_id,$page,$cat_id,$listing_id);
                    }
                    json_outputs($resp);
                }
            }
    ...
    public function add_to_cart_service() {
        $this->load->model('Dental_clinic_model');
        $method = $_SERVER['REQUEST_METHOD'];
        if ($method != 'POST') {
            json_output(400, array(
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    $params = json_decode(file_get_contents('php://input'), TRUE);
                    if ($params['user_id'] == "" ||  $params['service_name'] == "") {
                        $resp = array(
                            'status' => 400,
                            'message' => 'please enter all fields'
                        );
                        ...
                        $resp = $this->Dental_clinic_model->add_to_cart_service($user_id,$service_name,$treatment_id,$listing_id);
                    }
                    simple_json_output($resp);
                }
            }
    ...
    public function delete_from_cart_service() {
        $this->load->model('Dental_clinic_model');
        $method = $_SERVER['REQUEST_METHOD'];
        if ($method != 'POST') {
            json_output(400, array(
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    $params = json_decode(file_get_contents('php://input'), TRUE);
                    if ($params['user_id'] == "" || $params['cart_id'] == "" ) {
                        $resp = array(
                            'status' => 400,
                            'message' => 'please enter all fields'
                        );
                        ...
                        $resp = $this->Dental_clinic_model->delete_from_cart_service($user_id,$cart_id);
                    }
                    simple_json_output($resp);
                }
            }
    ...
    public function unselect_from_cart_service() {
        $this->load->model('Dental_clinic_model');
        $method = $_SERVER['REQUEST_METHOD'];
        if ($method != 'POST') {
            json_output(400, array(
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    if ($params['user_id'] == "" || $params['service_name'] == "" ) {
                        ...
                        $user_id        = $params['user_id'];
                        $service_name     = $params['service_name'];
                        $resp = $this->Dental_clinic_model->unselect_from_cart_service($user_id,$service_name);
                    }
                    simple_json_output($resp);
                }
            }
    ...
    public function service_cart_list() {
        $this->load->model('Dental_clinic_model');
        $method = $_SERVER['REQUEST_METHOD'];
        if ($method != 'POST') {
            json_output(400, array(
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    if ($params['user_id'] == "") {
                        ...
                        $user_id        = $params['user_id'];
                        $resp = $this->Dental_clinic_model->service_cart_list($user_id);
                    }
                    simple_json_output($resp);
                }
            }
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    if ($params['user_id'] == "" ||  $params['listing_id'] == "") {
                        ...
                        $user_id        = $params['user_id'];
                        $listing_id   = $params['listing_id'];
                        $resp = $this->Dental_clinic_model->update_cart_service($user_id,$listing_id);
                    }
                    simple_json_output($resp);
                }
            }
