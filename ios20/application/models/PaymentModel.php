...
class PaymentModel extends CI_Model { 
    ...
    public function insert_paypal_token_payment_id($payment_id,$access_token,$uni_id,$invoice_id)
    {
        ...
        return  array(
            ...
            "payment_url" => "https://www.paypal.com/checkoutnow?token=".$payment_id."&country.x=IN&locale.x=en_IN"
        );
    }
    ...
    public function paypal_capture($payment_id)
    {
        ...
        $url = "https://api.paypal.com/v2/checkout/orders/".$payment_id."/capture";
        $ch  = curl_init($url);
        ...
        $url = "https://api.paypal.com/v2/checkout/orders/".$payment_id;
        $ch  = curl_init($url);
