                                ...
                                $tracker = $this->All_booking_model->pharmacy_tracker($user_id, $invoice_no);
                                 ...
                                 if($listing_type=="38")
                                   ...
                                   else
                                   {
                                        ...
                                        $get_mno_info = $this->db->query("SELECT * FROM mno_orders WHERE invoice_no = '$invoice_no'")->result_array();
           ...
           $query2 = $this->db->query("select * from rides where user_id = '$user_id' and ride_id='$invoice_no' ORDER BY ride_id DESC");
            ...
            if ($count2 > 0) {
                foreach ($query2->result_array() as $row2) {
                    ...
                    $payment_details = $row2['pay_mode'];
            $paymnet_status= $row2['pay_status'];
...
usort($resultpost, "cmp");   
           ...
           $query2 = $this->db->query("select * from rides where user_id = '$user_id'  ORDER BY Create_time DESC LIMIT $start, $limit");
