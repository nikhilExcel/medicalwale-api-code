...
class NotificationcontrolModel extends CI_Model {
    ...
    public function Notification_unread_count($user_id)
    {
        ...
        $promo = $this->db->query("SELECT id FROM `other_notifications` where (user_id = '0' || user_id = '$user_id' ) and   notification_type!='article' and notification_type!='HealthDictionary' AND is_read = '0' and notification_date >='$final_date' and created_at >='$user_created_at' order by notification_date desc ");
