        ...
        if ($method != 'POST') {
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                  ...
                  //  $params = json_decode(file_get_contents('php://input'), TRUE);
                    if ($this->input->post('name') == "" || $this->input->post('mobile') == "" || $this->input->post('listing_id')=="" || $this->input->post('address1')=="") {
                        $resp = array(
                            'status' => 400,
                            'message' => 'please enter fields'
                        );
                ...
                if ($response['status'] == 200) {
                    ...
                    if ($params['listing_id'] == "") {
                       ...
                       if(array_key_exists('page_no',$params)){
                        ...
                        $resp         = $this->PharmacyPartnerModel->list_address_v2($listing_id,$page_no,$per_page,$search);
                    }
                    simple_json_output($resp);
                }
            }
                ...
                if ($response['status'] == 200) {
                    ...
                    if ($params['listing_id'] == "") {
                       ...
                       if(array_key_exists('page_no',$params)){
                        ...
                        $resp         = $this->PharmacyPartnerModel->list_address_lead_v2($listing_id,$page_no,$per_page,$search);
                    }
                    simple_json_output($resp);
                }
            }
