...
class Payment extends CI_Controller {
	...
	public function paypal_create_order()
    {
        ...
        if ($method != 'POST') {
            ...
            if ($check_auth_client == true) {
                ...
                $username = 'AT51txGdbOcn60Y96XFHRpmrNmXHtPvtaful9WUfpdqP2ytadEkNQx5monoLFTNvDFL-3O4cYiAa6IXO';
                $password = 'ENzQ-Q59UBffAk1ZEt4cuUlyGpUkKIIENicsFPwxa4Zz4R8Yngr5WARKYB0MbTvosP_oB1MQ7gAmuRMS';
                $headers = array(
                ...
                if($contexts==''){
                    ...
                    $application_context= array(
                       ...
                       "user_action"=>"PAY_NOW",
                       "return_url"=>"https://medicalwale.com/healthmall/payment_success",
                       "cancel_url"=>"https://medicalwale.com/healthmall/payment_cancel",
    ...
    public function paypal_transaction_contexts($uni_id,$email,$first_name,$last_name,$access_token,$user_id,$national_number)
    {
        ...
        $url="https://api.paypal.com/v1/risk/transaction-contexts/XXFM9V5P9GFRE/".$uni_id;
        $ch = curl_init($url);
