...
class WellnessController extends CI_Controller {
    ...
    // Wellness Clinic listig function by ghanshyam parihar starts
    public function wellness_clinic_list() {
        $this->load->model('WellnessModel');
        ...
        if ($method != 'POST') {
            ...
            $check_auth_client = $this->WellnessModel->check_auth_client();
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    if ($params['latitude'] == "" || $params['longitude'] == "") {
                        ...
                        $resp = $this->WellnessModel->wellness_clinic_list($user_id, $latitude, $longitude, $category);
                    }
                    json_outputs($resp);
                }
            }
    ...
    // Wellness Clinic listig function by ghanshyam parihar ends
    
    // Spa center Bachat listig function by ghanshyam parihar starts
    public function wellness_clinic_bachat_list() {
        $this->load->model('WellnessModel');
        $method = $_SERVER['REQUEST_METHOD'];
        if ($method != 'POST') {
            json_output(400, array(
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    if ($params['user_id'] == "" || $params['latitude'] == "" || $params['longitude'] == "") {
                        ...
                        $longitude = $params['longitude'];
                        $category = $params['category'];
                        $resp = $this->WellnessModel->wellness_clinic_bachat_list($user_id, $latitude, $longitude, $category);
                    }
                    json_outputs($resp);
                }
            }
