...
class Partnerdoctor extends CI_Controller {
                    ...
                    if ($params['doctor_id'] == "" || $params['patient_name'] == "" || $params['contact_no'] == "" || $params['gender'] == "") {
                        ...
                        if(array_key_exists("address",$params)){
                         ...
                         if(array_key_exists("date_of_birth",$params)){
                          ...
                          if(array_key_exists("blood_group",$params)){
                            $blood_group = $params['blood_group'];
                        } else {
                            $blood_group = '';
                        }
                          if(array_key_exists("medical_profile",$params)){
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    if ($params['prescription_id'] == "" ) {
                        ...
                        $resp = $this->PartnerdoctorModel->print_prescription($prescription_id);
                    }
                    json_outputs($resp);
                }
            }
    ...
    public function print_prescriptionnew($prescription_id) {
       /* $this->load->model('PartnerdoctorModel');
         $resp = $this->PartnerdoctorModel->print_prescriptionnew($prescription_id);
        */
        $this->load->model('PartnerdoctorModel');
        $method = $_SERVER['REQUEST_METHOD'];
        if ($method != 'POST') {
    ...
    public function list_patient() {
        ...
        if ($method != 'POST') {
			...
			$search = $params['search'];    
                        $resp = $this->PartnerdoctorModel->list_patient($params['user_id'],$search);
                    }
                    json_outputs($resp);
                }
            }
        ...
        if ($method != 'POST') {
		    ...
		    if(array_key_exists("page_no",$params)){
                    ...
                    if ($params['doctor_id'] == "" || $params['keyword'] == "") {
                        ...
                        $doctor_id = $params['doctor_id'];
                        $keyword   = $params['keyword'];
                        $resp = $this->PartnerdoctorModel->medicine_search($doctor_id,$keyword,$page_no);
                    }
                    json_outputs($resp);
                }
            }
    ...
    public function view_appointments_by_appoint_id() {
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    if (  $params['user_id'] == "") {
                        ...
                        $resp = $this->PartnerdoctorModel->view_appointments_by_appoint_id_module($user_id,$booking_id);
                    }
                    json_outputs($resp);
                }
            }
...
// 	added by nikhil for Vishal(IOS)
	
	public function doctor_edit_timings_ios() {
        $this->load->model('PartnerdoctorModel');
        $method = $_SERVER['REQUEST_METHOD'];
        if ($method != 'POST') {
            json_output(400, array(
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    // $consultation_charges = $params['consultation_charges'];
                        ...
                        // $consultation_charges = $this->input->post('consultation_charges'); 
                        $consultation_charges = $params['consultation_charges'];
                        $appointment_time = $params['appointment_time'];
                        //  $appointment_time = $this->input->post('appointment_time');
                         if($appointment_time == ""){$appointment_time = "null";}
                        //  $time =  $this->input->post('timings');
                         $time = $params['timings'];
                        // $discount_amount_min = $this->input->post('discount_amount_min');
                        $discount_amount_min = $params['discount_amount_min'];
                        // $discount_amount_max = $this->input->post('discount_amount_max');
                        $discount_amount_max = $params['discount_amount_max'];
                        // $discount_type = $this->input->post('discount_type');
                        $discount_type = $params['discount_type'];
                        // $discount_limit = $this->input->post('discount_limit');
                        ...
                        // $chat_fee= $this->input->post('chat_fee'); 
                        $chat_fee = $params['chat_fee'];
                        
                        // $video_fee=$this->input->post('video_fee');
                        $video_fee = $params['video_fee'];
                        
                        // $consultation_chat =$this->input->post('chat'); 
                        $consultation_chat = $params['chat'];
                        
                        // $consultation_video =$this->input->post('video'); 
                        $consultation_video = $params['video'];
                        ...
                        $consultation_entryadd = $this->PartnerdoctorModel->doctor_consultation_entry($doctor_id,$consultation_entry);
                       	...
                       	$consultation_type="";
            			if($consultation_chat=="1" && $consultation_video=="1")
            			{
            			   $consultation_type= "chat,video";
            			}
            			elseif($consultation_chat=="0" && $consultation_video=="1")
            			{
            			   $consultation_type= "video";
            			}
            			elseif($consultation_chat=="1" && $consultation_video=="0")
            			{
            			   $consultation_type= "chat";
            			}
            			elseif($consultation_chat=="0" && $consultation_video=="0")
            			{
            			   $consultation_type= "";
            			}
            			$chat_charges="0";
            			...
            			{
            			    $video_charges=$video_fee;
            			}
			        $data_type= 
			        array
			            (
                            'consultaion_video' 	 => $video_charges,
                            'consultaion_chat' 	     => $chat_charges,
                            'consultation_type'      => $consultation_type
                        );
		
		            $data_doctor = array(
                                    'chat' => $consultation_chat,
                                    'video' => $consultation_video,
                                    'chat_fee' => $chat_charges,
                                    'video_fee' => $video_charges
                                  );
                   
                    $this->db->where('doctor_id', $doctor_id);
                    $this->db->where('status', '0');
                    $insert = $this->db->update('doctor_online', $data_doctor);
		
		     $consultation_entryadd_new = $this->PartnerdoctorModel->update_consultation_amount($data_type,$doctor_id);
                ...
                $clinic_id = '0';
                       ...
                       $discount_data = array(
                            'doctor_user_id' => $params['doctor_id'],
                            'charges'=> "0",
                    ...
                    $timeConsult = $appointment_time;
                 $consultation_new_type='online';
                    $allRows = $this->PartnerdoctorModel->doctor_delete_clinic_timing($clinic_id, $doctor_id, $consultation_new_type);
                  
                    $deleted = $this->PartnerdoctorModel->doctor_delete_slot_details($doctor_id, $clinic_id,$consultation_new_type);                        
                    ...
                    //         echo '<pre>';
                    // print_r($timings[$i]['day']);
                    // die();
                             $day = $timings[$i]['day'];
                             
                            for($j=0;$j<sizeof($timings[$i]['slots']);$j++){
                                //         echo '<pre>';
                                // print_r($timings[$i]['slots'][$j]['time']);
                                // die();
                                
                                $timeSlot = $timings[$i]['slots'][$j]['time_slot'];
                                
                                for($k=0;$k<sizeof($timings[$i]['slots'][$j]['time']);$k++){
                                            
                                            $fromDate =  $timings[$i]['slots'][$j]['time'][$k]['FromTime'];
                                            $toDate =  $timings[$i]['slots'][$j]['time'][$k]['ToTime'];
...
public function doctor_edit_consultation() {
			...
			if($check_auth_client == true){
		        ...
		        if($response['status'] == 200){
					if ($this->input->post('doctor_id') == "") {
					    ...
					    $story_file = "";
					    $doctor_id = $this->input->post('doctor_id');
                        $stroy_text = $this->input->post('stroy_text');
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    if ($params['user_id'] == "") {
                        ...
                        $resp        = $this->PartnerdoctorModel->event_tracker($user_id,$doctor_id,$count,$seen,$story_id,$track_id);
                    }
                    simple_json_output($resp);
                }
            }
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    if ($params['story_id'] == "" || $params['user_id'] == "") {
                        ...
                        $resp        = $this->PartnerdoctorModel->delete_story($story_id,$user_id);
                    }
                    json_outputs($resp);
                }
            }
    ...
    public function you_may_know_list()
    {
        $this->load->model('PartnerdoctorModel');
        $method = $_SERVER['REQUEST_METHOD'];
        if ($method != 'POST') {
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    if ($params['user_id'] == "" ) {
                        ...
                        $type        = $params['type'];       //education
                        $resp        = $this->PartnerdoctorModel->you_may_know_list($latitude, $longitude, $user_id,$page_no,$per_page,$type);
                    }
                    json_outputs($resp);
                }
            }
...
$resp  = $this->PartnerdoctorModel->add_doctor_education_details($user_id,$college_name,$qualification,$from_date,$to_date);
     ...
     public function doctor_status_change()
    {
      ...
      public function doctor_request_()
    {
        $this->load->model('PartnerdoctorModel');
        $method = $_SERVER['REQUEST_METHOD'];
        if ($method != 'POST') {
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    if ($user_id == "" ) {
                        ...
                        $resp = $this->PartnerdoctorModel->doctor_request_($user_id,$status,$cat); 
                    }
                    json_outputs($resp);
                }
            }
      ...
      public function doctor_request_category()
    {
        $this->load->model('PartnerdoctorModel');
        $method = $_SERVER['REQUEST_METHOD'];
        if ($method != 'POST') {
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    if ($user_id == "" ) {
                        ...
                        $resp = $this->PartnerdoctorModel->doctor_request_category($user_id,$status); 
                    }
                    json_outputs($resp);
                }
            }
        ...
        public function doctor_request_withdraw()
    {
        $this->load->model('PartnerdoctorModel');
        $method = $_SERVER['REQUEST_METHOD'];
        if ($method != 'POST') {
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    if ($user_id == "" ) {
                        ...
                        $resp = $this->PartnerdoctorModel->doctor_request_withdraw($user_id,$dating_id,$days); 
                    }
                    json_outputs($resp);
                }
            }
    ...
    public function delete_work_place()
    {
        $this->load->model('PartnerdoctorModel');
        $method = $_SERVER['REQUEST_METHOD'];
        if ($method != 'POST') {
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    if ($user_id == "" || $work_id== "" ) {
                        ...
                        $resp = $this->PartnerdoctorModel->delete_work_place($user_id,$work_id); 
                    }
                    simple_json_output($resp);
                }
            }
    ...
    public function delete_fav_sport()
    {
        $this->load->model('PartnerdoctorModel');
        $method = $_SERVER['REQUEST_METHOD'];
        if ($method != 'POST') {
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    if ($user_id == "" || $sport_id== "" ) {
                        ...
                        $resp = $this->PartnerdoctorModel->delete_fav_place($user_id,$sport_id); 
                    }
                    simple_json_output($resp);
                }
            }
      ...
      public function Delete_doctor_education()
    {
        $this->load->model('PartnerdoctorModel');
        $method = $_SERVER['REQUEST_METHOD'];
        if ($method != 'POST') {
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    if ($user_id == "" || $edu_id== "" ) {
                        ...
                        $resp = $this->PartnerdoctorModel->Delete_doctor_education($user_id,$edu_id); 
                    }
                    simple_json_output($resp);
                }
            }
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    if ( $params['user_id'] =="") {
                        ...
                        $resp = $this->PartnerdoctorModel->languages_known($user_id);
                    }
                    json_outputs($resp);
                }
            }
    ...
    public function doctor_online_connect() {
        $this->load->model('PartnerdoctorModel');
        $method = $_SERVER['REQUEST_METHOD'];
        if ($method != 'POST') {
            json_output(400, array(
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    if ($params['doctor_id'] == "" || $params['user_id'] == ""  ) {
                        ...
                        $user_id=$params['user_id'];
                        $booking_id=$params['booking_id'];
                        $resp = $this->PartnerdoctorModel->doctor_online_connect($doctor_id,$user_id,$booking_id);
                    }
                    simple_json_output($resp);
                }
            }
       ...
       public function add_bookings_prescription()
    {
        $this->load->model('PartnerdoctorModel');
        $method = $_SERVER['REQUEST_METHOD'];
        if ($method != 'POST') {
                ...
                if ($response['status'] == 200) {
                    ...
                    if ($params['user_id'] == "") {
                        ...
                        $resp = array(
                            ...
                            $resp= $this->PartnerdoctorModel->add_bookings_prescription($doctor_id,$user_id,$clinic_id);
                    }
                    simple_json_output($resp);
                }
            }
