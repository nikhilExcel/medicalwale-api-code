    ...
    public function hash_tag()
    {
        ...
        if ($method != 'POST') {
            ...
            if ($check_auth_client == true) {
                $response = $this->HealthwallModel->auth();
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    if ($params['user_id'] == "" || $params['activity_user_id'] == "" || $params['healthwall_category'] == "" || $params['page'] == "") {
                        ...
                        $resp = $this->HealthwallModel->post_list($user_id, $activity_user_id, $healthwall_category, $page, $type);
                    }
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    if ($params['user_id'] == "" || $params['activity_user_id'] == "" || $params['healthwall_category'] == "" || $params['page'] == "") {
                        ...
                        $activity_user_id = $params['activity_user_id'];
                        $healthwall_category = $params['healthwall_category'];
                        $resp = $this->HealthwallModel->post_list_v2($user_id, $activity_user_id, $healthwall_category, $page, $type);
                    }
                    json_healthwall($resp);
                }
            }
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    if ($params['user_id'] == "" || $params['post_id'] == "") {
                        ...
                        $user_id = $params['user_id'];
                        $post_id = $params['post_id'];
                        $resp    = $this->HealthwallModel->post_delete($user_id, $post_id);
                    }
                    simple_json_output($resp);
                }
            }
