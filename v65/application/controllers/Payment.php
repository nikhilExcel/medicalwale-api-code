                         ...
                         if(array_key_exists('card_type',$params))
                           {
					    	...
					    	$resp           = $this->PaymentModel->insert_payment_status($user_id, $listing_id, $trans_id, $status, $type, $order_id, $order_type, $amount, $status_mesg, $discount, $discount_rupee, $payment_type,$opd,$card_type);
					}
