            ...
            // delivery charges debit entry : 
                ...
                if($listing_type == 44){
                    ...
                    if($delivery_charges_by_customer != 0){
                        ...
                        $user_comments = "";
                        $mw_comments = "Delivery charges by customer to night owl";
                        $vendor_comments = "";
                        $payment_method = "";
                    ...
                    if($delivery_charges_by_vendor != 0 && $completed != 1){
                        $user_comments = "";
                        $mw_comments = "Delivery charges by vendor to night owl";
                        $vendor_comments = "";
                        $payment_method = "";
                    ...
                    if($delivery_charges_by_mw != 0 && $completed != 1){
                        $user_comments = "";
                        $mw_comments = "Delivery charges by medicalwale to night owl";
                        $vendor_comments = "";
                        $payment_method = "";
                        $credit = "";
