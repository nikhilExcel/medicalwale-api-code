...
class ArticleModel extends CI_Model {
    ...
    public function article_list($category_id, $user_id, $page) {
     ...
     public function article_list_new($user_id, $page,$type,$sub_type) {
        ...
        if($sub_type!=""){
        $wher.="and article.cat_id='$sub_type'";
        }
        ...
        $lang=$query_lang->language;
      if($type=='1'){
        $query = $this->db->query("SELECT article.id,article.views, article.cat_id, article.article_title, article.article_title_hindi, article.article_description, article.article_description_hindi, article.image, article.posted, article.is_active, article.updated_date ,article_category.name AS category_name,article_category.type FROM article INNER JOIN article_category ON article.cat_id=article_category.id WHERE article_category.type='app_article' $wher and  article.language='$lang' limit $start,$limit");
      }
    if($type=='4'){
         $query = $this->db->query("SELECT article.id,article.views, article.cat_id, article.article_title, article.article_title_hindi, article.article_description, article.article_description_hindi, article.image, article.posted, article.is_active, article.updated_date ,article_category.name AS category_name,article_category.type FROM article INNER JOIN article_category ON article.cat_id=article_category.id WHERE article_category.type='home_remedies' $wher and  article.language='$lang' limit $start,$limit");
    }if($type=='3'){ 
        $query = $this->db->query("SELECT article.id,article.views, article.cat_id, article.article_title, article.article_title_hindi, article.article_description, article.article_description_hindi, article.image, article.posted, article.is_active, article.updated_date ,article_category.name AS category_name,article_category.type FROM article INNER JOIN article_category ON article.cat_id=article_category.id WHERE article_category.type='tips' $wher  and article.language='$lang' limit $start,$limit");
    }if($type=='2'){
        $query = $this->db->query("SELECT article.id,article.views, article.cat_id, article.article_title, article.article_title_hindi, article.article_description, article.article_description_hindi, article.image, article.posted, article.is_active, article.updated_date ,article_category.name AS category_name,article_category.type FROM article INNER JOIN article_category ON article.cat_id=article_category.id WHERE article_category.type='skin_hair' $wher  and  article.language='$lang' limit $start,$limit");
    }
		    ...
		    $src_file_name = $row['image'];
              ...
              $ad_post=array();
				 ...
				 $article_image = 'https://d2c8oti4is0ms3.cloudfront.net/images/article_images/' . $article_image;
                        ...
                        $image_ext="video";
				 $article_image = 'https://d2c8oti4is0ms3.cloudfront.net/images/healthwall_media/video/' . $article_image;
                        }
     ...
     public function article_sub_cat($user_id,$type) {
      ...
      if($type=='1'){
        $query = $this->db->query("SELECT id,name,article_category.type FROM article_category WHERE article_category.type='app_article'");
      }
    if($type=='4'){
         $query = $this->db->query("SELECT id,name,article_category.type FROM article_category WHERE article_category.type='home_remedies' ");
    }if($type=='3'){ 
        $query = $this->db->query("SELECT id,name,article_category.type FROM article_category WHERE article_category.type='tips' ");
    }if($type=='2'){
        $query = $this->db->query("SELECT id,name,article_category.type FROM article_category WHERE article_category.type='skin_hair'  ");
    }
      //  echo "SELECT article.id,article.views, article.cat_id, article.article_title, article.article_title_hindi, article.article_description, article.article_description_hindi, article.image, article.posted, article.is_active, article.updated_date ,article_category.name AS category_name,article_category.type FROM article INNER JOIN article_category ON article.cat_id=article_category.id WHERE article.cat_id='$category_id' AND article.language='$lang' limit $start,$limit";
        $count = $query->num_rows();
