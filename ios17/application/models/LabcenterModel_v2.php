...
//   get_offers
    ...
    public function get_offers($offer_id){
     ...
     //   echo "SELECT * FROM vendor_offers WHERE `listing_id`='10' AND `status` = '0' AND `end_date` >= '$today' $whereId"; die();
	    $getAllOffers = $this->db->query("SELECT * FROM vendor_offers WHERE `listing_id`='10' AND `status` = '0' AND `end_date` >= '$today' $whereId")->result_array();
	   // print_r($getAllOffers); die();
