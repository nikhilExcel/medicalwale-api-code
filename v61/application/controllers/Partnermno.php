    ...
    public function order_to_pharmacy() {
        ...
        if ($method != 'POST') {
            ...
            if ($check_auth_client == true) {
                ...
                if ($mno_id == "" || $invoice_no == "" || $pharmacy_id == "") {
                    $resp = array(
                        'status' => 400,
                        'message' => 'please enter mno_id, pharmacy_id and invoice_no'
                    );
                } else {
                    
                    $res = $this->PartnermnoModel->order_to_pharmacy($mno_id, $invoice_no, $pharmacy_id);
