...
class Bloodbank extends CI_Controller {
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    if ($params['user_id'] == "" || $params['listing_id'] == "" || $params['rating'] == "" || $params['review'] == "" || $params['service'] == "") {
                        ...
                        $review = $params['review'];
                        $service = $params['service'];
                        $resp = $this->BloodbankModel->edit_review($review_id,$user_id, $listing_id, $rating, $review, $service);
                    }
                    simple_json_output($resp);
                }
            }
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    if ($params['user_id'] == "" || $params['listing_id'] == "") {
                        ...
                        $user_id = $params['user_id'];
                        $listing_id = $params['listing_id'];
                        $resp = $this->BloodbankModel->review_with_comment($user_id, $listing_id);
                    }
                    json_outputs($resp);
                }
            }
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    if ($params['user_id'] == "") {
                        ...
                        $resp = $this->BloodbankModel->blood_donate($user_id);
                        json_outputs($resp);
                    }
    ...
    public function bloodbank_profile_views() {
        $this->load->model('BloodbankModel');
        $method = $_SERVER['REQUEST_METHOD'];
        if ($method != 'POST') {
            json_output(400, array(
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    if ($params['user_id'] == "" || $params['listing_id'] == "") {
                        ...
                        $user_id = $params['user_id'];
                        $listing_id = $params['listing_id'];
                        $resp = $this->BloodbankModel->bloodbank_profile_views($user_id, $listing_id);
                    }
                    simple_json_output($resp);
                }
            }
     ...
     public function blood_profile_details() {
        $this->load->model('BloodbankModel');
        $method = $_SERVER['REQUEST_METHOD'];
        if ($method != 'POST') {
            json_output(400, array(
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    if ($params['user_id'] == "" || $params['listing_id'] == "") {
                        ...
                        $user_id = $params['user_id'];
                        $listing_id = $params['listing_id'];
                        $resp = $this->BloodbankModel->blood_profile_details($user_id, $listing_id);
                    }
                    simple_json_output($resp);
                }
            }
