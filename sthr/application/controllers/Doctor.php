     ...
     public function add_bookings()
    {
     ...
     public function add_bookings_v2() {
        ...
        if ($method != 'POST') {
            ...
            $resp               = $this->DoctorModel->add_bookings_v2($user_id, $listing_id, $clinic_id, $booking_date, $booking_time, $user_name, $user_mobile, $from_time, $to_time, $user_email, $user_gender, $is_user, $is_patient, $patient_id,$allergies, $heradiatry_problem, $description, $relationship, $date_of_birth, $connect_type,$coupon_id,$status);
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    if ($params['doctor_id'] == "" || $params['consultation_type'] == "") {
                        ...
                        $resp              = $this->DoctorModel->user_read_slot_v2($doctor_id, $consultation_type,$agent);
                    }
                    json_outputs($resp);
                }
            }
            ...
            if ($check_auth_client == true) {
                ...
                if ($response['status'] == 200) {
                    ...
                    if ($params['doctor_id'] == "" || $params['consultation_type'] == "") {
                        ...
                        $doctor_id         = $params['doctor_id'];
                        $consultation_type = $params['consultation_type'];
                        $resp              = $this->DoctorModel->user_read_slot_v3($doctor_id, $consultation_type);
                    }
                    json_outputs($resp);
                }
            }
