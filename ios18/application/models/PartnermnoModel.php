    ...
    public function order_pickedup($mno_id,$invoice_no,$paid_to_pharmacy,$paid_to_pharmacy_comment,$received_from_pharmacy,$received_from_pharmacy_comment,$received_including_delivery_charges,$paid_payment_method, $received_payment_method){
        ...
        if($existingOrder > 0){
           ...
           // add for each transaction
            ...
            // WORKING
            $transaction_date = "";
             $res = $this->LedgerModel->create_ledger($mno_id, $invoice_no, $mno_id_type, $phatmacy_id, $phatmacy_id_type, $credit, $debit, $payment_method, $user_comments, $mw_comments, $vendor_comments,$order_type,$transaction_of,$transaction_id,$trans_status,$transaction_date);
            ...
            // delivery charges debit entry : 
                ...
                if($listing_type == 44){
                    ...
                    if($delivery_charges_by_customer != 0){
                        ...
                        // WORKING
                        $transaction_date = "";
                        $res1 = $this->LedgerModel->create_ledger($user_id, $invoice_no, $user_id_type, $mno_id, $mno_id_type, $credit, $debit, $payment_method, $user_comments, $mw_comments, $vendor_comments,$order_type,$transaction_of,$transaction_id,$trans_status,$transaction_date);
                    ...
                    if($delivery_charges_by_vendor != 0 && $completed != 1){
                        ...
                        // WORKING
                        $transaction_date = "";
                        $res2 = $this->LedgerModel->create_ledger($mno_id, $invoice_no, $mno_id_type, $phatmacy_id, $phatmacy_id_type, $credit, $debit, $payment_method, $user_comments, $mw_comments, $vendor_comments,$order_type,$transaction_of,$transaction_id,$trans_status,$transaction_date);
                    ...
                    if($delivery_charges_by_mw != 0 && $completed != 1){
                        ...
                        // WORKING
                        $transaction_date = "";
                        $res3 = $this->LedgerModel->create_ledger($mno_id, $invoice_no, $mno_id_type, $mw_id, $mw_id_type, $credit, $debit, $payment_method, $user_comments, $mw_comments, $vendor_comments,$order_type,$transaction_of,$transaction_id,$trans_status,$transaction_date);
                ...
                if($listing_type == 13){
                    ...
                    if($delivery_charges_by_vendor != 0){
                        ...
                        // WORKING
                        $transaction_date= "";
                        $res1 = $this->LedgerModel->create_ledger($mno_id, $invoice_no, $mno_id_type, $phatmacy_id, $phatmacy_id_type, $credit, $debit, $payment_method, $user_comments, $mw_comments, $vendor_comments,$order_type,$transaction_of,$transaction_id,$trans_status,$transaction_date);
                    ...
                    if($delivery_charges_by_customer != 0 && $completed != 1){
                        ...
                        // WORKING
                        $transaction_date = "";
                        $res2 = $this->LedgerModel->create_ledger($user_id, $invoice_no, $user_id_type, $mno_id, $mno_id_type, $credit, $debit, $payment_method, $user_comments, $mw_comments, $vendor_comments,$order_type,$transaction_of,$transaction_id,$trans_status,$transaction_date);
    ...
    public function order_delivered($mno_id,$invoice_no){
       ...
       $existingOrder = $this->db->query("SELECT uo.user_id,uo.delivery_charge,uo.delivery_charges_by_customer, uo.delivery_charges_by_vendor, uo.delivery_charges_by_mw,  uo.total_without_dc,uo.listing_type,uo.payment_method,uo.order_total, uo.listing_id,  uo.delivery_charges_to_mno, uo.suggested_pharmacy_id, ml.mno_name, mo.*, u.id as user_id, u.phone, u.token, u.agent FROM `mno_orders` as mo left join user_order as uo on (mo.invoice_no = uo.invoice_no) left join users as u on (uo.user_id = u.id) left join mno_list as ml on (ml.mno_id = mo.mno_id) WHERE mo.`invoice_no` = '$invoice_no' AND mo.`mno_id` = '$mno_id' AND mo.`ongoing` = 1 AND mo.`status` = 'accepted'")->row_array();
        ...
        if($existingOrder > 0 ){
           ...
           $transaction_date = "";
            $res = $this->LedgerModel->create_ledger($user_id, $invoice_no, $user_id_type, $mno_id, $mno_id_type, $credit, $debit, $payment_method, $user_comments, $mw_comments, $vendor_comments,$order_type,$transaction_of,$transaction_id,$trans_status,$transaction_date);
                       ...
                       // add for each transaction
                        ...
                        if($payment_method == 3){ // payment in CAP: refer payment_method
                            ...
                            // $user_id , $user_id_type , $phatmacy_id, $phatmacy_id_type
                             ...
                             $transaction_date = "";
                            $res = $this->LedgerModel->create_ledger($user_id, $invoice_no, $user_id_type, $phatmacy_id, $phatmacy_id_type, $credit, $debit, $payment_method, $user_comments, $mw_comments, $vendor_comments,$order_type,$transaction_of,$transaction_id,$trans_status,$transaction_date);
