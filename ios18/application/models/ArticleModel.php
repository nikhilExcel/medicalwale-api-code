...
class ArticleModel extends CI_Model {
    ...
    public function article_list($category_id, $user_id, $page) {
     ...
     public function article_list_new($user_id, $page,$type,$sub_type) {
        $ad_array='0,';
        //Pagination
        $limit = 5;
        $start = 0;
        ...
        $lang=$query_lang->language;
      if($type=='1'){
        $query = $this->db->query("SELECT article.id,article.views, article.cat_id as cat_id1, article.article_title, article.article_title_hindi, article.article_description, article.article_description_hindi, article.image, article.posted, article.is_active, article.updated_date ,article_category.name AS category_name,article_category.type FROM article INNER JOIN article_category ON article.cat_id=article_category.id WHERE article_category.type='app_article' $wher and  article.language='$lang' order by posted DESC limit $start,$limit");
      }
    if($type=='4'){
         $query = $this->db->query("SELECT article.id,article.views, article.cat_id as cat_id1, article.article_title, article.article_title_hindi, article.article_description, article.article_description_hindi, article.image, article.posted, article.is_active, article.updated_date ,article_category.name AS category_name,article_category.type FROM article INNER JOIN article_category ON article.cat_id=article_category.id WHERE article_category.type='home_remedies' $wher and  article.language='$lang' order by posted DESC limit $start,$limit");
    }if($type=='3'){ 
        $query = $this->db->query("SELECT article.id,article.views, article.cat_id as cat_id1, article.article_title, article.article_title_hindi, article.article_description, article.article_description_hindi, article.image, article.posted, article.is_active, article.updated_date ,article_category.name AS category_name,article_category.type FROM article INNER JOIN article_category ON article.cat_id=article_category.id WHERE article_category.type='tips' $wher  and article.language='$lang' order by posted DESC limit $start,$limit");
    }if($type=='2'){
        $query = $this->db->query("SELECT article.id,article.views, article.cat_id as cat_id1, article.article_title, article.article_title_hindi, article.article_description, article.article_description_hindi, article.image, article.posted, article.is_active, article.updated_date ,article_category.name AS category_name,article_category.type FROM article INNER JOIN article_category ON article.cat_id=article_category.id WHERE article_category.type='skin_hair' $wher  and  article.language='$lang' order by posted DESC limit $start,$limit");
    }
    if($type=='5'){
        $query = $this->db->query("SELECT surgery_master.id,surgery_master.surgery_name,surgery_master.surgery_image,surgery_master.created_at,surgery_master.subcategory_id,surgery_master_category.category_name FROM `surgery_master` Inner join surgery_master_category  on surgery_master.subcategory_id=surgery_master_category.id $where order by surgery_master.id DESC limit $start,$limit");
    }
