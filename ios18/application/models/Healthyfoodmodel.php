...
//$addr_patient_name=$firstname.' '.$lastname;
    ...
    public function edit_yogapulp_product_review($review_id,$user_id, $listing_id, $rating, $review, $service) {
        date_default_timezone_set('Asia/Kolkata');
        $date = date('Y-m-d H:i:s');
        $review_array = array(
            'rating' => $rating,
           ...
           $this->db->update('healthy_food_product_review',$review_array);
