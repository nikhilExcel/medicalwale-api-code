                ...
                if ($response['status'] == 200) {
                    ...
                    if ($this->input->post('user_id') == "" || $this->input->post('listing_id') == "" || $this->input->post('package_id') == "" || $this->input->post('branch_id') == "" || $this->input->post('category_id') == "") {
                       ...
                       /* $user_diet_preference= $params['diet_preference'];
                        ...
                        $resp = $this->SpaModel->add_bookings($user_id,$patient_id, $listing_id, $package_id, $branch_id, $category_id, $trail_booking_date, $trail_booking_time, $user_name, $user_mobile, $user_email, $user_gender,$user_age,$trainer_id,$address_id,$instruction,$amt);
                    }
                    simple_json_output($resp);
                }
            }
