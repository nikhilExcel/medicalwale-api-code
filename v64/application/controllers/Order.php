        ...
        if ($method != 'POST') {
            ...
            if ($lat == "" || $lng == "") {
              // print_r($lat); die();
                ...
                $data = $this->OrderModel->prescription_add_quickbook($user_id, $address_id, $chat_id, $payment_method, $delivery_charge, $is_night_delivery,$lat,$lng,$product_id,$is_profile,$listing_id,$night_owls);
