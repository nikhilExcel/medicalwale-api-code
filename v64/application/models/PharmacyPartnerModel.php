            ...
            if($amount > 0){
                ...
                if(sizeof($paymentMethods) > 0){
                   ...
                   // add for each transaction
                    ...
                    // NOT - WORKING
                     $res = $this->LedgerModel->create_ledger($customer_id, $invoice_no, $customer_id_type, $listing_id, $listing_type, $credit, $debit, $payment_method, $user_comments, $mw_comments, $vendor_comments,$order_type,$transaction_of,$transaction_id,$trans_status);
