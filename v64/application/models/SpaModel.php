...
class SpaModel extends CI_Model {
    ...
    public function spa_package_list_categorywise($user_id,$main_category,$sub_category,$tab_id,$sort,$latitude,$longitude)
    {
         $radius = '5';
        $resultpost = array();
        ...
        function GetDrivingDistance($lat1, $lat2, $long1, $long2) {
         ...
         $where = "";
                ...
                {
                    $where .= " AND (FIND_IN_SET('" . $main_category . "', spa_package_category) OR FIND_IN_SET('" . $sub_category . "', spa_package_category))";
                }
                $wh="";
                if($sort=="low")
                {
    ...
    */
    ...
    public function add_bookings($user_id, $patient_id, $listing_id, $package_id, $branch_id, $category_id, $trail_booking_date, $trail_booking_time, $user_name, $user_mobile, $user_email, $user_gender,$user_age,$question,$trainer_id,$address_id) {
        date_default_timezone_set('Asia/Kolkata');
