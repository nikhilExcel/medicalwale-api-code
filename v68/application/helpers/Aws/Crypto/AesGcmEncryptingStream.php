...
class AesGcmEncryptingStream implements AesStreamInterface {
    ...
    StreamInterface $plaintext, $key, $initializationVector, $aad = '', $tagLength = 16, $keySize = 256
    ) {
    ...
    public function createStream() {
        return Psr7\stream_for(openssl_encrypt(
                        (string) $this->plaintext, $this->getOpenSslName(), $this->key, OPENSSL_RAW_DATA, $this->initializationVector, $this->tag, $this->aad, $this->tagLength
        ));
    }
