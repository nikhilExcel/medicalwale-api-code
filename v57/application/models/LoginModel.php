    ...
    public function userlogin($phone, $token, $agent, $hash_key) {
        if ($phone == "") {
            ...
            if ($check_user != "") {
                ...
                if ($phone == '9833381096' || $phone=='18007696223' ||$phone == '7834277784' || $phone == '8655369076' || $phone == '9824242411' || $phone == '9733331211' || $phone == '8676008901' || $phone == '9107766551' || $phone == '7545032401' || $phone == '8500005213' || $phone == '9822212411' || $phone == '8080262411' || $phone == '9323465785' || $phone == '8097014524' || $phone=='7021493253' || $phone == '8879398756')  {
                    $otp_code = '123456';
                } else {
                    $otp_code = rand(100000, 999999);
                    if($agent=="android")
                ...
                if ($phone == '7834277784' || $phone=='18007696223'|| $phone == '8655369076' || $phone == '9824242411' || $phone == '9733331211' || $phone == '8676008901' || $phone == '9107766551' || $phone == '7545032401' || $phone == '8500005213' || $phone == '9822212411' || $phone == '8080262411' || $phone == '9323465785') {
                    $otp_code = '123456';
                } else {
                    $otp_code = rand(100000, 999999);
                    $message = 'Please enter this One Time Password : ' . $otp_code . ' to verify your mobile number.';
...
//   }
  ...
  public function coupon_code($user_id,$coupon,$listing_id,$listing_type)
  {
        ...
        $booking_id = date("YmdHis");
        $created_at = date('Y-m-d H:i:s');
        $query1 = $this->db->query("SELECT * FROM vendor_offers WHERE name='$coupon'");
