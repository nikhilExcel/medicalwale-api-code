 ...
 public function hospital_list($latitude, $longitude, $user_id, $category_name,$page,$keyword) {
      if($page==""){
       ...
       $resultpost_branch=array();
		...
		if(!empty($response_a['rows'][0]['elements'][0]))
		{
     ...
     if($keyword!=""){
        $sql = sprintf("SELECT `id`, `user_id`, `name_of_hospital`,`phone`,`about_us`, `certificates_accred`, `category`, `speciality`, `surgery`,`services`, `address`, `pincode`, `city`, `state`, `email`, `lat`, `lng`, `image`, `rating`, `review`,  `date`, `is_active`,`establishment_year`,`user_discount`,( 6371 * acos( cos( radians($latitude) ) * cos( radians( lat ) ) * cos( radians( lng ) - radians($longitude) ) + sin( radians($latitude) ) * sin( radians( lat ) ) ) ) AS distance FROM hospitals WHERE FIND_IN_SET('1', category) AND is_approval='1' AND is_active='1' and name_of_hospital LIKE '%%$keyword%%' HAVING distance < '%s' ORDER BY distance LIMIT $startk, $limitk", ($latitude), ($longitude), ($latitude), ($radius));
    }
   else
   {
        $sql = sprintf("SELECT `id`, `user_id`, `name_of_hospital`,`phone`,`about_us`, `certificates_accred`, `category`, `speciality`, `surgery`,`services`, `address`, `pincode`, `city`, `state`, `email`, `lat`, `lng`, `image`, `rating`, `review`,  `date`, `is_active`,`establishment_year`,`user_discount`,( 6371 * acos( cos( radians($latitude) ) * cos( radians( lat ) ) * cos( radians( lng ) - radians($longitude) ) + sin( radians($latitude) ) * sin( radians( lat ) ) ) ) AS distance FROM hospitals WHERE FIND_IN_SET('1', category) AND is_approval='1' AND is_active='1' HAVING distance < '%s' ORDER BY distance  LIMIT $start, $limit", ($latitude), ($longitude), ($latitude), ($radius));
    }
       ...
       $i=0;
         ...
         if($page!=0)
{    
        $query = $this->db->query("SELECT `id`, `user_id`, `name_of_hospital`,`phone`,`about_us`, `certificates_accred`, `category`, `speciality`, `surgery`,`services`, `address`, `pincode`, `city`, `state`, `email`, `lat`, `lng`, `image`, `rating`, `review`,  `date`, `is_active`,`establishment_year`,`user_discount`,( 6371 * acos( cos( radians($latitude) ) * cos( radians( lat ) ) * cos( radians( lng ) - radians($longitude) ) + sin( radians($latitude) ) * sin( radians( lat ) ) ) ) AS distance FROM hospitals WHERE FIND_IN_SET('1', category)  HAVING distance <= '$radius' LIMIT $start, $limit");
}
else
{
    $query = $this->db->query("SELECT `id`, `user_id`, `name_of_hospital`,`phone`,`about_us`, `certificates_accred`, `category`, `speciality`, `surgery`,`services`, `address`, `pincode`, `city`, `state`, `email`, `lat`, `lng`, `image`, `rating`, `review`,  `date`, `is_active`,`establishment_year`,`user_discount`,( 6371 * acos( cos( radians($latitude) ) * cos( radians( lat ) ) * cos( radians( lng ) - radians($longitude) ) + sin( radians($latitude) ) * sin( radians( lat ) ) ) ) AS distance FROM hospitals WHERE FIND_IN_SET('1', category)  HAVING distance <= '$radius'"); 
}
...
public function hospital_list_v2($latitude, $longitude, $user_id, $category_name,$page) {
    $radius = $page*500;
    $limit = 10;
    $start = 0;
        if ($page > 0) {
