...
// die();
   ...
   if ($phone == '9833381096' || $phone == '7834277784' || $phone == '8655369076' || $phone == '9824242411' || $phone == '9733331211' || $phone == '8676008901' || $phone == '9107766551' || $phone == '7545032401' || $phone == '8500005213' || $phone == '9822212411' || $phone == '8080262411' || $phone == '9323465785' || $phone == '8097014524' || $phone=='7021493253' || $phone == '8879398756')  {
    ...
    public function checkUserDetails($user_id) {
	    ...
	    //if($gmt <='02 Jan 2020 | 00:00 AM' and $gmt >='31 Dec 2019 | 11:59 PM' )
	    $gmt=date('d-m-Y h:i:s'); 
	 if(strtotime($gmt)<=strtotime('27-01-2020 00:00:00') && strtotime($gmt) >=strtotime('25-01-2020 23:59:59'))
	     {
        return array(
            'profile_percentage' => $profile_completed, 
            'is_Miss_belly_activated' => $Miss_belly_status, 
    		'ServerTime'=>$gmtdate, 
        	'OfferDate'=>'26 Jan 2020', 
        	'OfferStartTime'=>'25 Jan 2019 | 11:59 PM',
        	'OfferEndTime'=>'26 Jan 2020 | 11:59 PM',
        	'OfferImageUrl'=>'https://medicalwale.s3.amazonaws.com/images/Festival_offer/HealthMall_Banner-Republic_Day.jpg' 
            );
	     }
	     else
	     {
