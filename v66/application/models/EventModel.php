         ...
         if ($count1 > 0) 
            {
             ...
             foreach ($query1->result_array() as $row1) 
                     {
                          $final_id        = $row1['parent_id']; //echo "<br>";
                         // "SELECT * FROM Doctor_story where doctor_id = '$final_id' and status='0' order by id Desc";
          ...
          $query = $this->db->query("SELECT * FROM Doctor_story where doctor_id = '63835' and status='0' order by id Desc");
