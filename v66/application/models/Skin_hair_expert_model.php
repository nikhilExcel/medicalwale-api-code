...
class Skin_hair_expert_model extends CI_Model {
   ...
   public function add_comment($data,$comment1,$user_id){
    ...
    public function skin_hair_add_question($type, $user_id, $for_user_id, $user_name, $user_image, $question, $age, $height, $weight, $diet_preference, $post_location, $skin_type, $skin_color, $skin_concern, $skin_concern_other, $is_anonymous) 
    {
        date_default_timezone_set('Asia/Kolkata');
        $created_at = date('Y-m-d H:i:s');
       ...
       /* $field_de = array(
        ...
        $this->db->insert('expert_notifications', $field_de);
	     ...
	     define("POST_URL", "https://live.medicalwale.com/v66/healthwall/post_comment");
                    $comment = 'Thank you for connecting with us, VLCC Beauty Expert will be answering your query within 48 hours.';
                    $fields = array(
                        'user_id' => '1515',
                        'post_id' => $post_id,
                        'comment' => $comment,
     ...
     public function skin_hair_edit_question($type, $user_id,$post_id, $for_user_id, $user_name, $user_image, $question, $age, $height, $weight, $diet_preference, $post_location, $skin_type, $skin_color, $skin_concern, $skin_concern_other, $is_anonymous) 
    {
        date_default_timezone_set('Asia/Kolkata');
        $created_at = date('Y-m-d H:i:s');
